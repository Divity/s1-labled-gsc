...
lib_A79C::init()
{
	...
	level thread lib_A79C::onplayerconnect();
}

//Function Number: 2
lib_A79C::onplayerconnect()
{
	for(;;)
	{
		level waittill("connected",var_00);
		var_00 thread lib_A79C::lowermessagethink();
		var_00 thread lib_A79C::initnotifymessage();
	}
}

//Function Number: 3
lib_A79C::hintmessage(param_00)
{
	var_01 = spawnstruct();
	var_01.notifytext = param_00;
	lib_A79C::notifymessage(var_01);
}

//Function Number: 4
lib_A79C::initnotifymessage()
{
...
//Function Number: 5
lib_A79C::oldnotifymessage(param_00,param_01,param_02,param_03,param_04,param_05)
{
	var_06 = spawnstruct();
	...
	lib_A79C::notifymessage(var_06);
}

//Function Number: 6
lib_A79C::notifymessage(param_00)
{
	self endon("death");
	...
	{
		thread lib_A79C::shownotifymessage(param_00);
		return;
	}
...
//Function Number: 7
lib_A79C::dispatchnotify(param_00)
{
	waittillframeend;
	...
	{
		lib_A79C::actionnotify(var_01);
		return;
	}

	lib_A79C::shownotifymessage(var_01);
}

//Function Number: 8
lib_A79C::promotionsplashnotify()
{
	if(!isplayer(self))
	{
		return;
	...
	var_01 = "promotion";
	var_00.name = var_01;
	var_00.type = tablelookup(lib_A79C::get_table_name(),0,var_01,11);
	var_00.sound = tablelookup(lib_A79C::get_table_name(),0,var_01,9);
	var_00.slot = 0;
	thread lib_A79C::actionnotify(var_00);
}

//Function Number: 9
lib_A79C::shownotifymessage(param_00)
{
	self endon("disconnect");
	var_01 = param_00.slot;
	if(level.gameended)
	{
		...
		{
			thread lib_A79C::dispatchnotify(var_01);
		}
	...
	lib_A79C::waitrequirevisibility(0);
	...
	thread lib_A79C::resetoncancel();
	if(isdefined(param_00.sound))
	{
		self method_82F4(param_00.sound);
	}
	...
	if(isdefined(param_00.iconname))
	{
		...
		if(isdefined(param_00.iconoverlay))
		{
			...
			lib_A79C::waitrequirevisibility(var_02);
...
//Function Number: 10
lib_A79C::coopkillstreaksplashnotify(param_00,param_01)
{
	if(!isplayer(self))
	{
		return;
	...
	var_02.type = tablelookup(lib_A79C::get_table_name(),0,param_00,11);
	var_02.optionalnumber = 0;
	var_02.sound = tablelookup(lib_A79C::get_table_name(),0,param_00,9);
	var_02.leadersound = param_01;
	var_02.slot = 0;
	thread lib_A79C::actionnotify(var_02);
}

//Function Number: 11
lib_A79C::killstreaksplashnotify(param_00,param_01,param_02,param_03,param_04)
{
	if(!isplayer(self))
	{
		return;
	...
	var_05.type = tablelookup(lib_A79C::get_table_name(),0,param_00,11);
	...
	thread lib_A79C::actionnotify(var_05);
}

//Function Number: 12
lib_A79C::challengesplashnotify(param_00,param_01,param_02)
{
	if(!isplayer(self))
	{
		return;
	...
	for(var_03 = param_02 - 1;var_03 >= param_01;var_03--)
	{
		...
		var_05.sound = tablelookup(lib_A79C::get_table_name(),0,param_00,9);
		var_05.slot = 0;
		thread lib_A79C::actionnotify(var_05);
	}
}
...
//Function Number: 13
lib_A79C::splashnotify(param_00,param_01,param_02)
{
	if(!isplayer(self))
	{
		return;
	...
	var_03.type = tablelookup(lib_A79C::get_table_name(),0,param_00,11);
	var_03.optionalnumber = param_01;
	var_03.sound = tablelookup(lib_A79C::get_table_name(),0,var_03.name,9);
	if(!isdefined(param_02))
	{
		param_02 = -1;
	}
	...
	var_03.slot = 0;
	thread lib_A79C::actionnotify(var_03);
}

//Function Number: 14
lib_A79C::splashnotifyurgent(param_00,param_01)
{
	if(!isplayer(self))
	{
		return;
...
//Function Number: 15
lib_A79C::splashnotifydelayed(param_00,param_01)
{
	if(!isplayer(self))
	{
		return;
...
//Function Number: 16
lib_A79C::rankupsplashnotify(param_00,param_01,param_02)
{
	if(!isplayer(self))
	{
		return;
	...
	var_03.name = param_00;
	var_03.type = tablelookup(lib_A79C::get_table_name(),0,param_00,11);
	var_03.sound = tablelookup(lib_A79C::get_table_name(),0,param_00,9);
...
//Function Number: 17
lib_A79C::playercardsplashnotify(param_00,param_01,param_02)
{
	if(!isplayer(self))
	{
		return;
...
//Function Number: 18
lib_A79C::actionnotify(param_00)
{
	self endon("death");
	self endon("disconnect");
	var_01 = param_00.slot;
	...
	if(!isdefined(self.doingsplash[var_01]))
	{
		thread lib_A79C::actionnotifymessage(param_00);
		return;
	}
	else
	{
...
//Function Number: 19
lib_A79C::actionnotifymessage(param_00)
{
	self endon("disconnect");
	var_01 = param_00.slot;
	if(level.gameended)
	{
		...
		{
			self.connectedpostgame["postGameChallenges"]++;
			self setclientdvar("ui_challenge_" + self.connectedpostgame["postGameChallenges"] + "_ref",param_00.name);
		}
	...
	if(tablelookup(lib_A79C::get_table_name(),0,param_00.name,0) != "")
	{
		var_02 = tablelookuprownum(lib_A79C::get_table_name(),0,param_00.name);
		var_03 = maps\mp\_utility::stringtofloat(tablelookupbyrow(lib_A79C::get_table_name(),var_02,4));
		switch(param_00.type)
		{
			case "killstreak_splash":
			case "killstreak_coop_splash":
...
//Function Number: 20
lib_A79C::waitrequirevisibility(param_00)
{
	var_01 = 0.05;
	while(!lib_A79C::canreadtext())
	{
		wait(var_01);
	}
...
//Function Number: 22
lib_A79C::resetondeath()
{
	self endon("notifyMessageDone");
	self endon("disconnect");
	level endon("game_ended");
	self waittill("death");
	lib_A79C::resetnotify();
}

//Function Number: 23
lib_A79C::resetoncancel()
{
...
lib_A79C::lowermessagethink()
{
	...
	self.lowermessage.fontscale = 10;
	...
	self.lowertimer.fontscale = 10;
	self.lowertimer.showinkillcam = 0;
}

//Function Number: 26
lib_A79C::outcomeoverlay(param_00)
{
	if(level.teambased)
	{
		if(param_00 == "tie")
		{
			lib_A79C::matchoutcomenotify("draw");
			return;
		}

		if(param_00 == self.inliveplayerkillstreak)
		{
			lib_A79C::matchoutcomenotify("victory");
			return;
		}

		lib_A79C::matchoutcomenotify("defeat");
		return;
	}
...
//Function Number: 27
lib_A79C::matchoutcomenotify(param_00)
{
...
//Function Number: 29
lib_A79C::teamoutcomenotify(param_00,param_01,param_02,param_03)
{
	self endon("disconnect");
	self notify("reset_outcome");
	thread lib_A79C::lerpscreenblurup(32,1);
	wait(0.5);
	...
	else if(isdefined(self.connectedpostgame["team"]) && param_00 == var_04)
	{
		if(param_01)
		{
	...
	if(var_05 && !level.var_A322)
	{
		self setclientomnvar("ui_round_end_friendly_score",game["roundsWon"][var_04]);
		self setclientomnvar("ui_round_end_enemy_score",game["roundsWon"][level.matchbonus[var_04]]);
	}
	else if(!maps\mp\_utility::isroundbased() || !maps\mp\_utility::isobjectivebased())
	{
		...
		self setclientomnvar("ui_round_end_enemy_score",maps\mp\gametypes\_gamescore::_getteamscore(level.matchbonus[var_04]));
	}
	else
	{
		self setclientomnvar("ui_round_end_friendly_score",game["roundsWon"][var_04]);
	...
	if(isdefined(self.var_59DC))
	{
		self setclientomnvar("ui_round_end_match_bonus",self.var_59DC);
	}
...
//Function Number: 30
lib_A79C::outcomenotify(param_00,param_01)
{
	self endon("disconnect");
	self notify("reset_outcome");
	while(lib_A79C::isdoingsplash())
...
//Function Number: 31
lib_A79C::canshowsplash(param_00)
{
}

//Function Number: 32
lib_A79C::lerpscreenblurup(param_00,param_01)
{
	self setblurforplayer(param_00,param_01);
}

//Function Number: 33
lib_A79C::get_table_name()
{
