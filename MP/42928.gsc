...
//Function Number: 1
lib_A7B0::getspawnpoint_nearteam(param_00)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_01["primary"] = [];
	var_01["secondary"] = [];
	var_01["bad"] = [];
	foreach(var_03 in param_00)
	{
		lib_A7B0::initscoredata(var_03);
		var_03.criticalresult = lib_A7B0::criticalfactors_global(var_03);
		var_01[var_03.criticalresult][var_01[var_03.criticalresult].size] = var_03;
	}

	if(var_01["primary"].size)
	{
		var_05 = lib_A7B0::scorespawns_nearteam(var_01["primary"]);
	}
	else if(var_02["secondary"].size)
	{
		var_05 = lib_A7B0::scorespawns_nearteam(var_02["secondary"]);
	}
	else
	{
		var_05 = lib_A7B0::scorespawns_nearteam(var_01);
	}

	foreach(var_03 in param_00)
	{
		lib_A7B0::recon_log_spawnpoint_info(var_03);
...
//Function Number: 2
lib_A7B0::scorespawns_nearteam(param_00)
{
	var_01 = param_00[0];
	foreach(var_03 in param_00)
	{
		lib_A7B0::scorefactors_nearteam(var_03);
	...
	var_01 = lib_A7B0::selectbestspawnpoint(var_01,param_00);
	return var_01;
}

//Function Number: 3
lib_A7B0::getspawnpoint_twar(param_00,param_01)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_02["primary"] = [];
	var_02["secondary"] = [];
	...
	{
		lib_A7B0::initscoredata(var_04);
		var_04.criticalresult = lib_A7B0::criticalfactors_global(var_04);
		var_02[var_04.criticalresult][var_02[var_04.criticalresult].size] = var_04;
	}

	if(var_02["primary"].size)
	{
		var_06 = lib_A7B0::scorespawns_twar(var_02["primary"],param_01);
	}
	else if(var_03["secondary"].size)
	{
		var_06 = lib_A7B0::scorespawns_twar(var_03["secondary"],var_02);
	}
	else
	{
		var_06 = lib_A7B0::scorespawns_twar(param_01,var_02);
	}
	...
	foreach(var_04 in param_00)
	{
		if(!isagent(self))
		{
			lib_A7B0::recon_log_spawnpoint_info(var_04);
		}
...
//Function Number: 4
lib_A7B0::scorespawns_twar(param_00,param_01)
{
	var_02 = param_00[0];
	foreach(var_04 in param_00)
	{
		lib_A7B0::scorefactors_twar(var_04,param_01);
	...
	var_02 = lib_A7B0::selectbestspawnpoint(var_02,param_00);
	return var_02;
}

//Function Number: 5
lib_A7B0::checkdynamicspawns(param_00)
{
...
//Function Number: 6
lib_A7B0::selectbestspawnpoint(param_00,param_01)
{
	var_02 = param_00;
	var_03 = 0;
	var_04 = [];
...
{
	lib_A7B0::recon_log_spawnpoint_info(param_00);
}
...
//Function Number: 10
lib_A7B0::findbuddyspawn()
{
	var_00 = spawnstruct();
	lib_A7B0::initscoredata(var_00);
	var_01 = lib_A7B0::getteammatesoutofcombat(self.inliveplayerkillstreak);
	var_02 = spawnstruct();
	var_02.maxtracecount = 18;
	var_02.currenttracecount = 0;
	foreach(var_04 in var_01)
	{
		var_05 = lib_A7B0::findspawnlocationnearplayer(var_04);
		if(!isdefined(var_05))
		{
			continue;
		}

		if(lib_A7B0::issafetospawnon(var_04,var_05,var_02))
		{
			var_00.totalscore = 999;
			var_00.buddyspawn = 1;
			var_00.var_2E6 = var_05;
			var_00.var_41 = lib_A7B0::getbuddyspawnangles(var_04,var_00.var_2E6);
			break;
		}
...
//Function Number: 11
lib_A7B0::getbuddyspawnangles(param_00,param_01)
{
	var_02 = (0,param_00.var_41[1],0);
	var_03 = findentrances(param_01);
	if(isdefined(var_03) && var_03.size > 0)
	{
		var_02 = vectortoangles(var_03[0].var_2E6 - param_01);
	}
...
//Function Number: 12
lib_A7B0::getteammatesoutofcombat(param_00)
{
	var_01 = [];
	foreach(var_03 in level.var_328)
	{
		if(var_03.inliveplayerkillstreak != param_00)
		{
			continue;
		}
		...
		if(lib_A7B0::isplayerincombat(var_03))
		{
			continue;
		}
...
//Function Number: 13
lib_A7B0::isplayerincombat(param_00)
{
	...
	var_01 = 3000;
	if(param_00.health < param_00.var_275 && isdefined(param_00.lastdamagedtime) && gettime() < param_00.lastdamagedtime + var_01)
	{
		return 1;
	}
...
//Function Number: 14
lib_A7B0::findspawnlocationnearplayer(param_00)
{
	var_01 = maps\mp\gametypes\_spawnlogic::getplayertraceheight(param_00,1);
	var_02 = lib_A7B0::findbuddypathnode(param_00,var_01,0.5);
	if(isdefined(var_02))
	{
		return var_02.var_2E6;
	}
...
//Function Number: 15
lib_A7B0::findbuddypathnode(param_00,param_01,param_02)
{
	var_03 = getnodesinradiussorted(param_00.var_2E6,192,64,param_01,"Path");
	var_04 = undefined;
	if(isdefined(var_03) && var_03.size > 0)
	{
		...
		{
			var_08 = vectornormalize(var_07.var_2E6 - param_00.var_2E6);
			var_09 = vectordot(var_05,var_08);
			if(var_09 <= param_02 && !positionwouldtelefrag(var_07.var_2E6))
			{
				if(sighttracepassed(param_00.var_2E6 + (0,0,param_01),var_07.var_2E6 + (0,0,param_01),0,param_00))
				{
					var_04 = var_07;
					if(var_09 <= 0)
					{
...
//Function Number: 16
lib_A7B0::issafetospawnon(param_00,param_01,param_02)
{
	if(param_00 issighted())
	{
		return 0;
	...
	foreach(var_04 in level.var_328)
	{
		...
		var_06 = (var_06[0],var_06[1],var_04.var_2E6[2] + var_05);
...
//Function Number: 17
lib_A7B0::initscoredata(param_00)
{
...
//Function Number: 18
lib_A7B0::criticalfactors_global(param_00)
{
...
//Function Number: 19
lib_A7B0::scorefactors_nearteam(param_00)
{
	...
	param_00.totalscore = param_00.totalscore + var_01;
	var_01 = maps\mp\gametypes\_spawnfactor::score_factor(1,::maps\mp\gametypes\_spawnfactor::prefertwarzone,param_00);
	param_00.totalscore = param_00.totalscore + var_01;
...
//Function Number: 20
lib_A7B0::scorefactors_twar(param_00,param_01)
{
	...
	param_00.totalscore = param_00.totalscore + var_02;
	var_02 = maps\mp\gametypes\_spawnfactor::score_factor(1,::maps\mp\gametypes\_spawnfactor::prefertwarzone,param_00);
	param_00.totalscore = param_00.totalscore + var_02;
...
//Function Number: 21
lib_A7B0::getspawnpoint_domination(param_00,param_01)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_02["primary"] = [];
	var_02["secondary"] = [];
	...
	{
		lib_A7B0::initscoredata(var_04);
		var_04.criticalresult = lib_A7B0::criticalfactors_domination(var_04);
		var_02[var_04.criticalresult][var_02[var_04.criticalresult].size] = var_04;
	}

	if(var_02["primary"].size)
	{
		var_06 = lib_A7B0::scorespawns_domination(var_02["primary"],param_01);
	}
	else if(var_03["secondary"].size)
	{
		var_06 = lib_A7B0::scorespawns_domination(var_03["secondary"],var_02);
	}
	else
	{
		var_06 = lib_A7B0::scorespawns_domination(param_01,var_02);
	}
...
//Function Number: 22
lib_A7B0::scorespawns_domination(param_00,param_01)
{
	var_02 = param_00[0];
	foreach(var_04 in param_00)
	{
		lib_A7B0::scorefactors_domination(var_04,param_01);
		if(var_04.totalscore > var_02.totalscore)
		{
			var_02 = var_04;
		}
...
//Function Number: 23
lib_A7B0::criticalfactors_domination(param_00)
{
	return lib_A7B0::criticalfactors_global(param_00);
}

//Function Number: 24
lib_A7B0::scorefactors_domination(param_00,param_01)
{
	...
	param_00.totalscore = param_00.totalscore + var_02;
	var_02 = maps\mp\gametypes\_spawnfactor::score_factor(1.5,::maps\mp\gametypes\_spawnfactor::prefertwarzone,param_00);
	param_00.totalscore = param_00.totalscore + var_02;
...
//Function Number: 25
lib_A7B0::getspawnpoint_freeforall(param_00)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_01["primary"] = [];
	var_01["secondary"] = [];
	...
	{
		lib_A7B0::initscoredata(var_03);
		var_03.criticalresult = lib_A7B0::criticalfactors_freeforall(var_03);
		var_01[var_03.criticalresult][var_01[var_03.criticalresult].size] = var_03;
	}

	if(var_01["primary"].size)
	{
		var_05 = lib_A7B0::scorespawns_freeforall(var_01["primary"]);
	}
	else if(var_02["secondary"].size)
	{
		var_05 = lib_A7B0::scorespawns_freeforall(var_02["secondary"]);
	}
	else
	{
		var_05 = lib_A7B0::scorespawns_freeforall(var_01);
	}
...
//Function Number: 26
lib_A7B0::scorespawns_freeforall(param_00)
{
	var_01 = param_00[0];
	foreach(var_03 in param_00)
	{
		lib_A7B0::scorefactors_freeforall(var_03);
		if(var_03.totalscore > var_01.totalscore)
		{
			var_01 = var_03;
		}
...
//Function Number: 27
lib_A7B0::criticalfactors_freeforall(param_00)
{
	return lib_A7B0::criticalfactors_global(param_00);
}

//Function Number: 28
lib_A7B0::scorefactors_freeforall(param_00)
{
	var_01 = maps\mp\gametypes\_spawnfactor::score_factor(1.5,::maps\mp\gametypes\_spawnfactor::prefertwarzone,param_00);
	param_00.totalscore = param_00.totalscore + var_01;
...
//Function Number: 29
lib_A7B0::getspawnpoint_searchandrescue(param_00)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_01["primary"] = [];
	var_01["secondary"] = [];
	...
	{
		lib_A7B0::initscoredata(var_03);
		var_03.criticalresult = lib_A7B0::criticalfactors_searchandrescue(var_03);
		var_01[var_03.criticalresult][var_01[var_03.criticalresult].size] = var_03;
	}

	if(var_01["primary"].size)
	{
		var_05 = lib_A7B0::scorespawns_searchandrescue(var_01["primary"]);
	}
	else if(var_02["secondary"].size)
	{
		var_05 = lib_A7B0::scorespawns_searchandrescue(var_02["secondary"]);
	}
	else
	{
		var_05 = lib_A7B0::scorespawns_searchandrescue(var_01);
	}
...
//Function Number: 30
lib_A7B0::scorespawns_searchandrescue(param_00)
{
	var_01 = param_00[0];
	foreach(var_03 in param_00)
	{
		lib_A7B0::scorefactors_searchandrescue(var_03);
		if(var_03.totalscore > var_01.totalscore)
		{
			var_01 = var_03;
		}
...
//Function Number: 31
lib_A7B0::criticalfactors_searchandrescue(param_00)
{
	return lib_A7B0::criticalfactors_global(param_00);
}

//Function Number: 32
lib_A7B0::scorefactors_searchandrescue(param_00)
{
	var_01 = maps\mp\gametypes\_spawnfactor::score_factor(3,::maps\mp\gametypes\_spawnfactor::prefertwarzone,param_00);
	param_00.totalscore = param_00.totalscore + var_01;
...
//Function Number: 33
lib_A7B0::getspawnpoint_hardpoint(param_00)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_01["primary"] = [];
	var_01["secondary"] = [];
	...
	if(var_01["primary"].size)
	{
		var_02 = lib_A7B0::scorespawns_hardpoint(var_01["primary"]);
	}
	else if(var_01["secondary"].size)
	{
		var_02 = lib_A7B0::scorespawns_hardpoint(var_01["secondary"]);
	}
	else
	{
		var_02 = lib_A7B0::scorespawns_hardpoint(param_00);
	}
...
//Function Number: 34
lib_A7B0::scorespawns_hardpoint(param_00)
{
	var_01 = param_00[randomint(param_00.size)];
	foreach(var_03 in param_00)
	{
		lib_A7B0::scorefactors_hardpoint(var_03);
		if(var_03.totalscore > var_01.totalscore)
		{
			var_01 = var_03;
		}
...
//Function Number: 35
lib_A7B0::scorefactors_hardpoint(param_00)
{
...
getspawnpoint_ctf(param_00,param_01)
{
	...
	{
		lib_A7B0::initscoredata(var_04);
		var_04.criticalresult = lib_A7B0::criticalfactors_awayfromenemies(var_04);
		var_02[var_04.criticalresult][var_02[var_04.criticalresult].size] = var_04;
	}
...
//Function Number: 39
lib_A7B0::getspawnpoint_awayfromenemies(param_00,param_01)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_02["primary"] = [];
	var_02["secondary"] = [];
	...
	if(var_02["primary"].size)
	{
		var_06 = lib_A7B0::scorespawns_awayfromenemies(var_02["primary"],param_01);
	}
	else if(var_03["secondary"].size)
	{
		var_06 = lib_A7B0::scorespawns_awayfromenemies(var_03["secondary"],var_02);
	}
	else
	{
		var_06 = lib_A7B0::scorespawns_awayfromenemies(param_01,var_02);
	}
...
//Function Number: 40
lib_A7B0::scorespawns_awayfromenemies(param_00,param_01)
{
	var_02 = param_00[0];
	foreach(var_04 in param_00)
	{
		lib_A7B0::scorefactors_awayfromenemies(var_04,param_01);
		if(var_04.totalscore > var_02.totalscore)
		{
			var_02 = var_04;
		}
...
//Function Number: 41
lib_A7B0::criticalfactors_awayfromenemies(param_00)
{
	return lib_A7B0::criticalfactors_global(param_00);
}

//Function Number: 42
lib_A7B0::scorefactors_awayfromenemies(param_00,param_01)
{
	var_02 = maps\mp\gametypes\_spawnfactor::score_factor(1,::maps\mp\gametypes\_spawnfactor::prefertwarzone,param_00);
	param_00.totalscore = param_00.totalscore + var_02;
	var_02 = maps\mp\gametypes\_spawnfactor::score_factor(0.25,::maps\mp\gametypes\_spawnfactor::avoidsamespawn,param_00);
...
//Function Number: 43
lib_A7B0::getspawnpoint_safeguard(param_00)
{
	param_00 = lib_A7B0::checkdynamicspawns(param_00);
	var_01["primary"] = [];
	var_01["secondary"] = [];
	...
	{
		lib_A7B0::initscoredata(var_03);
		var_03.criticalresult = lib_A7B0::criticalfactors_safeguard(var_03);
		var_01[var_03.criticalresult][var_01[var_03.criticalresult].size] = var_03;
	}

	if(var_01["primary"].size)
	{
		var_05 = lib_A7B0::scorespawns_safeguard(var_01["primary"]);
	}
	else if(var_02["secondary"].size)
	{
		var_05 = lib_A7B0::scorespawns_safeguard(var_02["secondary"]);
	}
	else
	{
		var_05 = lib_A7B0::scorespawns_safeguard(var_01);
	}
...
//Function Number: 44
lib_A7B0::scorespawns_safeguard(param_00)
{
	var_01 = param_00[0];
	foreach(var_03 in param_00)
	{
		lib_A7B0::scorefactors_safeguard(var_03);
		if(var_03.totalscore > var_01.totalscore)
		{
			var_01 = var_03;
		}
...
//Function Number: 45
lib_A7B0::criticalfactors_safeguard(param_00)
{
	return lib_A7B0::criticalfactors_global(param_00);
}

//Function Number: 46
lib_A7B0::scorefactors_safeguard(param_00)
{
	var_01 = maps\mp\gametypes\_spawnfactor::score_factor(1,::maps\mp\gametypes\_spawnfactor::randomspawnscore,param_00);
	param_00.totalscore = param_00.totalscore + var_01;
	var_01 = maps\mp\gametypes\_spawnfactor::score_factor(1,::maps\mp\gametypes\_spawnfactor::preferalliesbydistance,param_00);
	param_00.totalscore = param_00.totalscore + var_01;
	var_01 = maps\mp\gametypes\_spawnfactor::score_factor(0.5,::maps\mp\gametypes\_spawnfactor::prefertwarzone,param_00);
	param_00.totalscore = param_00.totalscore + var_01;
}