 ...
 * Decompiled File: 42219.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 73
 * Decompile Time: 21 ms
 * Timestamp: 4/20/2022 8:18:14 PM
*******************************************************************/

//Function Number: 1
lib_A4EB::init()
{
	common_scripts\utility::array_thread(getentarray("com_wall_fan_blade_rotate_slow","targetname"),::lib_A4EB::fan_blade_rotate,"veryslow");
	common_scripts\utility::array_thread(getentarray("com_wall_fan_blade_rotate","targetname"),::lib_A4EB::fan_blade_rotate,"slow");
	common_scripts\utility::array_thread(getentarray("com_wall_fan_blade_rotate_fast","targetname"),::lib_A4EB::fan_blade_rotate,"fast");
	var_00 = [];
	var_00["trigger_multiple_dyn_metal_detector"] = ::lib_A4EB::metal_detector;
	var_00["trigger_multiple_dyn_creaky_board"] = ::lib_A4EB::creaky_board;
	var_00["trigger_multiple_dyn_photo_copier"] = ::lib_A4EB::photo_copier;
	var_00["trigger_multiple_dyn_copier_no_light"] = ::lib_A4EB::photo_copier_no_light;
	var_00["trigger_radius_motion_light"] = ::lib_A4EB::motion_light;
	var_00["trigger_radius_dyn_motion_dlight"] = ::lib_A4EB::outdoor_motion_dlight;
	var_00["trigger_multiple_dog_bark"] = ::lib_A4EB::dog_bark;
	var_00["trigger_radius_bird_startle"] = ::lib_A4EB::bird_startle;
	var_00["trigger_multiple_dyn_motion_light"] = ::lib_A4EB::motion_light;
	var_00["trigger_multiple_dyn_door"] = ::lib_A4EB::trigger_door;
	lib_A4EB::player_init();
	foreach(var_04, var_02 in var_00)
	{
		var_03 = getentarray(var_04,"classname");
		common_scripts\utility::array_thread(var_03,::lib_A4EB::triggertouchthink);
		common_scripts\utility::array_thread(var_03,var_02);
	}

	common_scripts\utility::array_thread(getentarray("vending_machine","targetname"),::lib_A4EB::vending_machine);
	common_scripts\utility::array_thread(getentarray("toggle","targetname"),::lib_A4EB::use_toggle);
	common_scripts\utility::array_thread(getentarray("sliding_door","targetname"),::lib_A4EB::sliding_door);
	level thread lib_A4EB::onplayerconnect();
	var_05 = getent("civilian_jet_origin","targetname");
	if(isdefined(var_05))
	{
		var_05 thread lib_A4EB::civilian_jet_flyby();
	}

	thread lib_A4EB::interactive_tv();
}

//Function Number: 2
lib_A4EB::onplayerconnect()
{
	for(;;)
	{
		level waittill("connecting",var_00);
		var_00 thread lib_A4EB::movementtracker();
	}
}
...
lib_A4EB::player_init()
{
	if(common_scripts\utility::issp())
	{
		foreach(var_01 in level.var_328)
		{
			...
			var_01 thread lib_A4EB::movementtracker();
		}
	}
}
...
{
	self.touchtriggers = [];
	thread lib_A4EB::movementtracker();
}

//Function Number: 5
lib_A4EB::civilian_jet_flyby()
{
	...
	for(;;)
	{
		thread lib_A4EB::jet_timer();
		self waittill("start_flyby");
		thread lib_A4EB::jet_flyby();
...
lib_A4EB::jet_init()
{
	...
	var_00 = vectornormalize(self.var_2E6 - self.jet_flyto.var_2E6) * 20000;
	self.jet_flyto.var_2E6 = self.jet_flyto.var_2E6 - var_00;
	self.var_2E6 = self.var_2E6 + var_00;
	foreach(var_02 in self.jet_parts)
	{
		var_02.var_2E6 = var_02.var_2E6 + var_00;
		var_02.old_origin = var_02.var_2E6;
		var_02 hide();
	}

	foreach(var_05 in self.engine_fxs)
	{
		var_05.var_2E6 = var_05.var_2E6 + var_00;
	}

	foreach(var_08 in self.flash_fxs)
	{
		var_08.var_2E6 = var_08.var_2E6 + var_00;
	}

	var_0A = self.var_2E6;
	var_0B = self.jet_flyto.var_2E6;
...
lib_A4EB::jet_reset()
{
	...
	{
		var_01.var_2E6 = var_01.old_origin;
		var_01 hide();
	}
}
...
{
	level endon("game_ended");
	var_00 = lib_A4EB::gettimeinterval();
...
lib_A4EB::gettimeinterval()
{
	...
	return lib_A4EB::getwatcheddvar("timelimit");
}

//Function Number: 10
lib_A4EB::getwatcheddvar(param_00)
{
...
lib_A4EB::jet_flyby()
{
	...
	{
		var_07 = spawn("script_model",var_06.var_2E6);
		var_07 setmodel("tag_origin");
		var_07.var_41 = var_06.var_41;
		var_03[var_03.size] = var_07;
	}

	foreach(var_0A in self.flash_fxs)
	{
		var_0B = spawn("script_model",var_0A.var_2E6);
		var_0B setmodel("tag_origin");
		var_0B.color = var_0A.var_39B;
		var_0B.var_41 = var_0A.var_41;
		var_04[var_04.size] = var_0B;
	}

	thread lib_A4EB::jet_planesound(self.jet_parts[0],level.var_5983);
	wait(0.05);
	...
	foreach(var_01 in self.jet_parts)
	{
		var_01 moveto(var_01.var_2E6 + self.jet_fly_vec,self.jet_flight_time);
	}

	foreach(var_07 in var_03)
	{
		var_07 moveto(var_07.var_2E6 + self.jet_fly_vec,self.jet_flight_time);
	}

	foreach(var_0B in var_04)
	{
		var_0B moveto(var_0B.var_2E6 + self.jet_fly_vec,self.jet_flight_time);
	}
...
//Function Number: 12
lib_A4EB::jet_planesound(param_00,param_01)
{
	param_00 thread lib_A4EB::playsound_loop_on_ent("veh_mig29_dist_loop");
	while(!lib_A4EB::targetisclose(param_00,param_01))
	{
		wait(0.05);
	}

	param_00 thread lib_A4EB::playsound_loop_on_ent("veh_mig29_close_loop");
	while(lib_A4EB::targetisinfront(param_00,param_01))
	{
		wait(0.05);
	}

	wait(0.5);
	param_00 thread lib_A4EB::playsound_float("veh_mig29_sonic_boom");
	while(lib_A4EB::targetisclose(param_00,param_01))
	{
		wait(0.05);
	}
...
//Function Number: 13
lib_A4EB::playsound_float(param_00,param_01,param_02)
{
...
//Function Number: 14
lib_A4EB::playsound_loop_on_ent(param_00,param_01)
{
...
//Function Number: 15
lib_A4EB::targetisinfront(param_00,param_01)
{
...
//Function Number: 16
lib_A4EB::targetisclose(param_00,param_01)
{
	var_02 = lib_A4EB::targetisinfront(param_00,param_01);
	if(var_02)
	{
		var_03 = 1;
	}
...
lib_A4EB::vending_machine()
{
	...
	self.vm_launch_from = var_02.var_2E6;
	var_03 = getent(var_02.target,"targetname");
	self.vm_launch_to = var_03.var_2E6;
	if(isdefined(var_03.target))
	{
		self.vm_fx_loc = getent(var_03.target,"targetname").var_2E6;
	}

	self.vm_normal setcandamage(1);
	self.vm_normal_model = self.vm_normal.model;
	self.vm_damaged_model = self.vm_normal.var_39B;
	self.vm_soda_model = var_00.model;
	self.vm_soda_start_pos = var_00.var_2E6;
	self.vm_soda_start_angle = var_00.var_41;
	self.vm_soda_stop_pos = var_01.var_2E6;
	self.vm_soda_stop_angle = var_01.var_41;
	...
	self.hp = 400;
	thread lib_A4EB::vending_machine_damage_monitor(self.vm_normal);
	self playloopsound("vending_machine_hum");
	for(;;)
	{
		self waittill("trigger",var_04);
		self playsoundasmaster("vending_machine_button_press");
		if(!self.soda_count)
		{
			continue;
		}
		...
		{
			lib_A4EB::soda_can_eject();
		}

		lib_A4EB::soda_can_drop(lib_A4EB::spawn_soda());
		wait(0.05);
	}
}

//Function Number: 18
lib_A4EB::vending_machine_damage_monitor(param_00)
{
	level endon("game_ended");
	...
	for(;;)
	{
		...
		if(isdefined(var_07))
		{
			...
			{
				var_08 = self.vm_normal.var_2E6 + (37,-31,52);
			}
			else
			{
...
lib_A4EB::spawn_soda()
{
	...
	var_00.var_2E6 = self.vm_soda_start_pos;
	var_00.var_41 = self.vm_soda_start_angle;
	return var_00;
}

//Function Number: 20
lib_A4EB::soda_can_drop(param_00)
{
	param_00 moveto(self.vm_soda_stop_pos,0.2);
	param_00 playsoundasmaster("vending_machine_soda_drop");
	wait(0.2);
...
lib_A4EB::freefall()
{
	...
	for(;;)
	{
		...
		{
			var_01 playsoundasmaster("freefall_death");
...
lib_A4EB::metal_detector()
{
	...
	var_05 = [];
	var_06 = min(var_01.var_2E6[0],var_02.var_2E6[0]);
	var_05[0] = var_06;
	var_07 = max(var_01.var_2E6[0],var_02.var_2E6[0]);
	var_05[1] = var_07;
	var_08 = min(var_01.var_2E6[1],var_02.var_2E6[1]);
	var_05[2] = var_08;
	var_09 = max(var_01.var_2E6[1],var_02.var_2E6[1]);
	var_05[3] = var_09;
	var_0A = min(var_01.var_2E6[2],var_02.var_2E6[2]);
	var_05[4] = var_0A;
	var_0B = max(var_01.var_2E6[2],var_02.var_2E6[2]);
	var_05[5] = var_0B;
	var_01 delete();
	var_02 delete();
	if(!common_scripts\utility::issp())
	...
	self.tolerance = 0;
	thread lib_A4EB::metal_detector_dmg_monitor(var_00);
	thread lib_A4EB::metal_detector_touch_monitor();
	thread lib_A4EB::metal_detector_weapons(var_05,"weapon_claymore","weapon_c4");
	var_0C = (var_03.var_2E6[0],var_03.var_2E6[1],var_0B);
	var_0D = (var_04.var_2E6[0],var_04.var_2E6[1],var_0B);
	...
	for(;;)
	{
		...
		thread lib_A4EB::playsound_and_light("alarm_metal_detector",var_0E,var_0C,var_0D);
	}
}

//Function Number: 24
lib_A4EB::playsound_and_light(param_00,param_01,param_02,param_03)
{
	level endon("game_ended");
	if(!self.alarm_playing)
	{
		self.alarm_playing = 1;
		thread lib_A4EB::annoyance_tracker();
...
lib_A4EB::annoyance_tracker()
{
	...
	lib_A4EB::waittill_any_or_timeout("dmg_triggered","touch_triggered","weapon_triggered",var_02 + 2);
...
//Function Number: 26
lib_A4EB::waittill_any_or_timeout(param_00,param_01,param_02,param_03)
{
	level endon("game_ended");
	self endon(param_00);
	self endon(param_01);
...
//Function Number: 27
lib_A4EB::metal_detector_weapons(param_00,param_01,param_02)
{
	level endon("game_ended");
	for(;;)
	{
		lib_A4EB::waittill_weapon_placed();
		var_03 = getentarray("grenade","classname");
		foreach(var_05 in var_03)
		{
			if(isdefined(var_05.model) && var_05.model == param_01 || var_05.model == param_02)
			{
				if(lib_A4EB::isinbound(var_05,param_00))
				{
					thread lib_A4EB::weapon_notify_loop(var_05,param_00);
				}
			}
		}
	}
...
//Function Number: 29
lib_A4EB::weapon_notify_loop(param_00,param_01)
{
	param_00 endon("death");
	while(lib_A4EB::isinbound(param_00,param_01))
	{
...
//Function Number: 30
lib_A4EB::isinbound(param_00,param_01)
{
	var_02 = param_01[0];
	var_03 = param_01[1];
	var_04 = param_01[2];
	...
	var_06 = param_01[4];
	var_07 = param_01[5];
	var_08 = param_00.var_2E6[0];
	var_09 = param_00.var_2E6[1];
	var_0A = param_00.var_2E6[2];
	if(lib_A4EB::isinbound_single(var_08,var_02,var_03))
	{
		if(lib_A4EB::isinbound_single(var_09,var_04,var_05))
		{
			if(lib_A4EB::isinbound_single(var_0A,var_06,var_07))
			{
				return 1;
			}
		}
...
//Function Number: 31
lib_A4EB::isinbound_single(param_00,param_01,param_02)
{
...
//Function Number: 32
lib_A4EB::metal_detector_dmg_monitor(param_00)
{
	level endon("game_ended");
	for(;;)
	{
		param_00 waittill("damage",var_01,var_02,var_03,var_04,var_05);
		if(isdefined(var_05) && lib_A4EB::alarm_validate_damage(var_05))
		{
...
//Function Number: 33
lib_A4EB::metal_detector_touch_monitor()
{
	level endon("game_ended");
	for(;;)
	{
		self waittill("trigger_enter");
		while(lib_A4EB::anythingtouchingtrigger(self))
		{
...
//Function Number: 34
lib_A4EB::alarm_validate_damage(param_00)
{
...
//Function Number: 35
lib_A4EB::creaky_board()
{
	level endon("game_ended");
	for(;;)
	{
		self waittill("trigger_enter",var_00);
		var_00 thread lib_A4EB::do_creak(self);
	}
}

//Function Number: 36
lib_A4EB::do_creak(param_00)
{
	self endon("disconnect");
	self endon("death");
	self playsoundasmaster("step_walk_plr_woodcreak_on");
	for(;;)
	{
		...
		self playsoundasmaster("step_walk_plr_woodcreak_off");
	}
}

//Function Number: 37
lib_A4EB::motion_light()
{
	level endon("game_ended");
	self.movetracker = 1;
	self.lightson = 0;
	...
	for(;;)
	{
		...
		while(lib_A4EB::anythingtouchingtrigger(self))
		{
			...
			if(var_05)
			{
				...
				{
					self.lightson = 1;
					var_00[0] playsoundasmaster("switch_auto_lights_on");
					foreach(var_02 in var_00)
					{
				...
				thread lib_A4EB::motion_light_timeout(var_00,10);
			}
...
//Function Number: 38
lib_A4EB::motion_light_timeout(param_00,param_01)
{
	...
	param_00[0] playsoundasmaster("switch_auto_lights_off");
	self.lightson = 0;
}

//Function Number: 39
lib_A4EB::outdoor_motion_dlight()
{
	...
	for(;;)
	{
		...
		while(lib_A4EB::anythingtouchingtrigger(self))
		{
			...
			if(var_02)
			{
				...
				{
					self.lightson = 1;
					var_00 playsoundasmaster("switch_auto_lights_on");
					var_00 setmodel("com_two_light_fixture_on");
					foreach(var_07 in var_01)
					{
						var_07.lightent = spawn("script_model",var_07.var_2E6);
						var_07.lightent setmodel("tag_origin");
						playfxontag(level.outdoor_motion_light,var_07.lightent,"tag_origin");
					}
				}

				thread lib_A4EB::outdoor_motion_dlight_timeout(var_00,var_01,10);
			}
...
//Function Number: 40
lib_A4EB::outdoor_motion_dlight_timeout(param_00,param_01,param_02)
{
	self notify("motion_light_timeout");
	self endon("motion_light_timeout");
	wait(param_02);
	...
	param_00 playsoundasmaster("switch_auto_lights_off");
...
lib_A4EB::dog_bark()
{
	...
	for(;;)
	{
		...
		while(lib_A4EB::anythingtouchingtrigger(self))
		{
			...
			if(var_02 > 6)
			{
				var_00 playsoundasmaster("dyn_anml_dog_bark");
...
//Function Number: 42
lib_A4EB::trigger_door()
{
	var_00 = getent(self.target,"targetname");
	self.doorent = var_00;
	self.doorangle = lib_A4EB::getvectorrightangle(vectornormalize(self getorigin() - var_00 getorigin()));
	var_00.baseyaw = var_00.var_41[1];
	var_01 = 1;
	for(;;)
	{
		self waittill("trigger_enter",var_02);
		var_00 thread lib_A4EB::dooropen(var_01,lib_A4EB::getdoorside(var_02));
		if(lib_A4EB::anythingtouchingtrigger(self))
		{
		...
		var_00 thread lib_A4EB::doorclose(var_01);
	}
}

//Function Number: 43
lib_A4EB::dooropen(param_00,param_01)
{
	if(param_01)
	{
	...
	self playsoundasmaster("door_generic_house_open");
	wait(param_00 + 0.05);
}

//Function Number: 44
lib_A4EB::doorclose(param_00)
{
	self rotateto((0,self.baseyaw,1),param_00);
	self playsoundasmaster("door_generic_house_close");
	wait(param_00 + 0.05);
}

//Function Number: 45
lib_A4EB::getdoorside(param_00)
{
	return vectordot(self.doorangle,vectornormalize(param_00.var_2E6 - self.doorent getorigin())) > 0;
}

//Function Number: 46
lib_A4EB::getvectorrightangle(param_00)
{
...
lib_A4EB::use_toggle()
{
	...
	for(;;)
	{
		...
		if(self.lightson)
		{
			...
			self playsoundasmaster("switch_auto_lights_on");
			continue;
		}
		...
		self playsoundasmaster("switch_auto_lights_off");
	}
}

//Function Number: 48
lib_A4EB::bird_startle()
{
}

//Function Number: 49
lib_A4EB::photo_copier_init(param_00)
{
	self.copier = lib_A4EB::get_photo_copier(param_00);
	if(isdefined(self.copier))
	{
		...
		if(isdefined(var_01))
		{
			...
			if(isdefined(var_02))
			{
				...
				param_00.start_pos = var_01.var_2E6;
				param_00.light = var_02;
				var_03 = self.copier.var_41 + (0,90,0);
...
//Function Number: 50
lib_A4EB::get_photo_copier(param_00)
{
	if(!isdefined(param_00.target))
	{
		...
		foreach(var_04 in var_01)
		{
			...
			{
				if(distance(param_00.var_2E6,var_02.var_2E6) > distance(param_00.var_2E6,var_04.var_2E6))
				{
					var_02 = var_04;
				}
			}
...
//Function Number: 51
lib_A4EB::waittill_copier_copies()
{
	if(!isdefined(self.copier))
	{
		return;
...
//Function Number: 52
lib_A4EB::photo_copier()
{
	level endon("game_ended");
	lib_A4EB::photo_copier_init(self);
	if(!isdefined(self.copier))
	{
		return;
	}
	...
	self.copier endon("FX_State_Change0");
	thread lib_A4EB::photo_copier_stop();
	for(;;)
	{
		lib_A4EB::waittill_copier_copies();
		self playsoundasmaster("mach_copier_run");
		if(isdefined(self.copy_bar))
		{
			lib_A4EB::reset_copier(self);
			thread lib_A4EB::photo_copier_copy_bar_goes();
			thread lib_A4EB::photo_copier_light_on();
		}
...
//Function Number: 53
lib_A4EB::photo_copier_no_light()
{
	level endon("game_ended");
	self endon("death");
	...
	self.copier = lib_A4EB::get_photo_copier(self);
	if(!isdefined(self.copier))
	{
		return;
	}
...
//Function Number: 54
lib_A4EB::reset_copier(param_00)
{
...
//Function Number: 55
lib_A4EB::photo_copier_copy_bar_goes()
{
...
//Function Number: 56
lib_A4EB::photo_copier_light_on()
{
	...
	lib_A4EB::photo_light_flicker(var_00);
}

//Function Number: 57
lib_A4EB::photo_copier_stop()
{
...
//Function Number: 58
lib_A4EB::photo_light_flicker(param_00)
{
...
//Function Number: 59
lib_A4EB::fan_blade_rotate(param_00)
{
	var_01 = 0;
	var_02 = 20000;
	var_03 = 1;
	...
	if(param_00 == "slow")
	{
		if(isdefined(self.var_39B) && self.var_39B == "lockedspeed")
		{
			var_01 = 180;
		}
		else
	...
	var_04 = self.var_41;
	var_05 = anglestoright(self.var_41) * 100;
...
//Function Number: 60
lib_A4EB::triggertouchthink(param_00,param_01)
{
	level endon("game_ended");
	self endon("deleted");
	...
	for(;;)
	{
		...
		{
			var_02 thread lib_A4EB::playertouchtriggerthink(self,param_00,param_01);
		}
	}
}

//Function Number: 61
lib_A4EB::playertouchtriggerthink(param_00,param_01,param_02)
{
	...
	if(!lib_A4EB::anythingtouchingtrigger(param_00))
	{
...
lib_A4EB::movementtracker()
{
	...
	for(;;)
	{
		...
		{
			self.distmoved = distance(var_00,self.var_2E6);
			var_00 = self.var_2E6;
			wait(0.05);
		}
...
//Function Number: 63
lib_A4EB::anythingtouchingtrigger(param_00)
{
	return param_00.touchlist.size;
}

//Function Number: 64
lib_A4EB::playertouchingtrigger(param_00,param_01)
{
	return isdefined(param_00.touchtriggers[param_01.entnum]);
}

//Function Number: 65
lib_A4EB::interactive_tv()
{
	...
	common_scripts\utility::array_thread(getentarray("interactive_tv","targetname"),::lib_A4EB::tv_logic);
}
...
lib_A4EB::tv_logic()
{
	...
	var_01 = common_scripts\utility::get_array_of_closest(self.var_2E6,level.tv_lite_array,undefined,undefined,64);
	if(var_01.size)
	{
		self.lite = var_01[0];
	...
	thread lib_A4EB::tv_damage();
	if(isdefined(self.usetrig))
	{
		thread lib_A4EB::tv_off();
	}
}
...
lib_A4EB::tv_damage()
{
	...
	self playsoundasmaster("tv_shot_burst");
	if(isdefined(self.usetrig))
	{
		self.usetrig delete();
	}
...
lib_A4EB::sliding_door()
{
	...
	foreach(var_03 in var_00)
	{
		...
		var_03 lib_A4EB::door_init(self.open_time);
	}
	...
	for(;;)
	{
		...
		if(var_07 > 0)
		{
			lib_A4EB::open_all_doors(var_00);
		}
		else
		{
			var_0B = 1;
			thread lib_A4EB::close_all_doors(var_00,var_0B);
		}
...
//Function Number: 70
lib_A4EB::door_init(param_00)
{
	self.start_position = self.var_2E6;
	self.sliding_door_state = "closed";
	var_01 = getent(self.target,"targetname");
	self.open_position = var_01.var_2E6;
	self.open_velocity = distance(self.open_position,self.var_2E6) / param_00;
}

//Function Number: 71
lib_A4EB::open_all_doors(param_00)
{
	foreach(var_02 in param_00)
	{
		...
		var_02 thread lib_A4EB::open_door();
	}
}
...
lib_A4EB::open_door()
{
	...
	var_00 = distance(self.var_2E6,self.open_position) / self.open_velocity;
	if(var_00 < 0.05)
	{
		var_00 = 0.05;
	}
	...
	self playsoundasmaster("glass_door_open");
	wait(var_00);
	self.sliding_door_state = "open";
}

//Function Number: 73
lib_A4EB::close_all_doors(param_00,param_01)
{
	foreach(var_03 in param_00)
	{
		...
		self playsoundasmaster("glass_door_close");
