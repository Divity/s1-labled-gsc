...
lib_A78A::init()
{
	...
	level.objidstart = 0;
	level thread lib_A78A::onplayerconnect();
}

//Function Number: 3
lib_A78A::onplayerconnect()
{
	level endon("game_ended");
	for(;;)
	{
		level waittill("connected",var_00);
		var_00 thread lib_A78A::onplayerspawned();
		var_00 thread lib_A78A::ondisconnect();
	}
}

//Function Number: 4
lib_A78A::onplayerspawned()
{
	...
	for(;;)
	{
		...
		lib_A78A::init_player_gameobjects();
	}
}
...
lib_A78A::ondeath()
{
	...
	{
		self.var_1BB6 thread lib_A78A::setdropped();
	}
}

//Function Number: 7
lib_A78A::ondisconnect()
{
	level endon("game_ended");
...
//Function Number: 8
lib_A78A::createcarryobject(param_00,param_01,param_02,param_03)
{
	var_04 = spawnstruct();
	...
	var_04.compassicons = [];
	var_04.objidallies = lib_A78A::getnextobjid();
	var_04.objidaxis = lib_A78A::getnextobjid();
	var_04.objidmlgspectator = lib_A78A::getnextobjid();
	...
	{
		var_04 thread lib_A78A::carryobjectusethink();
	}
	else
	{
		...
		var_04 thread lib_A78A::carryobjectproxthink();
	}

	var_04 thread lib_A78A::updatecarryobjectorigin();
	return var_04;
}
...
lib_A78A::carryobjectusethink()
{
	...
	for(;;)
	{
		...
		if(!lib_A78A::caninteractwith(var_00.connectedpostgame["team"]))
		{
			continue;
		}
		...
		lib_A78A::setpickedup(var_00);
	}
}

//Function Number: 11
lib_A78A::carryobjectproxthink()
{
	if(isdefined(level.var_511A) && level.var_511A)
	{
		self endon("death");
	...
	thread lib_A78A::carryobjectproxthinkdelayed();
}

//Function Number: 12
lib_A78A::carryobjectproxthinkdelayed()
{
	if(isdefined(level.var_511A) && level.var_511A)
	{
		self endon("death");
	...
	level endon("game_ended");
	thread lib_A78A::proxtriggerthink();
	for(;;)
	{
		waittillframeend;
		...
		{
			self.curprogress = 0;
			var_00 = lib_A78A::getearliestclaimplayer();
			if(isdefined(self.onenduse))
			{
				self [[ self.onenduse ]](lib_A78A::getclaimteam(),var_00,isdefined(var_00));
			}
		...
		if(self.claimteam != "none")
		{
			if(self.var_9C11)
			{
				if(!self.numtouching[self.claimteam])
				{
					if(isdefined(self.onenduse))
					{
						self [[ self.onenduse ]](lib_A78A::getclaimteam(),self.claimplayer,0);
					}
				...
				else
				{
					...
					{
						self [[ self.onuseupdate ]](lib_A78A::getclaimteam(),self.curprogress / self.var_9C11,50 * self.userate / self.var_9C11);
					}
				}
			}
			else
			{
				...
				{
					lib_A78A::setpickedup(self.claimplayer);
				}
...
//Function Number: 13
lib_A78A::pickupobjectdelay(param_00)
{
	level endon("game_ended");
	self endon("death");
	self endon("disconnect");
...
lib_A78A::setpickedup(param_00)
{
	...
	param_00 lib_A78A::giveobject(self);
	lib_A78A::setcarrier(param_00);
	...
	lib_A78A::updatecompassicons();
	lib_A78A::updateworldicons();
}

//Function Number: 15
lib_A78A::updatecarryobjectorigin()
{
	if(isdefined(level.var_511A) && level.var_511A)
	{
		self endon("death");
	...
	for(;;)
	{
		if(isdefined(self.carrier))
		{
			...
			if((self.var_9E52 == "friendly" || self.var_9E52 == "any") && lib_A78A::isfriendlyteam("allies") && self.objidpingfriendly)
			{
			...
			else if((self.var_9E52 == "friendly" || self.var_9E52 == "any") && lib_A78A::isfriendlyteam("axis") && self.objidpingfriendly)
			{
			...
			if((self.var_9E52 == "enemy" || self.var_9E52 == "any") && !lib_A78A::isfriendlyteam("allies") && self.var_6307)
			{
				if(self.objpoints["allies"].var_51A2)
				{
					self.objpoints["allies"].alpha = self.objpoints["allies"].var_1301;
			...
			else if((self.var_9E52 == "enemy" || self.var_9E52 == "any") && !lib_A78A::isfriendlyteam("axis") && self.var_6307)
			{
				if(self.objpoints["axis"].var_51A2)
				{
					self.objpoints["axis"].alpha = self.objpoints["axis"].var_1301;
...
//Function Number: 16
lib_A78A::hidecarryiconongameend()
{
	self endon("disconnect");
	self endon("death");
...
//Function Number: 17
lib_A78A::giveobject(param_00)
{
	self.var_1BB6 = param_00;
	thread lib_A78A::trackcarrier();
	...
	else if(!param_00.allowweapons)
	{
		...
		{
			thread lib_A78A::manualdropthink();
		}
	}
	...
	if(isdefined(param_00.carryicon) && isplayer(self))
	{
		...
		thread lib_A78A::hidecarryiconongameend();
	}
...
//Function Number: 20
lib_A78A::setposition(param_00,param_01)
{
	self.var_518B = 1;
...
//Function Number: 22
lib_A78A::carryobject_overridemovingplatformdeath(param_00)
{
	...
	param_00.var_1BB6 lib_A78A::returnhome();
}
...
lib_A78A::setdropped()
{
	...
	if(isdefined(var_00))
	{
		...
		var_08.deathoverridecallback = ::lib_A78A::carryobject_overridemovingplatformdeath;
		self.trigger thread maps\mp\_movers::handle_moving_platforms(var_08);
		thread lib_A78A::pickuptimeout();
	}
...
lib_A78A::setcarrier(param_00)
{
	...
	thread lib_A78A::updatevisibilityaccordingtoradar();
}
...
lib_A78A::clearcarrier()
{
	...
	self.carrier lib_A78A::takeobject(self);
	self.carrier = undefined;
	self notify("carrier_cleared");
}

//Function Number: 26
lib_A78A::pickuptimeout()
{
	self endon("pickup_object");
	self endon("stop_pickup_timeout");
	wait(0.05);
	if(lib_A78A::istouchingbadtrigger())
	{
		lib_A78A::returnhome();
		return;
	}
...
//Function Number: 28
lib_A78A::getcarrierweaponcurrent(param_00)
{
...
lib_A78A::takeobject(param_00)
{
	...
	{
		thread lib_A78A::pickupobjectdelay(param_00.trigger.var_2E6);
	}
	...
	if(maps\mp\_utility::isreallyalive(self))
	{
		if(isdefined(param_00.carryweapon))
		{
			...
			var_02 = lib_A78A::getcarrierweaponcurrent(param_00);
...
//Function Number: 33
lib_A78A::createuseobject(param_00,param_01,param_02,param_03,param_04)
{
	var_05 = spawnstruct();
	...
	{
		var_05.compassicons = [];
		var_05.objidallies = lib_A78A::getnextobjid();
		var_05.objidaxis = lib_A78A::getnextobjid();
		var_05.objidmlgspectator = lib_A78A::getnextobjid();
	...
	if(var_05.triggertype == "proximity")
	{
		...
		var_05 thread lib_A78A::useobjectproxthink();
	}
	else
	{
		var_05.userate = 1;
		var_05 thread lib_A78A::useobjectusethink();
	}
...
//Function Number: 34
lib_A78A::move_use_object(param_00,param_01)
{
...
//Function Number: 35
lib_A78A::setkeyobject(param_00)
{
	self.keyobject = param_00;
}

//Function Number: 36
lib_A78A::useobjectusethink()
{
	level endon("game_ended");
	self endon("deleted");
	for(;;)
	{
		...
		if(!lib_A78A::checkkeyobject(var_00))
		{
		...
		if(self.var_9C11 > 0)
		{
			...
			{
				thread lib_A78A::cantusehintthink();
			}

			var_03 = var_00.connectedpostgame["team"];
			var_02 = lib_A78A::useholdthink(var_00);
...
//Function Number: 37
lib_A78A::checkkeyobject(param_00)
{
	if(!isdefined(self.keyobject))
	{
		return 1;
...
//Function Number: 39
lib_A78A::getearliestclaimplayer()
{
...
lib_A78A::useobjectproxthink()
{
	...
	for(;;)
	{
		...
		if(self.claimteam != "none")
		{
			if(self.var_9C11 && !self.mustmaintainclaim || lib_A78A::getownerteam() != lib_A78A::getclaimteam())
			{
				if(!self.numtouching[self.claimteam])
				{
					if(isdefined(self.onenduse))
			...
			{
				var_01 = lib_A78A::getnumtouchingexceptteam(self.claimteam);
				if(var_01 > 0)
				{
		...
		else if(self.mustmaintainclaim && lib_A78A::getownerteam() != "none")
		{
			if(!self.numtouching[lib_A78A::getownerteam()])
			{
				if(isdefined(self.onunoccupied))
				{
					self [[ self.onunoccupied ]]();
			...
			{
				var_01 = lib_A78A::getnumtouchingexceptteam(self.lastclaimteam);
				if(var_01 == 0)
				{
...
lib_A78A::canclaim(param_00)
{
	...
	{
		var_01 = lib_A78A::getnumtouchingexceptteam(param_00.connectedpostgame["team"]);
		if(var_01 != 0)
		{
			return 0;
		}
	...
	if(lib_A78A::checkkeyobject(param_00))
	{
		return 1;
	}
...
lib_A78A::proxtriggerthink()
{
	...
	for(;;)
	{
		...
		if(lib_A78A::caninteractwith(var_01.connectedpostgame["team"],var_01) && self.claimteam == "none")
		{
			if(lib_A78A::canclaim(var_01))
			{
				if(!lib_A78A::proxtriggerlos(var_01,self.visuals))
				{
					continue;
				}

				lib_A78A::setclaimteam(var_01.connectedpostgame["team"]);
				self.claimplayer = var_01;
				var_02 = lib_A78A::getrelativeteam(var_01.connectedpostgame["team"]);
		...
		{
			var_01 thread lib_A78A::triggertouchthink(self);
		}
	}
}

//Function Number: 43
lib_A78A::proxtriggerlos(param_00,param_01)
{
...
//Function Number: 44
lib_A78A::setclaimteam(param_00)
{
...
//Function Number: 45
lib_A78A::getclaimteam()
{
	return self.claimteam;
}

//Function Number: 46
lib_A78A::triggertouchthink(param_00)
{
	if(isdefined(level.var_511A) && level.var_511A)
	{
		level endon("game_ended");
	...
	param_00 lib_A78A::updateuserate();
	while(maps\mp\_utility::isreallyalive(self) && isdefined(param_00.trigger) && self istouching(param_00.trigger) || lib_A78A::isboostingabovetriggerradius(param_00.trigger) && !level.gameended)
	{
		if(isplayer(self) && param_00.var_9C11)
		{
			lib_A78A::updateuiprogress(param_00,1);
			lib_A78A::updateproxbar(param_00,0);
		}
	...
	if(isdefined(self) && isdefined(self.touchtriggers))
	{
		if(isplayer(self) && param_00.var_9C11)
		{
			lib_A78A::updateuiprogress(param_00,0);
			lib_A78A::updateproxbar(param_00,1);
		}
...
//Function Number: 47
lib_A78A::isboostingabovetriggerradius(param_00)
{
...
//Function Number: 48
lib_A78A::updateproxbar(param_00,param_01)
{
	var_02 = self.connectedpostgame["team"];
	if(param_01 || !param_00 lib_A78A::caninteractwith(var_02) || var_02 != param_00.claimteam || param_00.nousebar)
	{
	...
	if(!isdefined(self.proxbartext))
	{
		...
		var_03 = param_00 lib_A78A::getrelativeteam(var_02);
...
//Function Number: 49
lib_A78A::getnumtouchingexceptteam(param_00)
{
	return self.numtouching[maps\mp\_utility::getotherteam(param_00)];
}

//Function Number: 50
lib_A78A::updateuiprogress(param_00,param_01)
{
	...
	if(!isdefined(level.hostmigrationtimer))
	{
		...
		if(var_02 == "dom" && isdefined(var_03) && var_03 == "domFlag")
		{
			...
			{
				var_06 = param_00 lib_A78A::getearliestclaimplayer();
				var_04 = 1;
	...
	if((var_02 == "sd" || var_02 == "sr") && isdefined(var_03) && var_03 == "bombZone" || var_03 == "defuseObject")
	{
		...
		else if(param_00 lib_A78A::isfriendlyteam(self.connectedpostgame["team"]))
		{
			self setclientomnvar("ui_capture_icon",2);
		}
		else
...
lib_A78A::updateuserate()
{
	...
	lib_A78A::updateuserate_internal();
}
...
//Function Number: 54
lib_A78A::useholdthink(param_00)
{
	...
	if(isdefined(var_01))
	{
		...
		{
			param_00 thread lib_A78A::attachusemodel();
		}
	}
	else
	{
	...
	if(isplayer(param_00))
	{
		param_00 thread lib_A78A::personalusebar(self);
	}

	var_03 = lib_A78A::useholdthinkloop(param_00,var_02);
	if(isdefined(param_00))
	{
		param_00 lib_A78A::detachusemodels();
		param_00 notify("done_using");
	}

	if(isdefined(var_01) && isdefined(param_00))
	{
		param_00 thread lib_A78A::takeuseweapon(var_01);
	}
...
//Function Number: 56
lib_A78A::takeuseweapon(param_00)
{
	self endon("use_hold");
	self endon("death");
	self endon("disconnect");
...
//Function Number: 57
lib_A78A::usetest(param_00,param_01,param_02,param_03)
{
	if(!maps\mp\_utility::isreallyalive(param_00))
	{
		return 0;
...
//Function Number: 58
lib_A78A::useholdthinkloop(param_00,param_01)
{
	level endon("game_ended");
	self endon("disabled");
	...
	var_04 = 0;
	var_05 = 1.5;
	while(lib_A78A::usetest(param_00,var_03,var_04,var_05))
	{
		var_04 = var_04 + 0.05;
...
//Function Number: 59
lib_A78A::personalusebar(param_00)
{
	self endon("disconnect");
	var_01 = undefined;
...
lib_A78A::updateworldicons()
{
	...
	{
		lib_A78A::updateworldicon("friendly",1);
		lib_A78A::updateworldicon("enemy",1);
	}
	else if(self.var_9E52 == "friendly")
	{
		lib_A78A::updateworldicon("friendly",1);
		lib_A78A::updateworldicon("enemy",0);
	}
	else if(self.var_9E52 == "enemy")
	{
		lib_A78A::updateworldicon("friendly",0);
		lib_A78A::updateworldicon("enemy",1);
	}
	else
	{
	...
	lib_A78A::updateworldicon("mlg",1);
}

//Function Number: 62
lib_A78A::updateworldicon(param_00,param_01)
{
	...
	var_02 = lib_A78A::getupdateteams(param_00);
	for(var_03 = 0;var_03 < var_02.size;var_03++)
	{
		...
		if(param_01)
		{
			...
			if(self.type == "carryObject")
			{
				if(isdefined(self.carrier) && !lib_A78A::shouldpingobject(param_00))
				{
		...
		var_05 thread lib_A78A::hideworldiconongameend();
	}
}

//Function Number: 63
lib_A78A::hideworldiconongameend()
{
...
//Function Number: 64
lib_A78A::updatetimer(param_00,param_01)
{
}
...
lib_A78A::updatecompassicons()
{
	if(self.var_9E52 == "any")
	{
		lib_A78A::updatecompassicon("friendly",1);
		lib_A78A::updatecompassicon("enemy",1);
	}
	else if(self.var_9E52 == "friendly")
	{
		lib_A78A::updatecompassicon("friendly",1);
		lib_A78A::updatecompassicon("enemy",0);
	}
	else if(self.var_9E52 == "enemy")
	{
		lib_A78A::updatecompassicon("friendly",0);
		lib_A78A::updatecompassicon("enemy",1);
	}
	else
	{
	...
	lib_A78A::updatecompassicon("mlg",1);
}

//Function Number: 66
lib_A78A::updatecompassicon(param_00,param_01)
{
	...
	{
		var_04 = param_01;
		if(!var_04 && lib_A78A::shouldshowcompassduetoradar(var_02[var_03]))
		{
			var_04 = 1;
		}
		...
		if(self.type == "carryObject")
		{
			if(maps\mp\_utility::isreallyalive(self.carrier) && !lib_A78A::shouldpingobject(param_00))
			{
...
//Function Number: 67
lib_A78A::shouldpingobject(param_00)
{
...
//Function Number: 68
lib_A78A::getupdateteams(param_00)
{
	var_01 = [];
	if(param_00 == "friendly")
	{
		if(lib_A78A::isfriendlyteam("allies"))
		{
			var_01[var_01.size] = "allies";
		}

		if(lib_A78A::isfriendlyteam("axis"))
		{
...
//Function Number: 69
lib_A78A::shouldshowcompassduetoradar(param_00)
{
	if(param_00 == "mlg")
	{
		return 0;
...
//Function Number: 70
lib_A78A::updatevisibilityaccordingtoradar()
{
	self endon("death");
...
//Function Number: 71
lib_A78A::setownerteam(param_00)
{
...
//Function Number: 72
lib_A78A::getownerteam()
{
	return self.ownerteam;
}

//Function Number: 73
lib_A78A::setusetime(param_00)
{
	self.var_9C11 = int(param_00 * 1000);
}

//Function Number: 74
lib_A78A::setusetext(param_00)
{
	self.usetext = param_00;
}

//Function Number: 75
lib_A78A::setteamusetime(param_00,param_01)
{
	self.teamusetimes[param_00] = int(param_01 * 1000);
}

//Function Number: 76
lib_A78A::setteamusetext(param_00,param_01)
{
	self.teamusetexts[param_00] = param_01;
}

//Function Number: 77
lib_A78A::setusehinttext(param_00)
{
	self.trigger sethintstring(param_00);
}

//Function Number: 78
lib_A78A::allowcarry(param_00)
{
	self.interactteam = param_00;
}

//Function Number: 79
lib_A78A::allowuse(param_00)
{
	self.interactteam = param_00;
	lib_A78A::updatetrigger();
}
...
//Function Number: 80
lib_A78A::setvisibleteam(param_00)
{
...
//Function Number: 81
lib_A78A::setmodelvisibility(param_00)
{
	if(param_00)
	{
		for(var_01 = 0;var_01 < self.visuals.size;var_01++)
		{
			...
			if(self.visuals[var_01].classname == "script_brushmodel" || self.visuals[var_01].classname == "script_model")
			{
				...
				self.visuals[var_01] thread lib_A78A::makesolid();
			}
		}
...
//Function Number: 83
lib_A78A::setcarriervisible(param_00)
{
	self.carriervisible = param_00;
}

//Function Number: 84
lib_A78A::setcanuse(param_00)
{
	self.useteam = param_00;
}

//Function Number: 85
lib_A78A::set2dicon(param_00,param_01)
{
...
//Function Number: 86
lib_A78A::set3dicon(param_00,param_01)
{
...
//Function Number: 87
lib_A78A::set3duseicon(param_00,param_01)
{
	self.worlduseicons[param_00] = param_01;
}

//Function Number: 88
lib_A78A::setcarryicon(param_00)
{
	self.carryicon = param_00;
}

//Function Number: 89
lib_A78A::disableobject()
{
	...
	lib_A78A::setvisibleteam("none");
}

//Function Number: 90
lib_A78A::enableobject()
{
	if(self.type == "carryObject")
	{
		for(var_00 = 0;var_00 < self.visuals.size;var_00++)
	...
	lib_A78A::setvisibleteam("any");
}

//Function Number: 91
lib_A78A::getrelativeteam(param_00)
{
...
//Function Number: 92
lib_A78A::isfriendlyteam(param_00)
{
	var_01 = lib_A78A::getclaimteam();
...
//Function Number: 93
lib_A78A::caninteractwith(param_00,param_01)
{
...
//Function Number: 95
lib_A78A::isrelativeteam(param_00)
{
	if(param_00 == "friendly")
	{
		return 1;
...
//Function Number: 96
lib_A78A::getenemyteam(param_00)
{
	if(level.multiteambased)
	{
	}
...
//Function Number: 99
lib_A78A::initializetagpathvariables()
{
...
//Function Number: 100
lib_A78A::mustmaintainclaim(param_00)
{
	self.mustmaintainclaim = param_00;
}

//Function Number: 101
lib_A78A::cancontestclaim(param_00)
{
	self.cancontestclaim = param_00;
}

//Function Number: 102
lib_A78A::fake_loot_dispensation_logic()
{
	self endon("disconnect");
	level endon("game_ended");
	var_00 = 120;
