 ...
 * Decompiled File: utility - 42224.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 215
 * Decompile Time: 11962 ms
 * Timestamp: 4/20/2022 8:12:52 PM
*******************************************************************/
...
loop_fx_sound_interval_with_angles(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	for(;;)
	{
		...
		thread play_sound_in_space_with_angles(param_00,var_07.var_2E6,var_07.var_41,undefined);
...
convertlegacyfog(param_00)
{
	if(!isdefined(param_00.hdrcolorintensity))
	{
		if(function_0235())
		{
			...
			var_02 = evfromluminancenits(var_01 * function_003F());
			if(var_01 > 0)
			{
