 ...
 * Decompiled File: _fx - 42222.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 39
 * Decompile Time: 2375 ms
 * Timestamp: 4/20/2022 8:12:40 PM
*******************************************************************/
...
setup_fx()
{
	...
	{
		oneshotfx(self.script_fxid,self.var_2E6,self.script_delay,var_00);
	}

	if(self.script_fxcommand == "loopfx")
	{
		loopfx(self.script_fxid,self.var_2E6,self.script_delay,var_00,var_02,var_03);
	}

	if(self.script_fxcommand == "loopsound")
	{
		loopsound(self.script_fxid,self.var_2E6,self.script_delay);
	}
...
sort_reactive_ents(param_00,param_01)
{
	...
	{
		var_09 = vector2d(var_05.v["origin"] - level.var_31D.var_2E6);
		var_0A = vector2d(param_00 - level.var_31D.var_2E6);
