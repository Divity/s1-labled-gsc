...
//Function Number: 2
lib_A7A2::createteamobjpoint(param_00,param_01,param_02,param_03,param_04,param_05)
{
	var_06 = lib_A7A2::getobjpointbyname(param_00);
	if(isdefined(var_06))
	{
		lib_A7A2::deleteobjpoint(var_06);
	}
	...
	var_06.y = param_01[1];
	var_06.z = param_01[2];
	var_06.inliveplayerkillstreak = param_02;
	var_06.isflashing = 0;
	var_06.var_51A2 = 1;
...
//Function Number: 3
lib_A7A2::deleteobjpoint(param_00)
{
	...
	var_03 = lib_A7A2::getobjpointbyindex(var_02);
...
//Function Number: 4
lib_A7A2::updateorigin(param_00)
{
...
//Function Number: 5
lib_A7A2::setoriginbyname(param_00,param_01)
{
	var_02 = lib_A7A2::getobjpointbyname(param_00);
	var_02 lib_A7A2::updateorigin(param_01);
}

//Function Number: 6
lib_A7A2::getobjpointbyname(param_00)
{
...
//Function Number: 7
lib_A7A2::getobjpointbyindex(param_00)
{
...
lib_A7A2::startflashing()
{
	...
	while(self.isflashing)
	{
		...
		self.alpha = 0.35 * self.var_1301;
		wait(0.75);
		self fadeovertime(0.75);
		self.alpha = self.var_1301;
		wait(0.75);
	}
