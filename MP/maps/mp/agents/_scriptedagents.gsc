 ...
 * Timestamp: 4/20/2022 8:13:03 PM
*******************************************************************/
...
waituntilnotetrack(param_00,param_01,param_02,param_03,param_04)
{
	...
	{
		var_07 = function_0063(self getanimentry(param_02,param_03));
	}
...
getsafeanimmovedeltapercentage(param_00)
{
	...
	var_03 = getvalidpointtopointmovelocation(self.var_2E6,var_02);
	var_04 = distance(self.var_2E6,var_03);
	var_05 = distance(self.var_2E6,var_02);
