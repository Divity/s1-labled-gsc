 ...
 * Platform: PC
 * Function Count: 13
 * Decompile Time: 739 ms
 * Timestamp: 4/20/2022 8:13:01 PM
*******************************************************************/
...
spawn_agent_player(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	if(isdefined(param_00) && isdefined(param_01))
	{
		...
		self.lastspawnpoint.var_2E6 = var_06;
		self.lastspawnpoint.var_41 = var_07;
	}
	else
	{
		var_08 = self [[ level.getspawnpoint ]]();
		var_06 = var_08.var_2E6;
		var_07 = var_08.var_41;
	...
	maps\mp\gametypes\_class::giveandapplyloadout(self.inliveplayerkillstreak,self.class,1);
...
agent_damage_finished(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	if(isdefined(param_00) || isdefined(param_01))
	{
		...
		if(isdefined(param_01) && param_04 != "MOD_FALLING" && param_04 != "MOD_SUICIDE")
		{
			if(level.teambased)
			{
				if(isdefined(param_01.inliveplayerkillstreak) && param_01.inliveplayerkillstreak != self.inliveplayerkillstreak)
				{
...
finishagentdamage_impactfxwrapper(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	self method_8540(param_00,param_01,param_02,param_03,param_04,param_05,param_06);
}
...
on_agent_generic_damaged(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	...
	{
		param_02 = [[ level.idflags_stun ]](self,param_00,param_01,param_02,param_04,param_05,param_06,param_07,param_08);
	}

	if(isdefined(param_01) && param_01 != self && param_02 > 0 && !isdefined(param_08) || param_08 != "shield")
	{
		if(param_03 & level.var_4B5E)
		{
			var_0C = "stun";
		}
...
on_humanoid_agent_killed_common(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	if(maps\mp\_riotshield::hasriotshieldequipped())
	{
		...
		if(!param_09)
		{
			var_0A = self method_8250(self getcurrentweapon());
			if(isdefined(var_0A))
			{
	...
	if(param_09)
	{
		self thread [[ level.var_A2CF ]](param_01,param_03);
	}
