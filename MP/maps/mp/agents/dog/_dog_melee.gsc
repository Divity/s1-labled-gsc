 ...
 * Timestamp: 4/20/2022 8:12:54 PM
*******************************************************************/
...
main()
{
	...
	var_00 = self.curmeleetarget.var_2E6 - self.var_2E6;
	...
	else
	{
		...
		var_03 = self.curmeleetarget.var_2E6 - var_01 * self.attackoffset;
	}

	var_04 = 0;
	var_05 = self.var_2E6 + (0,0,30);
	var_06 = self.curmeleetarget.var_2E6 + (0,0,30);
	...
	if(var_02)
	{
		var_08 = maps\mp\agents\_scriptedagents::canmovepointtopoint(self.var_2E6,var_03);
	}
	else
	{
		var_08 = 1;
...
shoulddoextendedkill(param_00)
{
	...
	{
		var_06 = 0;
		var_07 = rotatevector((1,0,0),param_00.var_41);
	}
	else if(var_07 < -0.707)
	{
		var_06 = 1;
		var_07 = rotatevector((-1,0,0),var_01.var_41);
	}
	else
	{
		...
		{
			var_06 = 3;
			var_07 = rotatevector((0,-1,0),param_00.var_41);
		}
		else
		{
			var_06 = 2;
	...
	var_0A = param_00.var_2E6 - var_09 * var_07;
	...
	if(!self aiphysicstracepassed(param_00.var_2E6 + (0,0,4),var_0B + (0,0,4),self.radius,self.height))
	{
		return undefined;
	}
...
doextendedkill(param_00)
{
	...
	thread extendedkill_sticktovictim(var_02,self.curmeleetarget.var_2E6,self.curmeleetarget.var_41);
...
extendedkill_sticktovictim(param_00,param_01,param_02)
{
	...
	self linkto(var_03);
	self doanimrelative(param_00,param_01,param_02);
}
...
dostandardkill(param_00,param_01)
{
	...
	if(!param_01)
	{
		...
		{
			var_04 = maps\mp\agents\_scriptedagents::droppostoground(self.curmeleetarget.var_2E6);
			if(isdefined(var_04))
			{
				var_03 = 1;
				param_00 = var_04;
	...
	self doanimlerp(self.var_2E6,param_00,var_08);
...
updatelerppos(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		self doanimlerp(self.var_2E6,var_05,var_03);
	}
}
...
getupdatedattackpos(param_00,param_01)
{
	if(!param_01)
	{
		var_02 = maps\mp\agents\_scriptedagents::droppostoground(param_00.var_2E6);
		return var_02;
	}

	var_03 = param_01.var_2E6 - self.var_2E6;
	...
	var_03 = var_03 / var_04;
	var_05 = param_01.var_2E6 - var_03 * self.attackoffset;
	if(maps\mp\agents\_scriptedagents::canmovepointtopoint(self.var_2E6,var_05))
	{
		return var_05;
	}
...
isprotectedbyriotshield(param_00)
{
	...
	{
		var_01 = self.var_2E6 - param_00.var_2E6;
...
domeleedamage(param_00,param_01,param_02)
{
	...
	param_00 dodamage(param_01,self.var_2E6,self,self,param_02);
}

//Function Number: 12
meleefailed()
{
	self.lastmeleefailedmypos = self.var_2E6;
	self.lastmeleefailedpos = self.curmeleetarget.var_2E6;
}