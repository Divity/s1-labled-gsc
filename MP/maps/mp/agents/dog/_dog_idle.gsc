 ...
 * Platform: PC
 * Function Count: 16
 * Decompile Time: 966 ms
 * Timestamp: 4/20/2022 8:12:53 PM
*******************************************************************/
...
{
	var_00 = undefined;
	if(isdefined(self.enemy) && distancesquared(self.enemy.var_2E6,self.var_2E6) < 1048576)
	{
		var_00 = self.enemy;
	}
	else if(isdefined(self.owner) && distancesquared(self.owner.var_2E6,self.var_2E6) > 576)
	{
		var_00 = self.owner;
	}
	...
	if(isdefined(var_00))
	{
		var_01 = var_00.var_2E6 - self.var_2E6;
		var_02 = vectortoangles(var_01);
		if(abs(angleclamp180(var_02[1] - self.var_41[1])) > 1)
		{
...
shouldattackidle()
{
	return isdefined(self.enemy) && maps\mp\_utility::isreallyalive(self.enemy) && distancesquared(self.var_2E6,self.enemy.var_2E6) < 1000000;
}
...
turntoangle(param_00)
{
	...
	if(animhasnotetrack(var_04,"turn_begin") && animhasnotetrack(var_04,"turn_end"))
	{
		...
		var_0C = (0,angleclamp180(self.var_41[1] + var_0A),0);
...
{
	if(abs(angleclamp180(param_00 - self.var_41[1])) <= param_01)
	{
		return;
	}
	...
	while(angleclamp180(param_00 - self.var_41[1]) > param_01)
	{
		wait(0.1);
	}
}
