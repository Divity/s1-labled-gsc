 ...
 * Timestamp: 4/20/2022 8:12:59 PM
*******************************************************************/
...
main()
{
	...
	{
		var_02 = var_01.var_2E6 - var_00.var_2E6;
		var_03 = length(var_02) / 256;
		var_04 = (var_02[0],var_02[1],0);
		var_05 = vectortoangles(var_04);
		self setorientmode("face angle abs",var_05);
		self doanimlerp(var_00.var_2E6,var_01.var_2E6,var_03);
	...
	self.blockgoalpos = 1;
	var_02 = var_05.var_2E6 - var_04.var_2E6;
	var_04 = (var_06[0],var_06[1],0);
	var_05 = vectortoangles(var_06);
	self setorientmode("face angle abs",var_06);
	...
	if(var_04[2] > 0)
	{
		if(var_09[2] > 0)
		{
			...
			if(var_0B.size > 0)
			{
				...
				self setanimscale(var_0C,var_0D);
				...
				var_0C = 1;
				var_0D = 1;
				var_11 = var_02.var_2E6 - self.var_2E6;
		...
		if(var_1A.size > 0)
		{
			...
			if(isdefined(var_1B))
			{
				var_1C = var_1B - self.var_2E6;
				var_1D = var_02.var_2E6 - var_1B;
		...
		var_20 = function_0063(var_1A);
		self doanimlerp(var_05.var_2E6,var_06.var_2E6,var_20);
	...
	if(var_20.size > 0)
	{
		...
		if(abs(var_22) > 0)
		{
			var_23 = self.var_2E6[2] - var_07.var_2E6[2];
			var_0D = var_23 / var_22;
			self setanimscale(var_1E.xy,var_0D);
	...
	{
		self setanimscale(var_1E.xy,var_1E.z);
...
gettargetentpos()
{
	...
	self.targetentpos = var_00.var_2E6;
	var_00 delete();
	return self.targetentpos;
}
