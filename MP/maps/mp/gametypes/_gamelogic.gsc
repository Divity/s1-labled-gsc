 ...
 * Decompiled File: _gamelogic - 42889.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 97
 * Decompile Time: 5693 ms
 * Timestamp: 4/20/2022 8:13:57 PM
*******************************************************************/
...
updatematchbonusscores(param_00)
{
	...
	foreach(var_04 in level.var_328)
	{
		...
		var_04 thread givematchbonus(var_0B,var_04.var_59DC);
	}
}
...
updatecombatrecordcommondata()
{
	...
	incrementcombatrecordstat("xpEarned",self.connectedpostgame["summary"]["xp"]);
