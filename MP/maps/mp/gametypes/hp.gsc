 ...
 * Platform: PC
 * Function Count: 40
 * Decompile Time: 2400 ms
 * Timestamp: 4/20/2022 8:15:30 PM
*******************************************************************/
...
updategameobjecthudindex()
{
	for(;;)
	{
		...
		{
			var_02 = var_01;
			if(var_01.inliveplayerkillstreak == "spectator" || var_01.sessionstate == "spectator")
			{
...
forcespawnteam(param_00)
{
	...
	for(var_02 = 0;var_02 < var_01.size;var_02++)
	{
		...
		if(var_03.connectedpostgame["team"] == param_00)
		{
...
onzonecapture(param_00)
{
	...
	var_03 = gettime();
	param_00 method_8026("zone captured");
	...
	if(isdefined(self.lastcaptureteam) && self.lastcaptureteam != var_01)
	{
		...
		{
			param_00 = level.var_328[var_07];
			if(param_00.connectedpostgame["team"] == var_01)
			{
...
give_capture_credit(param_00,param_01,param_02,param_03)
{
	...
	{
		var_06 = param_00[var_04[var_05]].var_31D;
...
movezoneaftertime(param_00)
{
	...
	if(!isdefined(level.zone.gameobject.wascontested) || level.zone.gameobject.wascontested == 0)
	{
		if(!isdefined(level.zone.gameobject.wasleftunoccupied) || level.zone.gameobject.wasleftunoccupied == 0)
		{
			...
			{
				if(var_03.connectedpostgame["team"] == var_01)
				{
...
matchzonestotriggers(param_00,param_01)
{
	for(var_02 = 0;var_02 < param_00.size;var_02++)
	{
		...
		var_04.trigorigin = var_04.trig.var_2E6;
		var_06 = [];
		var_06[0] = var_04;
		...
		var_04.gameobject.objpoints["allies"] cleartargetent(var_04.trig);
		var_04.gameobject.objpoints["axis"] cleartargetent(var_04.trig);
		var_04.gameobject.objpoints["mlg"] cleartargetent(var_04.trig);
...
setupnearbyspawns()
{
	...
	{
		var_00[var_01].distsq = distancesquared(var_00[var_01].var_2E6,self.var_2E6);
	}
...
onplayerkilled(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	...
	if(self istouching(level.zone.trig))
	{
		...
		if(self.inliveplayerkillstreak == var_0A)
		{
