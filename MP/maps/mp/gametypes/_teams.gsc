 ...
 * Decompiled File: _teams - 42930.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 49
 * Decompile Time: 3301 ms
 * Timestamp: 4/20/2022 8:14:54 PM
*******************************************************************/
...
setplayermodels()
{
	...
	setghilliemodels(getmapcustomfield("environment"));
}
...
updatefreeplayertimes()
{
	...
	for(;;)
	{
		...
		{
			level.var_328[var_00] updatefreeplayedtime();
		}
