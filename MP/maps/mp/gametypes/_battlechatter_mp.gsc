 ...
 * Decompiled File: _battlechatter_mp - 42880.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 53
 * Decompile Time: 4319 ms
 * Timestamp: 4/20/2022 8:13:33 PM
*******************************************************************/
...
dothreatcalloutresponse(param_00,param_01)
{
	...
	if(var_02 == param_00)
	{
		...
		foreach(var_08 in level.participants)
		{
			...
			if((var_05 != var_08.connectedpostgame["voiceNum"] || var_04 != var_09) && distancesquared(var_06,var_08.var_2E6) <= 262144 && !isspeakerinrange(var_08))
			{
