 ...
 * Decompiled File: _weapons - 42932.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 156
 * Decompile Time: 12497 ms
 * Timestamp: 4/20/2022 8:15:08 PM
*******************************************************************/
...
watchc4usage()
{
	...
	for(;;)
	{
		...
		if(var_01 == "c4" || var_01 == "c4_mp")
		{
			...
			var_00 thread setmineteamheadicon(self.connectedpostgame["team"]);
		}
	}
}
...
spawnmine(param_00,param_01,param_02,param_03,param_04)
{
	...
	var_06 thread setmineteamheadicon(param_01.connectedpostgame["team"]);
...
minechangeowner(param_00)
{
	if(isdefined(self.fx_origin))
	{
		...
		if(self.fx_origin == "bouncingbetty_mp")
		{
			...
			equipmentdisableuse(param_00);
			thread minebeacon();
			thread setmineteamheadicon(param_00.inliveplayerkillstreak);
