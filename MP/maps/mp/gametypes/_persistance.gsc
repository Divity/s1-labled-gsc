 ...
 * Decompiled File: _persistance - 42916.gsc
...
init()
{
	...
	level thread func_9AF2();
	level thread func_9BC2();
}
...
//Function Number: 5
func_8D4A(param_00,param_01,param_02)
{
	if(!maps\mp\_utility::rankingenabled() || maps\mp\_utility::practiceroundgame())
	{
		return;
...
//Function Number: 7
func_8D74(param_00,param_01,param_02)
{
	if(isagent(self))
	{
		return;
...
//Function Number: 8
func_8D4D(param_00,param_01,param_02)
{
	if(!maps\mp\_utility::rankingenabled() || maps\mp\_utility::practiceroundgame())
	{
		return;
...
//Function Number: 10
func_8D75(param_00,param_01,param_02)
{
	if(!maps\mp\_utility::rankingenabled())
	{
		return;
...
//Function Number: 11
func_8D4E(param_00,param_01,param_02)
{
	if(!maps\mp\_utility::rankingenabled())
	{
		return;
	...
	var_03 = func_8D65(param_00,param_01);
	func_8D75(param_00,param_01,var_03 + param_02);
}

//Function Number: 12
func_8D4C(param_00,param_01,param_02)
{
	if(!maps\mp\_utility::rankingenabled())
	{
		return;
	...
	var_03 = func_8D63(param_00) + param_01;
	if(var_03 > param_02)
	{
		var_03 = param_02;
	}

	if(var_03 < func_8D63(param_00))
	{
		var_03 = param_02;
	}

	func_8D73(param_00,var_03);
}

//Function Number: 13
func_8D4F(param_00,param_01,param_02,param_03)
{
	if(!maps\mp\_utility::rankingenabled())
	{
		return;
	...
	var_04 = func_8D65(param_00,param_01) + param_02;
	if(var_04 > param_03)
	{
		var_04 = param_03;
	}

	if(var_04 < func_8D65(param_00,param_01))
	{
		var_04 = param_03;
	}

	func_8D75(param_00,param_01,var_04);
}
...
func_8D4B(param_00,param_01)
{
	...
	var_02 = func_8D63(param_00);
	func_8D73(param_00,var_02 + param_01);
}
...
func_9AF2()
{
	...
	while(!level.gameended)
	{
		...
		{
			level.var_328[var_00] func_A357();
			level.var_328[var_00] func_9B9C();
		}
...
//Function Number: 19
func_4C3D(param_00,param_01,param_02)
{
...
//Function Number: 20
func_4C3A(param_00,param_01,param_02)
{
	if(maps\mp\_utility::rankingenabled() && !maps\mp\_utility::practiceroundgame())
	{
...
func_9B9C()
{
	...
	if(var_01[0] == "gl" || var_01[0] == "shotgun")
	{
		...
		{
			func_4C3A(var_01[0],"shots",self.trackingweaponshots);
		}

		if(self.trackingweaponkills > 0)
		{
			func_4C3A(var_01[0],"kills",self.trackingweaponkills);
		}

		if(self.trackingweaponhits > 0)
		{
			func_4C3A(var_01[0],"hits",self.trackingweaponhits);
		}

		if(self.trackingweaponheadshots > 0)
		{
			func_4C3A(var_01[0],"headShots",self.trackingweaponheadshots);
		}

		if(self.trackingweapondeaths > 0)
		{
			func_4C3A(var_01[0],"deaths",self.trackingweapondeaths);
		}

		if(self.trackingweaponhipfirekills > 0)
		{
			func_4C3A(var_01[0],"hipfirekills",self.trackingweaponhipfirekills);
		}

		if(self.trackingweaponusetime > 0)
		{
			func_4C3A(var_01[0],"timeInUse",self.trackingweaponusetime);
		}
	...
	foreach(var_07 in var_05)
	{
		...
		if(self.trackingweaponshots > 0)
		{
			if(var_08 != "tactical")
			{
				func_4C3A(var_08,"shots",self.trackingweaponshots);
			}
		}
		...
		if(self.trackingweaponkills > 0)
		{
			if(var_08 != "tactical")
			{
				func_4C3A(var_08,"kills",self.trackingweaponkills);
			}
		}
		...
		if(self.trackingweaponhits > 0)
		{
			if(var_08 != "tactical")
			{
				func_4C3A(var_08,"hits",self.trackingweaponhits);
			}
		}
		...
		if(self.trackingweaponheadshots > 0)
		{
			if(var_08 != "tactical")
			{
				func_4C3A(var_08,"headShots",self.trackingweaponheadshots);
			}
		}
		...
		if(self.trackingweaponhipfirekills > 0)
		{
			if(var_08 != "tactical")
			{
				func_4C3A(var_08,"hipfirekills",self.trackingweaponhipfirekills);
			}
		}
		...
		if(self.trackingweaponusetime > 0)
		{
			if(var_08 != "tactical")
			{
				func_4C3A(var_08,"timeInUse",self.trackingweaponusetime);
			}
		}

		if(self.trackingweapondeaths > 0)
		{
			func_4C3A(var_08,"deaths",self.trackingweapondeaths);
		}
	}
