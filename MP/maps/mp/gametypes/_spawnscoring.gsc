 ...
 * Decompiled File: _spawnscoring - 42928.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 46
 * Decompile Time: 2786 ms
 * Timestamp: 4/20/2022 8:14:50 PM
*******************************************************************/
...
findbuddyspawn()
{
	...
	var_01 = getteammatesoutofcombat(self.inliveplayerkillstreak);
	var_02 = spawnstruct();
	...
	foreach(var_04 in var_01)
	{
		...
		if(issafetospawnon(var_04,var_05,var_02))
		{
			...
			var_00.var_41 = getbuddyspawnangles(var_04,var_00.var_2E6);
			break;
		}
