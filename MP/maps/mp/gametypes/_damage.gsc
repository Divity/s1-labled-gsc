 ...
 * Decompiled File: _damage - 42883.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 98
 * Decompile Time: 5678 ms
 * Timestamp: 4/20/2022 8:13:45 PM
*******************************************************************/
...
playerkilled_internal(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A)
{
	...
	if(var_0B)
	{
		if(isdefined(common_scripts\utility::getfx("exo_knife_blood")))
		{
			...
			{
				function_0156(param_02 gettagorigin(gethitloctag(param_07)),param_06);
			}
			else
			{
...
callback_playerdamage_internal(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A)
{
	...
	if(!param_04 & level.var_4B56)
	{
		...
		else
		{
			...
			{
				addattacker(param_02,param_01.var_7BFC,param_00,param_06,param_03,param_07,param_08,param_09,param_0A,param_05);
			}
