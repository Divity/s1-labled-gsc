...
getstartspawnpoints(param_00)
{
	...
	if(!isdefined(level.dmstartspawnpoints[param_00]))
	{
		...
		{
			if(isdefined(var_03.var_39B) && var_03.var_39B == "start_spawn")
			{
	...
	if(level.dmstartspawnpoints[param_00].size >= level.var_328.size)
	{
...
getspawnpoint()
{
	...
	{
		var_00 = getstartspawnpoints(self.inliveplayerkillstreak);
		var_01 = maps\mp\gametypes\_spawnlogic::getspawnpoint_random(var_00);
	}
	else
	{
		var_00 = maps\mp\gametypes\_spawnlogic::getteamspawnpoints(self.inliveplayerkillstreak);
