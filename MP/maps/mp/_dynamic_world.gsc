 ...
 * Platform: PC
 * Function Count: 73
 * Decompile Time: 2640 ms
 * Timestamp: 4/20/2022 8:17:11 PM
*******************************************************************/
...
jet_flyby()
{
	...
	thread jet_planesound(self.jet_parts[0],level.var_5983);
	wait(0.05);
...
sliding_door()
{
	...
	for(;;)
	{
		...
		{
			if((isdefined(var_09.inliveplayerkillstreak) && var_09.inliveplayerkillstreak == "spectator") || isdefined(var_09.sessionstate) && var_09.sessionstate == "spectator")
			{
				continue;
			}
