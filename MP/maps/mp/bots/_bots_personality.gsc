 ...
 * Timestamp: 4/20/2022 8:13:17 PM
*******************************************************************/
...
bot_assign_personality_functions()
{
	...
	self.connectedpostgame["personality"] = self.personality;
...
bot_balance_personality()
{
	...
	if(isdefined(self.connectedpostgame["personality"]))
	{
		self botsetpersonality(self.connectedpostgame["personality"]);
		return;
	}
	...
	{
		if(maps\mp\_utility::isteamparticipant(var_0A) && isdefined(var_0A.inliveplayerkillstreak) && var_0A.inliveplayerkillstreak == var_00 && var_0A != self && isdefined(var_0A.has_balanced_personality))
		{
...
bot_find_ambush_entrances(param_00,param_01)
{
	self endon("disconnect");
	var_02 = [];
	var_03 = findentrances(param_00.var_2E6);
	if(isdefined(var_03) && var_03.size > 0)
	{
		...
		if(var_04 && param_01)
		{
			var_03 = self botnodescoremultiple(var_03,"node_exposure_vis",param_00.var_2E6,"crouch");
		}

		foreach(var_06 in var_03)
		{
			if(distancesquared(self.var_2E6,var_06.var_2E6) < 90000)
			{
				continue;
			}
			...
			{
				wait(0.05);
				if(!maps\mp\bots\_bots_util::entrance_visible_from(var_06.var_2E6,param_00.var_2E6,"crouch"))
				{
					continue;
				}
			}
...
bot_filter_ambush_vicinity(param_00,param_01,param_02)
{
	...
	if(level.teambased)
	{
		foreach(var_07 in level.participants)
		{
			...
			if(!isdefined(var_07.inliveplayerkillstreak))
			{
				continue;
			}

			if(var_07.inliveplayerkillstreak == param_01.inliveplayerkillstreak && var_07 != param_01 && isdefined(var_07.node_ambushing_from))
			{
				var_04[var_04.size] = var_07.node_ambushing_from.var_2E6;
			}
		}
	}
	...
	for(var_0B = 0;var_0B < var_0A;var_0B++)
	{
		...
		{
			var_0F = distancesquared(var_04[var_0E],var_0D.var_2E6);
...
find_camp_node_worker()
{
	...
	var_00 = getzonenearest(self.var_2E6);
	var_01 = undefined;
	var_02 = undefined;
	var_03 = self.var_41;
	if(isdefined(var_00))
	{
		var_04 = botzonenearestcount(var_00,self.inliveplayerkillstreak,-1,"enemy_predict",">",0,"ally","<",1);
		if(!isdefined(var_04))
		{
			var_04 = botzonenearestcount(var_00,self.inliveplayerkillstreak,-1,"enemy_predict",">",0);
		}

		if(isdefined(var_04))
		{
			var_05 = getzonenodeforindex(var_04);
			var_06 = function_0210(var_05);
			if(var_06.size == 0)
			{
				var_04 = undefined;
			}
		...
		if(!isdefined(var_04))
		{
			...
			for(var_09 = 0;var_09 < level.zonecount;var_09++)
			{
				...
				if(var_06.size > 0)
				{
					...
					if(!var_0B)
					{
						var_0C = distance2dsquared(getzoneorigin(var_09),self.var_2E6);
						if(var_0C > var_07)
						{
							var_07 = var_0C;
							var_08 = var_09;
...
find_ambush_node(param_00,param_01)
{
	...
	{
		var_02 = undefined;
		var_03 = getnodesinradius(self.var_2E6,5000,0,2000);
		if(var_03.size > 0)
		{
		...
		if(isdefined(var_02))
		{
			self.point_to_ambush = var_02.var_2E6;
		}
		else
		{
			return 0;
	...
	self.ambush_end = gettime() + self.ambush_duration;
	self.node_ambushing_from.bot_ambush_end = self.ambush_end;
	var_08 = vectornormalize(self.point_to_ambush - self.node_ambushing_from.var_2E6);
...
bot_random_path()
{
	...
	var_00 = level.bot_random_path_function[self.inliveplayerkillstreak];
	return self [[ var_00 ]]();
}
