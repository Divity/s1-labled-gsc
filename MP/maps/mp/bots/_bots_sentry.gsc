 ...
 * Timestamp: 4/20/2022 8:13:18 PM
*******************************************************************/
...
//Function Number: 2
bot_can_use_sentry_only_ai_version(param_00)
{
	foreach(var_02 in param_00.var_5D57)
	{
		if(var_02 == "sentry_guardian")
		{
			return 1;
		}
	}
...
bot_sentry_add_goal(param_00,param_01,param_02,param_03)
{
	...
	if(isdefined(var_04))
	{
		...
		var_05.end_thread = 10;
		var_05.var_8CBD = ::bot_sentry_path_start;
		var_05.var_3150 = ::bot_sentry_cancel;
		...
		maps\mp\bots\_bots_strategy::bot_new_tactical_goal("sentry_placement",var_04.node.var_2E6,0,var_05);
	}
}
...
bot_sentry_path_thread(param_00)
{
	...
	{
		if(distance2d(self.var_2E6,param_00.object.node.var_2E6) < 400)
		{
			thread maps\mp\bots\_bots_util::bot_force_stance_for_time("stand",5);
			thread bot_sentry_cancel_failsafe();
			maps\mp\bots\_bots_ks::func_1708(param_00.object.killstreak_info,param_00.object.killstreaks_array,param_00.object.weapon);
			return;
		}
...
bot_sentry_choose_target(param_00)
{
	...
	{
		return self.node_ambushing_from.var_2E6;
	}

	var_02 = getnodesinradius(self.var_2E6,1000,0,512);
	var_03 = 5;
	if(param_00 != "turret")
	{
...
bot_sentry_choose_placement(param_00,param_01,param_02,param_03)
{
	...
	if(isdefined(var_07))
	{
		var_04 = spawnstruct();
		var_04.node = var_07;
		if(param_01 != var_07.var_2E6 && param_02 != "hide_nonlethal")
		{
			var_04.yaw = vectortoyaw(param_01 - var_07.var_2E6);
		}
		else
		{
...
bot_sentry_activate(param_00)
{
	...
	if(isdefined(var_02))
	{
		...
		if(!var_02.canbeplaced)
		{
			...
			{
				var_0B = playerphysicstrace(param_00.object.node.var_2E6,param_00.object.node.var_2E6 + anglestoforward((0,var_0A + 180,0)) * 100);
				var_0C = distance2d(var_0B,param_00.object.node.var_2E6);
				if(var_0C < var_08)
				{
					var_08 = var_0C;
					self botsetscriptmove(var_0A,var_04);
					self botlookatpoint(param_00.object.node.var_2E6,var_04,"script_forced");
				}
			}
