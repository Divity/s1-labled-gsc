...
bot_cache_entrances_to_bombzones()
{
	...
	{
		var_00[var_02] = common_scripts\utility::random(var_04.bottargets).var_2E6;
...
bot_cache_entrances_to_gametype_array(param_00,param_01,param_02,param_03)
{
	...
	foreach(var_0A, var_08 in param_00)
	{
		...
		{
			var_04[var_06] = param_00[var_0A].bottarget.var_2E6;
		}
		else
		{
			param_00[var_0A].nearest_node = function_00C5(param_00[var_0A].var_2E6);
			if(!isdefined(param_00[var_0A].nearest_node))
			{
				var_09 = getnodesinradiussorted(param_00[var_0A].var_2E6,256,0);
				if(var_09.size > 0)
				{
			...
			if(distance(param_00[var_0A].nearest_node.var_2E6,param_00[var_0A].var_2E6) > 128)
			{
				param_00[var_0A].nearest_node = undefined;
				continue;
			}

			var_04[var_06] = param_00[var_0A].nearest_node.var_2E6;
		}
...
bot_cache_entrances(param_00,param_01,param_02,param_03)
{
	...
	for(var_0B = 0;var_0B < param_00.size;var_0B++)
	{
		...
		for(var_0D = 0;var_0D < var_0A[var_0C].size;var_0D++)
		{
			...
			var_0E.prone_visible_from[var_0C] = maps\mp\bots\_bots_util::entrance_visible_from(var_0E.var_2E6,param_00[var_0B],"prone");
			wait(0.05);
			var_0E.crouch_visible_from[var_0C] = maps\mp\bots\_bots_util::entrance_visible_from(var_0E.var_2E6,param_00[var_0B],"crouch");
			wait(0.05);
		}
	}
...
bot_add_missing_nodes(param_00,param_01)
{
	...
	{
		var_02 = getnodesinradius(param_01.var_2E6,param_01.radius,0,100);
	...
	if(param_01.classname == "trigger_multiple" || param_01.classname == "trigger_use_touch")
	{
		...
		{
			var_08 = distance(var_07,param_01.var_2E6);
			if(var_08 > var_05)
			{
				var_05 = var_08;
			}
		...
		var_02 = getnodesinradius(param_01.var_2E6,var_05,0,100);
		foreach(var_0B in var_02)
		{
			if(!ispointinvolume(var_0B.var_2E6,param_01))
			{
				if(ispointinvolume(var_0B.var_2E6 + (0,0,40),param_01) || ispointinvolume(var_0B.var_2E6 + (0,0,80),param_01) || ispointinvolume(var_0B.var_2E6 + (0,0,120),param_01))
				{
...
bot_gametype_get_num_players_on_team(param_00)
{
	...
	{
		if(maps\mp\_utility::isteamparticipant(var_03) && isdefined(var_03.inliveplayerkillstreak) && var_03.inliveplayerkillstreak == param_00)
		{
			var_01++;
		}
	}
...
bot_gametype_get_allied_attackers_for_team(param_00,param_01,param_02)
{
	...
	{
		if(!isai(var_05) && isdefined(var_05.inliveplayerkillstreak) && var_05.inliveplayerkillstreak == param_00)
		{
			if(distancesquared(param_01,var_05.var_2E6) > squared(param_02))
			{
...
bot_gametype_get_players_by_role(param_00,param_01)
{
	...
	{
		if(isdefined(var_04.inliveplayerkillstreak) && isalive(var_04) && maps\mp\_utility::isteamparticipant(var_04) && var_04.inliveplayerkillstreak == param_01 && isdefined(var_04.role) && var_04.role == param_00)
		{
...
{
	var_00 = [[ level.bot_gametype_allied_attackers_for_team ]](self.inliveplayerkillstreak);
	var_01 = [[ level.bot_gametype_allied_defenders_for_team ]](self.inliveplayerkillstreak);
	var_02 = [[ level.bot_gametype_attacker_limit_for_team ]](self.inliveplayerkillstreak);
	var_03 = [[ level.bot_gametype_defender_limit_for_team ]](self.inliveplayerkillstreak);
