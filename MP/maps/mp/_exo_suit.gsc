 ...
 * Decompiled File: _exo_suit - 42806.gsc
...
monitorgroundslam()
{
	...
	for(;;)
	{
		...
		{
			thread draw_circle_for_time(self.var_2E6,var_0E + var_05,(0,1,0),0,16,var_00);
			var_14 = 100;
			var_15 = var_14 - var_09 * var_0E / var_0A - var_09;
			thread draw_circle_for_time(self.var_2E6,var_15 + var_05,(1,0,0),0,16,var_00);
			foreach(var_12 in level.var_328)
			{
			}
		}
