 ...
 * Decompiled File: _perkfunctions - 42971.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 101
 * Decompile Time: 4279 ms
 * Timestamp: 4/20/2022 8:16:59 PM
*******************************************************************/
...
glowsticksetupandwaitfordeath(param_00)
{
	...
	thread glowstickteamupdater(self.inliveplayerkillstreak,level.spawnglow["enemy"],param_00);
	...
	var_01 thread glowstickteamupdater(self.inliveplayerkillstreak,level.spawnglow["friendly"],param_00);
