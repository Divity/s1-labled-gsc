 ...
 * Decompiled File: _explosive_drone - 42809.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 68
 * Decompile Time: 2699 ms
 * Timestamp: 4/20/2022 8:17:24 PM
*******************************************************************/
...
createexplosivedrone(param_00,param_01,param_02,param_03)
{
	...
	var_0E.stunned = 0;
	var_0E.inactive = 0;
	var_0E thread maps\mp\gametypes\_damage::setentitydamagecallback(var_0E.var_275,undefined,::onexplosivedronedeath,undefined,0);
...
{
	maps\mp\_utility::incrementfauxvehiclecount();
	var_01 = param_00 createexplosivedrone(1,self.var_2E6,self.var_41);
	if(!isdefined(var_01))
	{
		maps\mp\_utility::decrementfauxvehiclecount();
		return 0;
