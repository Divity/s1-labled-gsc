 ...
 * Decompiled File: _utility - 42842.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 392
 * Decompile Time: 14409 ms
 * Timestamp: 4/20/2022 8:18:01 PM
*******************************************************************/
...
getplant()
{
	...
	if(var_04["fraction"] < 1)
	{
		...
		var_05.var_41 = orienttonormal(var_04["normal"]);
		return var_05;
	}
	...
	var_08.var_41 = orienttonormal(var_04["normal"]);
	return var_08;
}
	...
	if(isdefined(param_01))
	{
		if(isdefined(param_02))
		{
			for(var_03 = 0;var_03 < level.var_328.size;var_03++)
			{
				...
				if(isdefined(var_04.connectedpostgame["team"]) && var_04.connectedpostgame["team"] == param_01 && !isexcluded(var_04,param_02))
				{
...
leaderdialog(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(isdefined(param_03))
	{
		for(var_05 = 0;var_05 < level.var_328.size;var_05++)
		{
			...
			if(isdefined(var_06.connectedpostgame["team"]) && var_06.connectedpostgame["team"] == param_01 && !isexcluded(var_06,param_03))
			{
...
leaderdialogbothteams(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	if(level.splitscreen)
	{
		...
		{
			level.var_328[0] leaderdialogonplayer(param_00,param_04,undefined,param_06);
		}
...
updateobjectivetext()
{
	...
	if(getwatcheddvar("scorelimit") > 0 && !isobjectivebased())
	{
		if(level.splitscreen)
		{
			self setclientdvar("cg_objectiveText",getobjectivescoretext(self.connectedpostgame["team"]));
			return;
		}

		self setclientdvar("cg_objectiveText",getobjectivescoretext(self.connectedpostgame["team"]),getwatcheddvar("scorelimit"));
		return;
	}

	self setclientdvar("cg_objectiveText",getobjectivetext(self.connectedpostgame["team"]));
}
...
validateusestreak(param_00,param_01)
{
	...
	if(shouldpreventearlyuse(var_02) && level.var_539F)
	{
		var_04 = 0;
...
isteaminlaststand()
{
	var_00 = getlivingplayers(self.inliveplayerkillstreak);
	foreach(var_02 in var_00)
	{
...
reset_visionset_on_team_change(param_00,param_01,param_02)
{
	...
	{
		if(self.inliveplayerkillstreak != var_04 || !common_scripts\utility::array_contains(param_00 get_players_watching(),self))
		{
...
{
	_playerallow("highjump",param_00,param_01,::method_83B2);
}

//Function Number: 363
playerallowhighjumpdrop(param_00,param_01)
{
	_playerallow("highjumpdrop",param_00,param_01,::method_8486);
}

//Function Number: 364
playerallowboostjump(param_00,param_01)
{
	_playerallow("boostjump",param_00,param_01,::method_849E);
}

//Function Number: 365
playerallowpowerslide(param_00,param_01)
{
	_playerallow("powerslide",param_00,param_01,::method_8485);
}

//Function Number: 366
playerallowdodge(param_00,param_01)
{
	_playerallow("dodge",param_00,param_01,::method_848D);
}
