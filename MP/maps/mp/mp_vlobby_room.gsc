 ...
 * Decompiled File: mp_vlobby_room.gsc
...
fade_from_black()
{
	...
	var_00 method_84D7("mp_no_foley",1);
}
...
vl_ground_setup()
{
	...
	{
		var_04.var_2E6 = var_04.var_2E6 + var_01.var_2E6 - var_00.var_2E6;
	}
...
vl_lighting_setup()
{
	...
	if(level.nextgen)
	{
		var_00 method_84AB(0.613159,89.8318,level.camdirectionforward.dof_time,level.camdirectionforward.dof_time * 2);
		return;
	}

	var_00 method_84AB(4.01284,95.2875,level.camdirectionforward.dof_time,level.camdirectionforward.dof_time * 2);
}

//Function Number: 5
vl_dof_based_on_focus(param_00)
{
	var_01 = level.camdirectionforward.dof_time;
	var_02 = self;
	var_03 = param_00;
	var_02 = self;
	...
	var_02 method_84AB(var_09,var_03,var_01,var_01 * 2);
}
...
vl_handle_mode_change(param_00,param_01,param_02)
{
	...
	if(param_01 == "cao")
	{
		if(level.nextgen)
		{
			var_03 method_84AB(1.223,156.419,level.camdirectionforward.dof_time,level.camdirectionforward.dof_time);
			return;
		}

		var_03 method_84AB(3.223,156.419,level.camdirectionforward.dof_time,level.camdirectionforward.dof_time);
		return;
	}
...
setdefaultdof()
{
	...
	var_00 method_84AB(4.01284,95.2875,level.camdirectionforward.dof_time,level.camdirectionforward.dof_time);
}