 ...
 * Decompiled File: _movers - 42823.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 64
 * Decompile Time: 2432 ms
 * Timestamp: 4/20/2022 8:17:33 PM
*******************************************************************/
...
script_mover_move_to_target(param_00)
{
	...
	while(param_00.goals.size != 0)
	{
		...
		if(anglesclamp180(var_08["angles"]) != anglesclamp180(var_02.var_41))
		{
			if(var_03 <= 0)
			{
				var_02 dontinterpolate();
...
script_mover_init_move_parameters()
{
	...
	self.var_41 = anglesclamp180(self.var_41);
