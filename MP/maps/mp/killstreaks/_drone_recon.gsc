 ...
 * Decompiled File: _drone_recon - 42944.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 28
 * Decompile Time: 1351 ms
 * Timestamp: 4/20/2022 8:16:05 PM
*******************************************************************/
...
tryuserecondrone(param_00,param_01)
{
	...
	var_04 = createreconuav(param_00,param_01,var_02.var_2E6,var_02.var_41);
	common_scripts\utility::_enableweaponswitch();
...
createreconuav(param_00,param_01,param_02,param_03)
{
	...
	var_06 thread maps\mp\gametypes\_damage::setentitydamagecallback(var_06.var_275,undefined,::onrecondronedeath,::maps\mp\killstreaks\_aerial_utility::heli_modifydamage,1);
	if(var_06.hascloak)
	{
