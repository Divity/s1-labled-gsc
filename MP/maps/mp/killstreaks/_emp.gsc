 ...
 * Decompiled File: _emp - 42945.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 32
 * Decompile Time: 1499 ms
 * Timestamp: 4/20/2022 8:16:07 PM
*******************************************************************/
...
onplayerspawned()
{
	...
	for(;;)
	{
		...
		self waittill("death");
		if(self.inliveplayerkillstreak == "spectator" || issystemhacked())
		{
			removeemp();
		}
	}
...
destroyactiverockets(param_00,param_01,param_02,param_03)
{
	...
	{
		if(isdefined(var_08.fx_origin) && skiprocketemp(var_08.fx_origin))
		{
			continue;
		}
