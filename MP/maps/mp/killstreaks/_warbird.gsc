 ...
 * Decompiled File: _warbird - 42961.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 93
 * Decompile Time: 4671 ms
 * Timestamp: 4/20/2022 8:16:49 PM
*******************************************************************/
...
setupwarbirdkillstreak(param_00,param_01)
{
	...
	var_04 thread maps\mp\gametypes\_damage::setentitydamagecallback(var_04.var_275,undefined,::warbirdondeath,::maps\mp\killstreaks\_aerial_utility::heli_modifydamage,1);
...
warbirdmovetoattackpoint(param_00)
{
	...
	if(!isdefined(var_02))
	{
		var_03 = common_scripts\utility::get_array_of_closest(param_00.var_2E6,buildvalidflightpaths());
...
playwarbirdenginefx()
{
	...
	{
		self.var_31D pausewarbirdenginefxforplayer(self);
	}
