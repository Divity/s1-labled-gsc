 ...
 * Decompiled File: _drone_assault - 42941.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 39
 * Decompile Time: 1943 ms
 * Timestamp: 4/20/2022 8:16:02 PM
*******************************************************************/
...
tryuseassaultdrone(param_00,param_01)
{
	...
	var_06 = createassaultuav(param_00,param_01,var_03.var_2E6,var_03.var_41);
	if(!var_04)
	{
		common_scripts\utility::_enableweaponswitch();
...
setupcommonassaultdroneproperties(param_00,param_01,param_02,param_03)
{
	...
	param_00 thread maps\mp\gametypes\_damage::setentitydamagecallback(param_00.var_275,undefined,::onassaultdronedeath,::maps\mp\killstreaks\_aerial_utility::heli_modifydamage,1);
...
waitforc4detonation(param_00)
{
	...
	param_00 entityradiusdamage(param_00.var_2E6 + (0,0,50),getassaultvehiclec4radius(),200,200,self,"MOD_EXPLOSIVE","AssaultDrone_C4_mp");
