 ...
 * Decompiled File: _airdrop - 42935.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 64
 * Decompile Time: 3311 ms
 * Timestamp: 4/20/2022 8:15:50 PM
*******************************************************************/
...
createairdropcrate(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	if(var_07.inliveplayerkillstreak == "any")
	{
		...
		var_07.var_3AB6 thread deleteonownerdeath(var_07);
	}
	...
	else
	{
		...
		if(level.teambased)
		{
			var_07.var_3AB6 thread cratemodelteamupdater(var_07.inliveplayerkillstreak,1);
		}
		else
		{
			var_07.var_3AB6 thread cratemodelplayerupdater(param_00,1);
		}

		var_07.enemymodel thread deleteonownerdeath(var_07);
		if(level.teambased)
		{
			var_07.enemymodel thread cratemodelteamupdater(level.matchbonus[var_07.inliveplayerkillstreak],0);
		}
		else
		{
...
cratesetupforuse(param_00,param_01)
{
	...
	{
		thread crateuseteamupdater(maps\mp\_utility::getotherteam(self.inliveplayerkillstreak));
	}
	else
	{
		...
		if(level.teambased)
		{
			if(isdefined(param_01) && isarray(param_01))
			{
				setheadicon_multiple(self.inliveplayerkillstreak,param_01);
			}
			else
			{
...
physicswaiter(param_00,param_01)
{
	...
	var_06.var_9403 = ::movingplatformtouchvalid;
...
killstreakcratethink(param_00)
{
	...
	for(;;)
	{
		...
		if(var_09 || var_0B)
		{
			var_0C = var_06 createairdropcrate(var_06,"booby_trap","booby_trap",self.var_2E6,self.var_41);
