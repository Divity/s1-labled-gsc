 ...
 * Decompiled File: _remoteturret - 42957.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 95
 * Decompile Time: 4593 ms
 * Timestamp: 4/20/2022 8:16:41 PM
*******************************************************************/
...
updateturretplacement(param_00)
{
	...
	for(;;)
	{
		...
		param_00.canbeplaced = self isonground() && var_02["result"] && abs(param_00.var_2E6[2] - self.var_2E6[2]) < 10 && !param_00 istouchingwater();
...
turret_setactive()
{
	...
	thread maps\mp\gametypes\_damage::setentitydamagecallback(self.var_275,undefined,::onturretdeath,::turret_modifydamage,1);
...
startusingremoteturret(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(!param_04)
	{
		...
		var_05 method_84BF();
		var_05 playerwaittillweaponswitchover(level.var_99B4[self.turrettype].laptopinfo);
