 ...
 * Decompiled File: _aerial_utility - 42933.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 77
 * Decompile Time: 3776 ms
 * Timestamp: 4/20/2022 8:15:45 PM
*******************************************************************/
...
heli_leave(param_00)
{
	...
	if(isdefined(var_01))
	{
		...
		{
			_setvehgoalpos(var_01.var_2E6,0);
...
handleincomingstinger(param_00)
{
	...
	for(;;)
	{
		...
		level thread watchmissileproximity(var_02,var_01,var_01.inliveplayerkillstreak);
	}
}
...
missilewatchproximity(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		{
			param_02.var_31D thread doproximityalarm(self,param_02);
		}
...
detectiongrenadethink(param_00,param_01,param_02,param_03)
{
	...
	var_07 = getplayersonteam(param_01.inliveplayerkillstreak);
...
heli_crash()
{
	...
	{
		_setvehgoalpos(var_00.var_2E6,0);
		self waittillmatch("goal");
	}
...
heli_fly_simple_path(param_00)
{
	...
	for(var_01 = param_00;isdefined(var_01.target);var_01 = var_02)
	{
		...
		{
			_setvehgoalpos(var_02.var_2E6 + self.zoffset,0);
