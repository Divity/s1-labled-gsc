 ...
 * Decompiled File: _orbitalsupport - 42955.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 77
 * Decompile Time: 3949 ms
 * Timestamp: 4/20/2022 8:16:35 PM
*******************************************************************/
...
setorbitalsupportplayer(param_00,param_01)
{
	...
	param_00 playerswitchtoturret(level.var_6563);
...
orbitalsupport_spawn()
{
	...
	level.var_6563 = spawnorbitalsupportturret("orbitalsupport_big_turret_mp","orbitalsupport_big_turret","tag_orbitalsupport_biggun",0);
