 ...
 * Decompiled File: _placeable - 42956.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 30
 * Decompile Time: 1404 ms
 * Timestamp: 4/20/2022 8:16:36 PM
*******************************************************************/
...
handledamage(param_00)
{
	self endon("carried");
	var_01 = level.placeableconfigs[param_00];
	maps\mp\gametypes\_damage::setentitydamagecallback(var_01.var_275,var_01.damagefeedback,::handledeathdamage,::modifydamage,1);
}
