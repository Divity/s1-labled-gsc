 ...
 * Decompiled File: _killstreaks - 42947.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 79
 * Decompile Time: 3879 ms
 * Timestamp: 4/20/2022 8:16:18 PM
*******************************************************************/
...
updatestreakcount()
{
	...
	for(var_00 = level.killstreak_slot_1;var_00 < level.killstreak_stacking_start_slot;var_00++)
	{
		...
		var_04 = getstreakcost(self.connectedpostgame["killstreaks"][var_00].streakname);
...
givehordekillstreak(param_00,param_01,param_02,param_03,param_04)
{
	...
	{
		var_0A.var_5D57 = getkillstreakmodules(self,param_00);
	}
...
givekillstreak(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	{
		var_0E.var_5D57 = getkillstreakmodules(self,param_00);
	}
