 ...
 * Decompiled File: _orbital_util - 42954.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 37
 * Decompile Time: 1794 ms
 * Timestamp: 4/20/2022 8:16:31 PM
*******************************************************************/
...
{
	return (nodeispathnode(param_00) && function_02C8(param_00) && function_02C9(param_00) == "up") || isdefined(param_00.bestmissilespawnabove);
}

//Function Number: 14
nodehasremotemissiledataset(param_00)
{
	return (nodeispathnode(param_00) && function_02C8(param_00)) || isdefined(param_00.bestmissilespawnabove) || isdefined(param_00.bestmissilespawn);
}
...
nodetestfirefromabove(param_00,param_01)
{
	...
	var_03 = remotemissileenttracetooriginpassedwrapper(var_02,param_00.var_2E6,param_01);
	if(var_03)
	{
...
{
	var_02 = undefined;
	if(nodeispathnode(param_00) && function_02C8(param_00))
	{
...
nodefindremotemissleent(param_00,param_01,param_02)
{
	...
	{
		var_05 = remotemissileenttracetooriginpassedwrapper(var_04.var_2E6,param_00.var_2E6,param_02);
		if(var_05)
		{
...
nodecanhitground(param_00,param_01)
{
	...
	{
		if(goliathbadlandingcheck(param_00.var_2E6))
		{
			return 0;
		}
	}
...
playergetnearestnode(param_00,param_01)
{
	...
	if(var_08)
	{
		var_08 = nodecanhitground(var_07,param_01) && carepackagetrace(var_07.var_2E6,self,param_01);
	}
	...
	if(!isdefined(var_07))
	{
		var_07 = playergetclosestnode(500,100,self.var_2E6,0,1,param_01);
		if(!isdefined(var_07))
		{
			var_07 = playergetclosestnode(500,0,self.var_2E6,0,0,param_01);
		}
...
playerfindnodeinfrontinternal(param_00,param_01,param_02,param_03,param_04)
{
	while(param_01 < param_02 && param_04.maxnodes > 0)
	{
		...
		if(isdefined(var_05))
		{
			...
			var_09 = var_08["fraction"] == 1 && carepackagetrace(var_05.var_2E6,self,param_03);
			if(var_09)
			{
				return var_05;
			}
...
playerfindaltnode(param_00,param_01)
{
	...
	if(isdefined(var_02))
	{
		...
		if(param_01 == "goliath")
		{
			if(goliathbadlandingcheck(var_02.var_2E6))
			{
				return undefined;
			}
		}
...
checknodestart(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		{
			var_06++;
			if(!carepackagetrace(var_07.var_2E6,param_01,param_02))
			{
...
playergetclosestnodeinternal(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	for(var_08 = 0;var_08 < var_07.size;var_08++)
	{
		...
		if(param_04)
		{
			var_06 = var_06 & playerwithinfov2d(var_07[var_08].var_2E6);
		}
