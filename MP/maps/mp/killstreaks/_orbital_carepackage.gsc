 ...
 * Decompiled File: _orbital_carepackage - 42952.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 38
 * Decompile Time: 1928 ms
 * Timestamp: 4/20/2022 8:16:25 PM
*******************************************************************/
...
trajectory_kill(param_00)
{
	...
	while(isdefined(self))
	{
		if(!level.teambased)
		{
			capsule_damage(10000,self.var_2E6,var_01,30,undefined,param_00);
		}
		else
		{
			capsule_damage(10000,self.var_2E6,var_01,30,level.matchbonus[param_00.inliveplayerkillstreak],param_00);
		}
...
monitordropinternal(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	var_09 thread carepackagesetupminimap(param_02.var_5D57,param_00);
	...
	if(isdefined(param_01) && !var_08 && param_01.var_2E6[2] > param_02.var_2F8D[2] && distancesquared(param_01.var_2E6,param_02.var_2F8D) > 22500)
	{
		if(param_02.givebackcarepackage)
		{
			if(isdefined(level.var_511A) && level.var_511A)
			{
				...
				firepod(level.ocp_weap_name,self,var_0D,"horde_support_drop",param_02.var_5D57,0,undefined,undefined,1);
			}
	...
	if(var_08 && allowdronedelivery(param_00) && isdefined(param_02.var_2E19))
	{
...
orbitalphysicswaiter(param_00,param_01,param_02)
{
	...
	{
		self.var_3AB6 thread orbitalanimate();
		self.var_3AB6 solid();
	}
...
setupdamagecallback(param_00)
{
	...
	setupdamagecallbackinternal(param_00.var_3AB6);
...
{
	disabledamagecallbackinternal(param_00.var_3AB6);
