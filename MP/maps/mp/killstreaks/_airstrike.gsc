 ...
 * Decompiled File: _airstrike - 42936.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 63
 * Decompile Time: 3056 ms
 * Timestamp: 4/20/2022 8:15:53 PM
*******************************************************************/
...
{
	var_03 = dropsitetrace(param_00.var_2E6,param_00);
...
bomberdropbombs(param_00,param_01)
{
	...
	while(var_04 < 5000)
	{
		...
		if(var_04 < 4500)
		{
			param_00 thread callstrike_bomb(param_00.var_2E6,param_01,(0,0,0),var_02);
		}
...
callstrike_bomb(param_00,param_01,param_02,param_03)
{
	...
	radiusartilleryshellshock(var_06,512,8,4,param_01.inliveplayerkillstreak);
...
finishairstrikeusage(param_00,param_01,param_02,param_03,param_04)
{
	...
	for(var_05 = 0;var_05 < param_01.size;var_05++)
	{
		...
		thread doairstrike(param_00,var_06,var_07,self,self.connectedpostgame["team"],param_03,param_04);
	}
}
