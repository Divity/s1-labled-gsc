 ...
 * Decompiled File: _grappling_hook.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 12
 * Decompile Time: 503 ms
 * Timestamp: 4/20/2022 8:17:27 PM
*******************************************************************/
...
give_grappling_hook()
{
	...
	var_01 method_8383(self);
	self method_8550(var_01);
	thread common_scripts\utility::delete_on_death(var_01);
	thread delete_on_reset(var_01);
	var_02 = self method_84A5(level.grapplinghookweapon);
	self setclientomnvar("ui_exo_battery_level0",var_02);
	self setclientomnvar("exo_ability_nrg_req0",function_0298(level.grapplinghookweapon));
...
wait_for_full_battery()
{
	...
	self endon("grappling_hook_reset");
	self endon("grappling_hook_battery_hud_reset");
	var_00 = self method_84A5(level.grapplinghookweapon);
	for(;;)
	{
		var_01 = self method_84A2(level.grapplinghookweapon);
		if(var_01 >= var_00)
		{
			maps\mp\_exo_battery::set_exo_ability_hud_omnvar(level.grapplinghookweapon,"ui_exo_battery_toggle",0);
			return;
