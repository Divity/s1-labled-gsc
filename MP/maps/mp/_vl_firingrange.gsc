 ...
 * Decompiled File: _vl_firingrange - 42845.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 82
 * Decompile Time: 3201 ms
...
init_firingrange()
{
	...
	var_00.var_AB8 = firing_range_setup_min_range();
...
firing_range_setup_floor_panels()
{
	...
	{
		var_02.og_position = var_02.var_2E6;
		var_02.up_position = var_02.var_2E6 + (0,0,4);
	}
...
snd_play_linked_firingrange(param_00,param_01,param_02,param_03)
{
	...
	var_04 method_8446(param_01);
	var_04 thread maps\mp\_audio::sndx_play_linked_internal(param_00,param_01,param_02,param_03);
	if(!isdefined(level.firingrange.var_88A5))
	{
		level.firingrange.var_88A5 = [];
	}
	else
	{
		level.firingrange.var_88A5 = common_scripts\utility::add_to_array(level.firingrange.var_88A5,var_04);
	}
...
targetspreadshooting(param_00)
{
	...
	var_02.alive = 1;
	thread maps\mp\_audio::snd_play_in_space("mp_shooting_range_panels_bell",level.firingrange.audio_buzzer_struct.var_2E6);
	var_02 spawntarget();
	var_02 show();
	var_02 solid();
	var_02 setcandamage(1);
	var_02 method_8495(1);
	var_02.damagecallback = ::monitordamagecallback;
	var_02.health = 9999;
	var_02.var_275 = 9999;
	var_02 method_8029();
	foreach(var_04 in level.firingrange.var_AB8)
	{
	...
	level.firingrange.minpointmodpos = level.firingrange.minpoint.var_2E6 + anglestoforward(level.firingrange.minpoint.var_41) * -64;
...
monitordistance(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		{
			var_04 = distance2d(param_01.var_2E6,param_02.var_2E6);
...
monitoruppressed(param_00)
{
	...
	for(;;)
	{
		...
		if(level.firingrange.pressedup == 0)
		{
			...
			thread movelogic(level.firingrange.maxpoint.var_2E6,param_00,self);
		}
	}
}
...
monitorupreleased(param_00)
{
	...
	for(;;)
	{
		...
		var_01 = distance2d(level.firingrange.maxpoint.var_2E6,param_00.var_2E6);
		if(var_01 <= 1)
		{
			param_00 moveto(param_00.var_2E6,0.05);
		}
		else
		{
			var_02 = param_00.var_2E6 + anglestoforward(level.firingrange.alltargetmax[0].var_41) * level.firingrange.gracedisance * -1;
			var_01 = distance2d(var_02,param_00.var_2E6);
...
monitordownreleased(param_00)
{
	...
	for(;;)
	{
		...
		var_01 = distance2d(level.firingrange.minpointmodpos,param_00.var_2E6);
		if(var_01 <= 1)
		{
			param_00 moveto(param_00.var_2E6,0.05);
		}
		...
		{
			var_02 = param_00.var_2E6 + anglestoforward(level.firingrange.alltargetmax[0].var_41) * level.firingrange.gracedisance;
			var_01 = distance2d(var_02,param_00.var_2E6);
			var_03 = var_01 / level.firingrange.target_units_per_second;
			if(var_03 < 0.05)
			{
...
{
	var_03 = distance2d(param_00,param_01.var_2E6);
	if(var_03 <= 1)
	{
...
getmodifier(param_00,param_01,param_02)
{
	...
	if(param_00 != "specialty_null" && param_00 != "none" && param_00 != "iw5_combatknife_mp")
	{
		if(maps\mp\gametypes\_class::isvalidprimary(var_06) || maps\mp\gametypes\_class::isvalidsecondary(var_06,0))
		{
			...
			var_04 = param_02 method_850A(var_06 + "_mp",var_03);
			return var_04;
		}
...
monitorshotsfired(param_00)
{
	...
	for(;;)
	{
		...
		if(isdefined(var_01))
		{
			var_02 = level.firingrange.var_8445 + var_01;
			if(var_02 > 9999)
			{
				level.firingrange.var_8445 = 0;
				level.firingrange.shotshit = 0;
				level.firingrange.var_67C2 = 0;
				param_00 setclientomnvar("ui_vlobby_round_hits",level.firingrange.shotshit);
				param_00 setclientomnvar("ui_vlobby_round_fired",level.firingrange.var_8445);
				param_00 setclientomnvar("ui_vlobby_round_accuracy",level.firingrange.var_67C2);
			}
			else if(var_02 < 0)
			{
				level.firingrange.var_8445 = 0;
			...
			{
				level.firingrange.shouldupdateluadisplay = 1;
				level.firingrange.var_8445 = var_02;
			}
...
monitorgrenades(param_00)
{
	...
	for(;;)
	{
		...
		if(isdefined(var_01))
		{
			...
			var_02 = level.firingrange.var_8445 + 1;
			if(var_02 > 9999)
			{
				level.firingrange.var_8445 = 0;
				level.firingrange.shotshit = 0;
...
monitorhitpercent(param_00)
{
	...
	for(;;)
	{
		if(level.firingrange.var_8445 > 0)
		{
			var_01 = level.firingrange.shotshit / level.firingrange.var_8445 * 100;
			var_01 = maps\mp\_utility::rounddecimalplaces(var_01,0);
			if(var_01 != level.firingrange.var_67C2)
			{
				if(var_01 > 999)
				{
					var_01 = 999;
				...
				level.firingrange.var_67C2 = int(var_01);
				level.firingrange.shouldupdateluadisplay = 1;
			}
		}
...
startround(param_00)
{
	...
	self setclientomnvar("ui_vlobby_round_fired",level.firingrange.var_8445);
	self setclientomnvar("ui_vlobby_round_accuracy",level.firingrange.var_67C2);
	foreach(var_02 in level.firingrange.alltargetsarray[param_00])
	{
		foreach(var_04 in var_02)
		{
			var_04.var_2E6 = var_04.original_position;
			var_04.var_41 = var_04.original_orientation;
		}
	}
	...
	foreach(var_0C in level.firingrange.allvfx_struct[param_00])
	{
		if(level.nextgen)
		{
			thread particlespawn(level.firingrange.vfxholoedge,var_0C.var_2E6,var_0C.var_41,undefined,1);
		}
		else if(var_0A % 2 == 0)
		{
			thread particlespawn(level.firingrange.vfxholoedge,var_0C.var_2E6,var_0C.var_41,undefined,1);
...
showtransitionrev(param_00)
{
	...
	{
		if(isdefined(var_02) && !function_0294(var_02) && isdefined(var_02.classname) && var_02.classname == "script_model")
		{
			if(isdefined(var_02.model) && issubstr(var_02.model,"_trans"))
			{
				var_03 = var_02.model + "_rev";
				var_04 = spawn("script_model",var_02.var_2E6);
				level.firingrange.transitionmeshesrev[level.firingrange.transitionmeshesrev.size] = var_04;
				if(isdefined(var_02.var_41))
				{
					var_04.var_41 = var_02.var_41;
				}
				else
				{
					var_04.var_41 = (0,0,0);
...
hidetransitionmeshes()
{
	if(isarray(level.firingrange.transitionmeshes))
	{
		...
		{
			if(isdefined(var_01) && !function_0294(var_01))
			{
				var_01 hide();
				var_01 notsolid();
			}
...
shutdownround(param_00,param_01)
{
	...
	foreach(var_09 in level.firingrange.alltargetsarray[param_00])
	{
		foreach(var_0B in var_09)
		{
			...
			var_0B.var_2E6 = var_0B.original_position;
			var_0B.var_41 = var_0B.original_orientation;
	...
	param_01 setclientomnvar("ui_vlobby_round_fired",level.firingrange.var_8445);
	param_01 setclientomnvar("ui_vlobby_round_accuracy",level.firingrange.var_67C2);
...
scalesoundsonexit()
{
	...
	if(isdefined(level.in_firingrange))
	{
		for(;;)
		{
			...
			{
				level.firingrange.var_88A5 = common_scripts\utility::array_remove_duplicates(level.firingrange.var_88A5);
				foreach(var_01 in level.firingrange.var_88A5)
				{
...
wait_start_firingrange(param_00,param_01)
{
	...
	var_02 = getgroundposition(level.firingrange.fr_start.var_2E6,20,512,120);
	param_01 dontinterpolate();
	param_01 setorigin(var_02);
	param_01 setplayerangles(level.firingrange.fr_start.var_41);
	...
	param_01 method_847A("mp_virtual_lobby_fr",0);
	param_01 method_83C0("mp_vl_firingrange");
	...
	if(param_01.alias != "specialty_null" && param_01.alias != "none" && param_01.alias != "iw5_combatknife_mp" && !issubstr(param_01.alias,"em1") && !issubstr(param_01.alias,"epm3") && !issubstr(param_01.alias,"dlcgun1_mp") && !issubstr(param_01.alias,"dlcgun1loot") && !issubstr(param_01.alias,"dlcgun9loot6") && !issubstr(param_01.alias,"dlcgun10loot4") && !issubstr(param_01.alias,"dlcgun10loot6"))
	{
		param_01 thread monitor_weapon_ammo_count(param_01.alias);
		if(issubstr(param_01.alias,"_gl"))
		{
			param_01 thread monitor_weapon_ammo_count("alt_" + param_01.alias);
		}
	}

	if(param_01.secondaryweapon != "specialty_null" && param_01.secondaryweapon != "none" && param_01.secondaryweapon != "iw5_combatknife_mp" && !issubstr(param_01.secondaryweapon,"em1") && !issubstr(param_01.secondaryweapon,"epm3") && !issubstr(param_01.alias,"dlcgun1_mp") && !issubstr(param_01.alias,"dlcgun1loot") && !issubstr(param_01.alias,"dlcgun9loot6") && !issubstr(param_01.alias,"dlcgun10loot4") && !issubstr(param_01.alias,"dlcgun10loot6"))
	{
...
chargebattery(param_00)
{
	...
	{
		self method_84A4(var_01);
		self method_84A6(var_01,1);
	}
}
...
{
	level endon("shutdown_hologram");
	self.original_position = self.var_2E6;
	self.original_orientation = self.var_41;
	self.alive = 1;
	spawntarget();
...
particlespawn(param_00,param_01,param_02,param_03,param_04)
{
	...
	{
		wait(param_03);
		if(isdefined(var_05) && !function_0294(var_05))
		{
			var_05 delete();
			return;
		}
...
movetargettodest()
{
	...
	var_01 = common_scripts\utility::getclosest(self.var_2E6,level.firingrange.alltargetlogicarray[var_00]);
	...
	for(;;)
	{
		if(isdefined(self))
		{
			var_02 = distance(self.current_ent.var_2E6,self.var_2E6);
			var_03 = var_02 / level.firingrange.round_target_unit_per_second;
			if(isdefined(self.current_ent.var_39B) && self.current_ent.var_39B == "jump")
			{
				self moveto(self.current_ent.var_2E6,var_03 * 0.5,0,0.1);
			}
			else if(isdefined(self.last_ent.var_39B) && self.last_ent.var_39B == "jump")
			{
				self moveto(self.current_ent.var_2E6,var_03 * 0.5,0.1,0);
			}
			else
			{
				self moveto(self.current_ent.var_2E6,var_03);
			}
...
popinpopout()
{
	...
	var_00 = 4;
	var_01 = 1;
	var_02 = self.current_ent.var_2E6;
	var_03 = self.last_ent.var_2E6;
...
movebackforth()
{
	...
	var_00 = undefined;
	var_01 = undefined;
	if(isdefined(self.last_ent.var_39B) && self.last_ent.var_39B == "jump")
	{
...
target_handler(param_00)
{
	...
	self.aimassist_target.var_275 = 9999;
	self.var_275 = 9999;
	self.health = self.var_275;
	self.fakehealth = 100;
	self setcandamage(1);
...
firing_range_setup_targets()
{
	...
	{
		var_03.alive = 0;
		var_03.connectedpostgame["team"] = "axis";
		var_03.inliveplayerkillstreak = "axis";
		var_03.origin_ent = getent(var_03.target,"targetname");
		var_03.aimassist_target = getent(var_03.origin_ent.target,"targetname");
		var_03.aimassist_target method_8446(var_03);
		var_03.aimassist_target.connectedpostgame["team"] = "axis";
		var_03.aimassist_target.inliveplayerkillstreak = "axis";
		var_03.original_position = var_03.var_2E6;
		var_03.original_orientation = var_03.var_41;
...
grenadecleanup(param_00)
{
	if(isdefined(level.grenades) && isarray(level.grenades))
	{
		foreach(var_02 in level.grenades)
		{
			if(isdefined(var_02) && !function_0294(var_02))
			{
				if(!isdefined(self) || !isdefined(var_02.owner) || function_0294(var_02.owner))
				{
					if(!isdefined(var_02.fx_origin))
					{
						continue;
					}
					else if(maps\mp\_utility::strip_suffix(var_02.fx_origin,"_lefthand") == "explosive_drone_mp")
					{
				...
				if(var_02.owner == self)
				{
					...
					{
						if(maps\mp\_utility::strip_suffix(var_02.fx_origin,"_lefthand") == "explosive_drone_mp")
						{
							var_02 thread maps\mp\_explosive_drone::explosivegrenadedeath();
							continue;
						}

						if(maps\mp\_utility::strip_suffix(var_02.fx_origin,"_lefthand") == "exoknife_mp")
						{
...
dronecleanup()
{
	if(isdefined(level.trackingdrones) && isarray(level.trackingdrones))
	{
		foreach(var_01 in level.trackingdrones)
		{
			if(isdefined(var_01) && !function_0294(var_01))
			{
				if(!isdefined(self) || !isdefined(var_01.owner) || function_0294(var_01.owner))
				{
	...
	for(;;)
	{
		...
		if(var_02 == "explosive_drone_mp")
		{
			if(isdefined(level.grenades) && isarray(level.grenades))
			{
				...
				{
					if(isdefined(var_00) && !function_0294(var_00) && isdefined(self) && isdefined(var_00.owner) && isdefined(var_00.fx_origin))
					{
						if(maps\mp\_utility::strip_suffix(var_00.fx_origin,"_lefthand") == "explosive_drone_mp" && var_00.owner == self)
						{
