 ...
 * Decompiled File: _threatdetection - 42838.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 38
 * Decompile Time: 1374 ms
 * Timestamp: 4/20/2022 8:17:43 PM
*******************************************************************/
	...
	for(;;)
	{
		...
		foreach(var_05 in self._threatdetection.showlist)
		{
			if(var_05.endtime >= var_02)
			{
				...
				var_05.los = 0;
				var_06 = getnormaldirectionvec(anglestoforward(var_05.var_31D.var_41));
				var_07 = getnormaldirectionvec(self.var_2E6 - var_05.var_31D.var_2E6);
		...
		foreach(var_10 in self._threatdetection.showlist)
		{
			if(var_10.los)
			{
				showthreat(var_10.var_31D,::getfriendlylosmarker,::gethostilelosmarker,::visitorupdatelosmarker);
				prepare_show_threat(var_01,var_0A,var_10.var_31D);
				var_01 = 0;
				continue;
			}
			...
			{
				showthreat(var_10.var_31D,::getfriendlymarker,::gethostilemarker,::visitorshowtoplayer);
				prepare_show_threat(var_01,var_0A,var_10.var_31D);
				var_01 = 0;
			}
		}
