 ...
 * Decompiled File: _tracking_drone - 42839.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 48
 * Decompile Time: 1830 ms
 * Timestamp: 4/20/2022 8:17:45 PM
*******************************************************************/
...
{
	maps\mp\_utility::incrementfauxvehiclecount();
	var_01 = param_00 createtrackingdrone(self.fx_origin,1,self.var_2E6,self.var_41);
	if(!isdefined(var_01))
	{
		maps\mp\_utility::decrementfauxvehiclecount();
		return 0;
