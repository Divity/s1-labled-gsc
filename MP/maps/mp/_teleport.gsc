 ...
 * Decompiled File: _teleport - 42837.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 59
 * Decompile Time: 2174 ms
 * Timestamp: 4/20/2022 8:17:42 PM
*******************************************************************/
...
teleport_init()
{
	...
	{
		var_02 = teleport_closest_zone(var_06.var_2E6);
...
teleport_pre_onstartgamesd_and_sr()
{
	...
	{
		var_06 = teleport_closest_zone(var_05.var_2E6);
		if(isdefined(var_06))
		{
	...
	{
		var_06 = teleport_closest_zone(var_0A.var_2E6);
		if(isdefined(var_06))
		{
	...
	{
		var_06 = teleport_closest_zone(var_0E.var_2E6);
		if(isdefined(var_06))
		{
...
teleport_onstartgamedom()
{
	...
	{
		var_05 = teleport_closest_zone(var_04.var_2E6);
		if(isdefined(var_05))
		{
...
bot_setup_ball_jump_nodes()
{
	...
	foreach(var_04 in level.ball_goals)
	{
		...
		foreach(var_07 in var_05)
		{
			...
			var_01++;
			if(bot_ball_origin_can_see_goal(var_07.var_2E6,var_04,1))
			{
...
{
	var_03 = bot_ball_trace_to_origin(param_00,param_01.var_2E6);
...
teleport_validate_success(param_00)
{
	...
	if(isdefined(param_00))
	{
		var_01 = teleport_closest_zone(param_00.var_2E6);
		if(var_01.name != level.teleport_zone_current)
		{
