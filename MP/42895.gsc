...
lib_A78F::init()
{
	...
	level thread lib_A78F::onplayerconnect();
}

//Function Number: 2
lib_A78F::onplayerconnect()
{
	for(;;)
	{
		level waittill("connected",var_00);
		var_00 thread lib_A78F::onplayerspawned();
	}
}

//Function Number: 3
lib_A78F::onplayerspawned()
{
	self endon("disconnect");
	for(;;)
	{
		self waittill("spawned_player");
		thread lib_A78F::playerhealthregen();
	}
}

//Function Number: 4
lib_A78F::playerhealthregen()
{
	self endon("death");
	self endon("disconnect");
	...
	var_00 = 0;
	var_01 = 0;
	thread lib_A78F::playerpainbreathingsound();
	...
	for(;;)
	{
		...
		thread lib_A78F::healthregeneration(var_01,var_07);
		thread lib_A78F::breathingmanager(var_01,var_07,var_02,var_06);
	}
}

//Function Number: 5
lib_A78F::breathingmanager(param_00,param_01,param_02,param_03)
{
	...
	{
		lib_A78F::playdamagesound(param_00);
	}
...
//Function Number: 7
lib_A78F::healthregeneration(param_00,param_01)
{
...
//Function Number: 8
lib_A78F::wait_for_not_using_remote()
{
...
//Function Number: 9
lib_A78F::playerpainbreathingsound()
{
	level endon("game_ended");
	self endon("death");
	self endon("disconnect");
