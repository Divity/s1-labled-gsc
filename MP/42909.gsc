...
lib_A79D::setparent(param_00)
{
	...
	{
		self.parent lib_A79D::removechild(self);
	}

	self.parent = param_00;
	self.parent lib_A79D::addchild(self);
	if(isdefined(self.point))
	{
		lib_A79D::setpoint(self.point,self.relativepoint,self.xoffset,self.yoffset);
		return;
	}

	lib_A79D::setpoint("TOPLEFT");
}
...
//Function Number: 5
lib_A79D::setpoint(param_00,param_01,param_02,param_03,param_04)
{
...
//Function Number: 6
lib_A79D::setpointbar(param_00,param_01,param_02,param_03)
{
	...
	lib_A79D::updatebar(self.bar.frac);
}

//Function Number: 7
lib_A79D::updatebar(param_00,param_01)
{
	if(self.elemtype == "bar")
	{
		lib_A79D::updatebarscale(param_00,param_01);
	}
}
...
lib_A79D::updatebarscale(param_00,param_01)
{
	...
	self.bar.var_5606 = gettime();
}

//Function Number: 9
lib_A79D::createfontstring(param_00,param_01)
{
	...
	var_02.yoffset = 0;
	var_02.children = [];
	var_02 lib_A79D::setparent(level.uiparent);
	var_02.hidden = 0;
	return var_02;
}

//Function Number: 10
lib_A79D::createserverfontstring(param_00,param_01,param_02)
{
	if(isdefined(param_02))
	{
	...
	var_03.yoffset = 0;
	var_03.children = [];
	var_03 lib_A79D::setparent(level.uiparent);
	var_03.hidden = 0;
	return var_03;
}

//Function Number: 11
lib_A79D::createservertimer(param_00,param_01,param_02)
{
	if(isdefined(param_02))
	{
		var_03 = newteamhudelem(param_02);
...
//Function Number: 12
lib_A79D::createtimer(param_00,param_01)
{
	var_02 = newclienthudelem(self);
...
//Function Number: 13
lib_A79D::createicon(param_00,param_01,param_02)
{
...
//Function Number: 14
lib_A79D::createservericon(param_00,param_01,param_02,param_03)
{
	if(isdefined(param_03))
	{
	...
	var_04.yoffset = 0;
	var_04.children = [];
	var_04 lib_A79D::setparent(level.uiparent);
	var_04.hidden = 0;
	if(isdefined(param_00))
	{
...
//Function Number: 15
lib_A79D::createserverbar(param_00,param_01,param_02,param_03,param_04,param_05)
{
	if(isdefined(param_04))
	{
	...
	var_07.color = (0,0,0);
	var_07.alpha = 0.5;
	var_07 lib_A79D::setparent(level.uiparent);
...
//Function Number: 16
lib_A79D::createbar(param_00,param_01,param_02,param_03)
{
	...
	var_05.color = (0,0,0);
	var_05.alpha = 0.5;
	var_05 lib_A79D::setparent(level.uiparent);
...
//Function Number: 17
lib_A79D::getcurrentfraction()
{
	var_00 = self.bar.frac;
	if(isdefined(self.bar.rateofchange))
	{
		var_00 = var_00 + gettime() - self.bar.var_5606 * self.bar.rateofchange / 1000;
		if(var_00 > 1)
		{
			var_00 = 1;
		}
...
//Function Number: 18
lib_A79D::createprimaryprogressbar(param_00,param_01)
{
	if(!isdefined(param_00))
	{
		param_00 = 0;
	...
	var_02 = lib_A79D::createbar((1,1,1),level.primaryprogressbarwidth,level.primaryprogressbarheight);
	var_02 lib_A79D::setpoint("CENTER",undefined,level.primaryprogressbarx + param_00,level.primaryprogressbary + param_01);
	return var_02;
}

//Function Number: 19
lib_A79D::createprimaryprogressbartext(param_00,param_01)
{
	if(!isdefined(param_00))
	{
		param_00 = 0;
	...
	var_02 = lib_A79D::createfontstring("hudbig",level.primaryprogressbarfontsize);
	var_02 lib_A79D::setpoint("CENTER",undefined,level.primaryprogressbartextx + param_00,level.primaryprogressbartexty + param_01);
	var_02.fontscale = -1;
	return var_02;
}

//Function Number: 20
lib_A79D::createteamprogressbar(param_00)
{
	var_01 = lib_A79D::createserverbar((1,0,0),level.teamprogressbarwidth,level.teamprogressbarheight,undefined,param_00);
	var_01 lib_A79D::setpoint("TOP",undefined,0,level.teamprogressbary);
	return var_01;
}

//Function Number: 21
lib_A79D::createteamprogressbartext(param_00)
{
	var_01 = lib_A79D::createserverfontstring("default",level.teamprogressbarfontsize,param_00);
	var_01 lib_A79D::setpoint("TOP",undefined,0,level.teamprogressbartexty);
	return var_01;
}

//Function Number: 22
lib_A79D::setflashfrac(param_00)
{
...
lib_A79D::destroyelem()
{
	...
	{
		var_00[var_01] lib_A79D::setparent(lib_A79D::getparent());
	}
...
//Function Number: 27
lib_A79D::seticonshader(param_00)
{
...
//Function Number: 28
lib_A79D::geticonshader(param_00)
{
	return self.shader;
}

//Function Number: 29
lib_A79D::seticonsize(param_00,param_01)
{
	self setshader(self.shader,param_00,param_01);
}

//Function Number: 30
lib_A79D::setwidth(param_00)
{
	self.width = param_00;
}

//Function Number: 31
lib_A79D::setheight(param_00)
{
	self.height = param_00;
}

//Function Number: 32
lib_A79D::setsize(param_00,param_01)
{
	self.width = param_00;
...
//Function Number: 33
lib_A79D::updatechildren()
{
	for(var_00 = 0;var_00 < self.children.size;var_00++)
	{
		var_01 = self.children[var_00];
		var_01 lib_A79D::setpoint(var_01.point,var_01.relativepoint,var_01.xoffset,var_01.yoffset);
	}
}

//Function Number: 34
lib_A79D::transitionreset()
{
	self.x = self.xoffset;
	self.y = self.yoffset;
...
//Function Number: 35
lib_A79D::transitionzoomin(param_00)
{
	switch(self.elemtype)
	{
		case "timer":
...
//Function Number: 36
lib_A79D::transitionpulsefxin(param_00,param_01)
{
...
//Function Number: 37
lib_A79D::transitionslidein(param_00,param_01)
{
	if(!isdefined(param_01))
	{
		param_01 = "left";
...
//Function Number: 38
lib_A79D::transitionslideout(param_00,param_01)
{
	if(!isdefined(param_01))
	{
		param_01 = "left";
...
//Function Number: 39
lib_A79D::transitionzoomout(param_00)
{
	switch(self.elemtype)
	{
		case "timer":
...
//Function Number: 40
lib_A79D::transitionfadein(param_00)
{
...
//Function Number: 41
lib_A79D::transitionfadeout(param_00)
{
...
//Function Number: 42
lib_A79D::istimelimitedchallenge(param_00)
{
...
//Function Number: 43
lib_A79D::isweaponclasschallenge(param_00)
{
...
//Function Number: 44
lib_A79D::ch_getprogress(param_00)
{
	if(lib_A79D::isweaponclasschallenge(param_00))
	{
		return lib_A79D::processviaitemstatsprogress(param_00);
	}
...
//Function Number: 45
lib_A79D::ch_getstate(param_00)
{
	if(lib_A79D::isweaponclasschallenge(param_00))
	{
		return lib_A79D::processviaitemstatsstate(param_00);
	}
...
//Function Number: 46
lib_A79D::ch_setprogress(param_00,param_01)
{
	if(lib_A79D::isweaponclasschallenge(param_00))
	{
		return;
	...
	if(maps\mp\_utility::isstrstart(param_00,"ch_daily_"))
	{
		self setplayerdata("challengeProgress","ch_marksman_iw5_dlcgun12",var_02);
		return;
	}

	self setplayerdata("challengeProgress",param_00,var_02);
}

//Function Number: 47
lib_A79D::ch_setstate(param_00,param_01)
{
	if(lib_A79D::isweaponclasschallenge(param_00))
	{
		return;
	...
	if(maps\mp\_utility::isstrstart(param_00,"ch_daily_"))
	{
		self setplayerdata("challengeState","ch_marksman_iw5_dlcgun12",param_01);
		return;
	}

	self setplayerdata("challengeState",param_00,param_01);
}

//Function Number: 48
lib_A79D::ch_gettarget(param_00,param_01)
{
	var_02 = tablelookup("mp/allChallengesTable.csv",0,param_00,9 + param_01 - 1 * 2);
...
//Function Number: 49
lib_A79D::displayclientstring(param_00,param_01,param_02,param_03)
{
	var_04 = lib_A79D::createfontstring("hudbig",param_02);
	var_04 lib_A79D::setpoint("CENTER","CENTER",0,param_01);
	var_04.fontscale = 1001;
	var_04.color = (1,1,1);
	var_04.foreground = 0;
	...
	if(isdefined(var_04))
	{
		var_04 lib_A79D::destroyelem();
	}
}

//Function Number: 50
lib_A79D::processviaitemstatsprogress(param_00)
{
	if(common_scripts\utility::string_starts_with(param_00,"ch_attach_unlock_hipfirekills"))
	{
		return lib_A79D::totalallweaponvariants(param_00,"hipfirekills");
	}
	else if(common_scripts\utility::string_starts_with(param_00,"ch_attach_unlock_kills"))
	{
		return lib_A79D::totalallweaponvariants(param_00,"kills");
	}
	else if(common_scripts\utility::string_starts_with(param_00,"ch_attach_unlock_headShots"))
	{
		return lib_A79D::totalallweaponvariants(param_00,"headShots");
	}
}

//Function Number: 51
lib_A79D::processviaitemstatsstate(param_00)
{
	var_01 = lib_A79D::processviaitemstatsprogress(param_00);
	var_02 = 1;
	for(var_03 = lib_A79D::ch_gettarget(param_00,var_02);var_03 > 0 && var_01 >= var_03;var_03 = lib_A79D::ch_gettarget(param_00,var_02))
	{
		var_02++;
	}
...
//Function Number: 52
lib_A79D::totalallweaponvariants(param_00,param_01)
{
	var_02 = undefined;
	var_03 = 0;
	...
	if(isdefined(var_02))
	{
		...
		while(var_06 >= 0)
		{
			...
			var_03 = var_03 + self getrankedplayerdata("weaponStats",var_07,param_01);
		...
		var_08 = self getrankedplayerdata("attachUnlock_" + param_01,var_02);
		if(var_08 > var_03)
		{
			var_08 = 0;
		}
