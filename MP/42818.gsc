...
lib_A742::main()
{
	...
	{
		var_00[var_01] thread lib_A742::lanterns();
	}

	maps\mp\_audio::init_audio();
	maps\mp\_art::main();
	lib_A742::setupexploders();
	...
	{
		lib_A742::deleteduringreflectionprobegeneration();
		maps\mp\gametypes\_spawnlogic::setmapcenterfordev();
...
//Function Number: 2
lib_A742::exploder_load(param_00)
{
	...
	if(isdefined(param_00.script_chance) && randomfloat(1) > param_00.script_chance)
	{
		...
		level thread lib_A742::exploder_load(param_00);
		return;
	}
...
lib_A742::setupexploders()
{
	...
	for(var_02 = 0;var_02 < var_03.size;var_02++)
	{
		...
		var_07.v = [];
		var_07.v["origin"] = var_06.var_2E6;
		var_07.v["angles"] = var_06.var_41;
...
lib_A742::lanterns()
{
	common_scripts\_fx::loopfx("lantern_light",self.var_2E6,0.3,self.var_2E6 + (0,0,1));
}

//Function Number: 5
lib_A742::hurtplayersthink()
{
...
//Function Number: 6
lib_A742::setupdestructiblekillcaments()
{
...
//Function Number: 7
lib_A742::deletedestructiblekillcament()
{
	level endon("game_ended");
