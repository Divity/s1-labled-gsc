...
lib_A752::func_8E50()
{
	thread lib_A752::func_8E4D();
	thread lib_A752::func_8E4B();
}
...
lib_A752::func_8E4D()
{
	...
	for(;;)
	{
		...
		if(var_02 && self playerads() > 0.99)
		{
			...
			self.var_8E48.var_580A = lib_A752::func_0CF8(common_scripts\utility::array_removeundefined(self.var_8E48.var_580A));
			if(isdefined(self.var_8E48.var_580F))
			{
				if(!lib_A752::func_5810(self.var_8E48.var_580F))
				{
			...
			else
			{
				...
				{
					self.var_8E48.var_580F = lib_A752::func_3CD7();
					if(isdefined(self.var_8E48.var_580F))
					{
						thread lib_A752::func_580E();
					}
				}
			}
...
lib_A752::func_8E4B()
{
	...
	for(;;)
	{
		...
		{
			thread lib_A752::func_8E37(self,var_00,var_01);
		}
	}
}

//Function Number: 4
lib_A752::func_8E37(param_00,param_01,param_02)
{
	var_03 = (0,0,0);
	var_04 = (0,0,0);
	...
	param_00.var_8E48.var_580A = lib_A752::func_0CF8(common_scripts\utility::array_removeundefined(self.var_8E48.var_580A));
	var_05 = [];
	for(var_06 = 0;var_06 < 4;var_06++)
	{
		var_07 = var_04 + lib_A752::random_vector(20,20,20);
		...
		if(param_00.var_8E48.var_580A.size > 0)
		{
			...
			var_09 missilesettargetent(var_0A,lib_A752::func_8E45(var_0A));
...
//Function Number: 5
lib_A752::func_0C99(param_00,param_01)
{
...
lib_A752::func_3CD7()
{
	...
	foreach(var_16 in var_10)
	{
		...
		{
			var_17 = lib_A752::func_8E46(var_16);
...
//Function Number: 7
lib_A752::func_5810(param_00)
{
	var_01 = self geteye();
	var_02 = anglestoforward(self getplayerangles());
	var_03 = lib_A752::func_8E46(param_00);
...
//Function Number: 10
lib_A752::func_8E45(param_00)
{
	return lib_A752::func_8E46(param_00) - param_00.var_2E6;
}
...
lib_A752::func_5807()
{
	...
	for(;;)
	{
		if(isdefined(level.spawnedwarbirds))
		{
			foreach(var_01 in level.spawnedwarbirds)
			{
				if(isdefined(var_01.owner) && isdefined(var_01.var_31D) && isdefined(self.var_8E48.var_580A) && lib_A752::isinarray(self.var_8E48.var_580A,var_01))
				{
					var_01.owner method_82F4("wpn_stingerm7_enemy_locked");
				}
			}
		...
		if(isdefined(level.orbitalsupport_player) && isdefined(self.var_8E48.var_580A) && lib_A752::isinarray(self.var_8E48.var_580A,level.orbitalsupport_planemodel))
		{
			level.orbitalsupport_player method_82F4("wpn_stingerm7_enemy_locked");
		}
