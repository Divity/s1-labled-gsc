...
//Function Number: 1
lib_A737::monitor_exocrossbow_launch()
{
...
wait_for_stuck(param_00)
{
	...
	param_00 thread lib_A737::determine_sticky_position(self,var_01);
}

//Function Number: 3
lib_A737::determine_sticky_position(param_00,param_01)
{
	self endon("death");
	...
	thread lib_A737::sticky_timer(param_00);
	thread lib_A737::sticky_fx(param_00);
	thread lib_A737::remove_sticky_on_explosion(param_00);
	thread lib_A737::cleanup_sticky_on_death();
	thread maps\mp\gametypes\_weapons::stickyhandlemovers("detonate");
}

//Function Number: 4
lib_A737::sticky_timer(param_00)
{
	self endon("death");
	wait(1.5);
...
//Function Number: 6
lib_A737::remove_sticky_on_explosion(param_00)
{
	self endon("death");
	self waittill("exocrossbow_exploded");
	lib_A737::cleanup_sticky();
}

//Function Number: 7
lib_A737::cleanup_sticky_on_death()
{
	self endon("exocrossbow_exploded");
	self waittill("death");
	lib_A737::cleanup_sticky();
