...
lib_A749::watchmutebombusage()
{
	...
	for(;;)
	{
		...
		if(var_01 == "mute_bomb_mp")
		{
			...
			thread lib_A749::tryusemutebomb(var_00);
		}
	}
}
...
//Function Number: 3
lib_A749::tryusemutebomb(param_00)
{
	...
	thread lib_A749::startmutebomb(param_00);
	thread lib_A749::monitorplayerdeath(param_00);
	param_00 thread lib_A749::monitormutebombdeath();
	return 1;
}

//Function Number: 4
lib_A749::startmutebomb(param_00)
{
	...
	param_00 thread lib_A749::monitormutebombplayers();
	wait(20);
...
//Function Number: 5
lib_A749::monitorplayerdeath(param_00)
{
...
//Function Number: 7
lib_A749::monitormutebombplayers()
{
	self endon("ShutdownMuteBomb");
	var_00 = 475;
