...
lib_A7C0::init()
{
	...
	thread lib_A7C0::onplayerconnect();
	level.killstreakfuncs["recon_ugv"] = ::lib_A7C0::tryuserecondrone;
...
//Function Number: 3
lib_A7C0::tryuserecondrone(param_00,param_01)
{
	...
	var_02 = lib_A7C0::getdronespawnpoint();
	...
	var_04 = lib_A7C0::createreconuav(param_00,param_01,var_02.var_2E6,var_02.var_41);
	common_scripts\utility::_enableweaponswitch();
	self switchtoweapon("killstreak_predator_missile_mp");
	if(isdefined(var_04))
	{
		maps\mp\_matchdata::logkillstreakevent("recon_ugv",self.var_2E6);
...
//Function Number: 4
lib_A7C0::onplayerconnect()
{
	for(;;)
	{
		level waittill("connected",var_00);
		var_00 thread lib_A7C0::onplayerspawned();
	}
}

//Function Number: 5
lib_A7C0::onplayerspawned()
{
...
//Function Number: 6
lib_A7C0::createreconuav(param_00,param_01,param_02,param_03)
{
	var_04 = "recon_uav_mp";
	...
	thread lib_A7C0::playercommonreconvehiclesetup(var_06,param_01,param_00);
	var_06.var_275 = 250;
	...
	var_06 thread maps\mp\gametypes\_damage::setentitydamagecallback(var_06.var_275,undefined,::lib_A7C0::onrecondronedeath,::maps\mp\killstreaks\_aerial_utility::heli_modifydamage,1);
	if(var_06.hascloak)
	{
		thread maps\mp\killstreaks\_drone_common::dronecloakready(var_06,var_06.hascloak);
	}

	lib_A7C0::startusingreconvehicle(var_06);
	thread lib_A7C0::monitoruavsafearea(var_06);
	thread lib_A7C0::monitorplayerdisconnect(var_06);
	thread lib_A7C0::monitorplayerswitchteams(var_06);
	thread lib_A7C0::monitorplayergameended(var_06);
	thread lib_A7C0::reconhandletimeoutwarning(var_06);
	thread lib_A7C0::reconhandletimeout(var_06);
	thread lib_A7C0::reconhandledeath(var_06);
	thread lib_A7C0::reconhudsetup(var_06);
	thread maps\mp\killstreaks\_drone_common::playerwatchfordroneemp(var_06);
	var_08 = spawnstruct();
	var_08.validateaccuratetouching = 1;
	var_08.deathoverridecallback = ::lib_A7C0::override_drone_platform_death;
	var_06 thread maps\mp\_movers::handle_moving_platforms(var_08);
	var_06.getstingertargetposfunc = ::lib_A7C0::reconuav_stinger_target_pos;
	return var_06;
}

//Function Number: 7
lib_A7C0::reconuav_stinger_target_pos()
{
	return self gettagorigin("tag_origin");
}

//Function Number: 8
lib_A7C0::override_drone_platform_death(param_00)
{
	self notify("death");
}

//Function Number: 9
lib_A7C0::setupplayercommands(param_00)
{
	if(isbot(self))
	{
		return;
...
//Function Number: 10
lib_A7C0::disableplayercommands(param_00)
{
	if(isbot(self))
	{
		return;
	...
	self method_849C("recon_fire_main","+attack");
	self method_849C("recon_fire_main","+attack_akimbo_accessible");
	self method_849C("recon_fire_secondary","+speed_throw");
	self method_849C("recon_fire_secondary","+toggleads_throw");
	self method_849C("recon_fire_secondary","+ads_akimbo_accessible");
...
//Function Number: 11
lib_A7C0::playercommonreconvehiclesetup(param_00,param_01,param_02)
{
	...
	param_00.var_5D57 = param_01;
	param_00.hasarhud = common_scripts\utility::array_contains(param_00.var_5D57,"recon_ugv_ar_hud");
	param_00.haspaintgrenade = 1;
	param_00.hasassistpoints = common_scripts\utility::array_contains(param_00.var_5D57,"recon_ugv_assist_points");
	param_00.hasstun = common_scripts\utility::array_contains(param_00.var_5D57,"recon_ugv_stun");
	param_00.hasincreasedtime = common_scripts\utility::array_contains(param_00.var_5D57,"recon_ugv_increased_time");
	param_00.hascloak = common_scripts\utility::array_contains(param_00.var_5D57,"recon_ugv_cloak");
	param_00.hasempgrenade = common_scripts\utility::array_contains(param_00.var_5D57,"recon_ugv_emp");
	param_00 hide();
	param_00 makeunusable();
	param_00 makevehiclesolidcapsule(23,-9,23);
	param_00 setcandamage(1);
	param_00 common_scripts\utility::make_entity_sentient_mp(param_00.inliveplayerkillstreak);
	lib_A7C0::reconspawnturret(param_00);
	thread maps\mp\killstreaks\_drone_common::dronesetupcloaking(param_00,param_00.hascloak);
	wait(1.6);
	lib_A7C0::setupplayercommands(param_01);
	thread lib_A7C0::notify_recon_drone_on_player_command(param_00);
	...
	thread lib_A7C0::reconplayerexit(param_00);
}
...
lib_A7C0::reconspawnturret(param_00)
{
	...
	var_04.var_41 = param_00 gettagangles(var_02);
	...
	var_04 makeunusable();
	var_04.inliveplayerkillstreak = param_00.inliveplayerkillstreak;
	var_04.connectedpostgame["team"] = param_00.inliveplayerkillstreak;
	if(level.teambased)
	{
		var_04 setturretteam(param_00.inliveplayerkillstreak);
	}
	...
	var_04.firesoundent method_8446(param_00,var_02,(0,0,0),(0,0,0));
	var_04.firesoundent setcontents(0);
	var_04 hide();
	param_00.mgturret = var_04;
	if(param_00.haspaintgrenade)
	{
		thread lib_A7C0::firethreatgrenades(param_00);
	}

	if(param_00.hasempgrenade)
	{
		thread lib_A7C0::fireempgrenades(param_00);
	}
}

//Function Number: 13
lib_A7C0::firethreatgrenades(param_00)
{
	param_00 endon("death");
	self endon("disconnect");
	var_01 = gettime();
	...
	for(;;)
	{
		...
		var_04 = param_00.targetent.var_2E6;
...
//Function Number: 14
lib_A7C0::fireempgrenades(param_00)
{
	param_00 endon("death");
	self endon("disconnect");
	for(;;)
...
//Function Number: 15
lib_A7C0::notify_recon_drone_on_player_command(param_00)
{
	self endon("disconnect");
	param_00 endon("death");
	for(;;)
...
//Function Number: 16
lib_A7C0::startusingreconvehicle(param_00)
{
	var_01 = self;
	...
	{
		var_01.var_52A3.alpha = 0;
	}
}

//Function Number: 17
lib_A7C0::reconhudsetup(param_00)
{
	param_00 endon("death");
	self endon("disconnect");
	lib_A7C0::reconhudremove(param_00);
	wait(0.5);
...
//Function Number: 19
lib_A7C0::monitoruavsafearea(param_00)
{
	self endon("reconStreakComplete");
...
//Function Number: 20
lib_A7C0::monitorplayerdisconnect(param_00)
{
...
//Function Number: 21
lib_A7C0::monitorplayerswitchteams(param_00)
{
	self endon("reconStreakComplete");
...
//Function Number: 22
lib_A7C0::monitorplayergameended(param_00)
{
	self endon("reconStreakComplete");
...
//Function Number: 23
lib_A7C0::onrecondronedeath(param_00,param_01,param_02,param_03)
{
...
//Function Number: 24
lib_A7C0::reconhandletimeoutwarning(param_00)
{
	param_00 endon("death");
	var_01 = 10;
	var_02 = 1;
...
//Function Number: 25
lib_A7C0::reconhandletimeout(param_00)
{
	param_00 endon("death");
...
//Function Number: 26
lib_A7C0::reconhandledeath(param_00)
{
	...
	{
		thread maps\mp\_utility::leaderdialogonplayer("ks_recdrone_destroyed",undefined,undefined,self.var_2E6);
	}

	if(isdefined(self) && self.using_remote_tank || maps\mp\_utility::isusingremote())
	{
		lib_A7C0::reconsetinactivity(param_00);
		self.using_remote_tank = 0;
		if(maps\mp\_utility::isjuggernaut())
		{
			self.var_52A3.alpha = 1;
		}
	}
...
lib_A7C0::reconsetinactivity(param_00)
{
	...
	if(isdefined(var_01.using_remote_tank) && var_01.using_remote_tank)
	{
		...
		var_01 lib_A7C0::reconhudremove(param_00);
		var_01 lib_A7C0::disableplayercommands(param_00);
...
//Function Number: 28
lib_A7C0::reconplayerexit(param_00)
{
	if(!isdefined(self))
	{
		return;
