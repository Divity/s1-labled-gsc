...
lib_A756::init()
{
	...
	level thread lib_A756::onplayerconnect();
	level thread lib_A756::watchagentspawn();
}

//Function Number: 2
lib_A756::changethreatstyle(param_00)
{
	...
	foreach(var_02 in level.var_328)
	{
		var_02 lib_A756::threat_init(param_00);
	}
...
lib_A756::getthreatstyle()
{
	...
	{
		lib_A756::changethreatstyle(var_00);
	}
...
//Function Number: 4
lib_A756::onplayerconnect()
{
	for(;;)
	{
		level waittill("connected",var_00);
		var_00 thread lib_A756::onplayerspawned();
	}
}

//Function Number: 5
lib_A756::watchagentspawn()
{
	for(;;)
	{
		...
		var_00 thread lib_A756::onagentspawned();
	}
}

//Function Number: 6
lib_A756::onagentspawned()
{
	self endon("death");
	childthread lib_A756::monitorthreathighlight();
	childthread lib_A756::cleanupondeath();
}

//Function Number: 7
lib_A756::onplayerspawned()
{
	...
	childthread lib_A756::monitorthreathighlight();
	childthread lib_A756::cleanupondeath();
	childthread lib_A756::monitorthreathighlightnotification();
	for(;;)
	{
		self waittill("spawned_player");
		var_00 = lib_A756::getthreatstyle();
		if(var_00 == "attached_glow")
		{
			lib_A756::visitfxent(::lib_A756::visitorrelink,::lib_A756::gethostilemarker,undefined);
		}
	}
}

//Function Number: 8
lib_A756::monitorthreathighlightnotification()
{
	...
	for(;;)
	{
		if(self._threatdetection.showlist.size != 0)
		{
			...
			{
				var_00.hidden = 0;
				var_00 childthread lib_A756::threatnotificationoverlayflash(var_01,var_02);
			}
		}
...
//Function Number: 9
lib_A756::threatnotificationoverlayflash(param_00,param_01)
{
...
//Function Number: 10
lib_A756::debughelper()
{
	for(;;)
	{
		var_00 = distance(self.var_2E6,level.var_328[0].var_2E6);
		thread common_scripts\utility::draw_line_for_time(level.var_328[0].var_2E6,self.var_2E6,1,1,1,0.3);
		if(isdefined(self._threatdetection.mark_enemy_model))
		{
			thread common_scripts\utility::draw_line_for_time(level.var_328[0].var_2E6,self._threatdetection.mark_enemy_model.var_2E6,1,1,1,0.3);
		}
...
//Function Number: 11
lib_A756::cleanupondeath()
{
	self endon("disconnect");
	for(;;)
	{
		self waittill("death");
		lib_A756::removethreatevents();
	}
}
...
lib_A756::removethreatevents()
{
	...
	var_06 = lib_A756::getthreatstyle();
	if(var_06 == "attached_glow")
	{
		lib_A756::visitfxent(::lib_A756::visitorhideall,::lib_A756::gethostilemarker,undefined);
	}
}

//Function Number: 13
lib_A756::detection_highlight_hud_effect_on(param_00,param_01,param_02)
{
	...
	var_03.alpha = 1;
	var_03 method_83A4(param_01);
	return var_03;
}

//Function Number: 14
lib_A756::detection_highlight_hud_effect_off(param_00)
{
...
//Function Number: 15
lib_A756::detection_highlight_hud_effect(param_00,param_01,param_02,param_03)
{
	var_04 = lib_A756::detection_highlight_hud_effect_on(param_00,param_01,param_02);
	...
	lib_A756::detection_highlight_hud_effect_off(var_04);
}

//Function Number: 16
lib_A756::detection_grenade_hud_effect(param_00,param_01,param_02,param_03)
{
	var_04 = newhudelem();
	var_04.x = param_01[0];
	var_04.y = param_01[1];
	...
	var_04 method_83A3(int(param_03 + var_05 / 2),int(var_05),param_02 + 0.05);
	wait(param_02);
	if(isdefined(var_04))
	{
		var_04 destroy();
...
//Function Number: 17
lib_A756::exo_ping_hud_effect(param_00,param_01,param_02,param_03,param_04)
{
	var_05 = undefined;
	if(isdefined(param_03))
	{
	...
	var_05 method_83A3(int(param_02),int(var_06),param_01 + 0.05);
	wait(param_01);
	if(isdefined(var_05))
	{
		var_05 destroy();
...
//Function Number: 18
lib_A756::addthreatevent(param_00,param_01,param_02,param_03,param_04,param_05)
{
	if(!isalive(self))
	{
		return;
	...
	var_09 = lib_A756::getthreatstyle();
	...
	foreach(var_0B in param_00)
	{
		...
		if(!var_0C)
		{
			...
			self._threatdetection.showlist[var_10].var_31D = var_0B;
	...
	if(isplayer(self))
	{
		if(param_04)
		{
			lib_A756::visitfxent(::lib_A756::visitorupdatemarkerpos,::lib_A756::getfriendlymarker,undefined);
		}

		if(param_03)
		{
			lib_A756::visitfxent(::lib_A756::visitorupdatemarkerpos,::lib_A756::gethostilemarker,undefined);
		}
	}
}

//Function Number: 19
lib_A756::stopthreateventtype(param_00)
{
	...
	var_04 = lib_A756::getthreatstyle();
...
//Function Number: 20
lib_A756::visitfxent(param_00,param_01,param_02)
{
	var_03 = lib_A756::getthreatstyle();
	if(var_03 == "glow")
	{
...
//Function Number: 21
lib_A756::visitorrelink(param_00,param_01,param_02)
{
	param_00 unlink();
	param_00.var_2E6 = self gettagorigin(param_02);
	param_00.var_41 = self gettagangles(param_02);
...
//Function Number: 22
lib_A756::visitorhideall(param_00,param_01,param_02)
{
	var_03 = lib_A756::getthreatstyle();
	if(var_03 == "attached_glow")
	{
...
//Function Number: 23
lib_A756::visitorupdatemarkerpos(param_00,param_01,param_02)
{
	var_03 = lib_A756::getthreatstyle();
	param_00.var_2E6 = self gettagorigin(param_02);
	param_00.var_41 = self gettagangles(param_02);
...
//Function Number: 24
lib_A756::gethostilemarker(param_00)
{
	var_01 = lib_A756::getthreatstyle();
	if(var_01 == "glow")
	{
...
//Function Number: 25
lib_A756::getfriendlymarker(param_00)
{
	var_01 = lib_A756::getthreatstyle();
	if(var_01 == "glow")
	{
...
//Function Number: 26
lib_A756::getfriendlylosmarker(param_00)
{
	var_01 = lib_A756::getthreatstyle();
	if(var_01 == "glow")
	{
...
//Function Number: 27
lib_A756::gethostilelosmarker(param_00)
{
	var_01 = lib_A756::getthreatstyle();
	if(var_01 == "glow")
	{
...
//Function Number: 28
lib_A756::visithideallmarkers(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		foreach(var_05 in self._threatdetection.showlist)
		{
			if(var_05.endtime >= var_02)
			{
				...
				var_05.los = 0;
				var_06 = lib_A756::getnormaldirectionvec(anglestoforward(var_05.var_31D.var_41));
				var_07 = lib_A756::getnormaldirectionvec(self.var_2E6 - var_05.var_31D.var_2E6);
		...
		var_0A = lib_A756::getthreatstyle();
		if(!var_01)
		{
			var_01 = 1;
			if(var_0A == "glow")
		...
		foreach(var_10 in self._threatdetection.showlist)
		{
			if(var_10.los)
			{
				lib_A756::showthreat(var_10.var_31D,::lib_A756::getfriendlylosmarker,::lib_A756::gethostilelosmarker,::lib_A756::visitorupdatelosmarker);
				lib_A756::prepare_show_threat(var_01,var_0A,var_10.var_31D);
				var_01 = 0;
				continue;
			}

			var_11 = bullettrace(var_10.var_31D.var_2E6 + var_00,self.var_2E6 + var_00,1,var_10.var_31D);
			if(var_11["fraction"] < 1 && !isplayer(var_11["entity"]))
			{
				lib_A756::showthreat(var_10.var_31D,::lib_A756::getfriendlymarker,::lib_A756::gethostilemarker,::lib_A756::visitorshowtoplayer);
				lib_A756::prepare_show_threat(var_01,var_0A,var_10.var_31D);
				var_01 = 0;
			}
		}
...
//Function Number: 32
lib_A756::prepare_show_threat(param_00,param_01,param_02)
{
	if(param_00)
	{
		if(param_01 == "attached_glow")
		{
			lib_A756::showthreat(param_02,::lib_A756::getfriendlylosmarker,::lib_A756::gethostilelosmarker,::lib_A756::visitorretriggerfx);
		}
	}
}

//Function Number: 33
lib_A756::visitorretriggerfx(param_00,param_01,param_02)
{
	playfxontag(param_00.fx,param_00,"tag_origin");
}

//Function Number: 34
lib_A756::check_los(param_00)
{
	if(bullettracepassed(param_00.var_31D geteye(),self geteye(),0,param_00.var_31D))
	{
		return 1;
	}
...
lib_A756::threat_init(param_00)
{
	...
	if(param_00 == "glow")
	{
		...
		{
			var_04 = spawnstruct();
			var_04.var_2E6 = self gettagorigin(var_03[0]);
			var_04.var_41 = self gettagangles(var_03[0]);
			var_04.enemymarker = spawnfx(var_03[1],var_04.var_2E6);
			triggerfx(var_04.enemymarker);
			var_04.enemymarker hide();
			var_04.enemylosmarker = spawnfx(var_03[3],var_04.var_2E6);
			triggerfx(var_04.enemylosmarker);
			var_04.enemylosmarker hide();
			var_04.friendlymarker = spawnfx(var_03[2],var_04.var_2E6);
			triggerfx(var_04.friendlymarker);
			var_04.friendlymarker hide();
			var_04.friendlylosmarker = spawnfx(var_03[4],var_04.var_2E6);
	...
	if(param_00 == "model")
	{
		var_06 = spawn("script_model",self.var_2E6);
		var_06.var_2E6 = self.var_2E6;
		var_06.var_41 = self.var_41;
		var_06 setmodel(level._threatdetection.var_3AB6);
	...
	if(param_00 == "vfx_model")
	{
		...
		self._threatdetection.mark_friendly_model = spawnfx(common_scripts\utility::getfx("threat_detect_model_stand"),self.var_2E6,anglestoforward(self.var_41),anglestoup(self.var_41));
		self._threatdetection.friendly_pose = "threat_detect_model_stand";
		self._threatdetection.mark_enemy_model = spawnstruct();
		self._threatdetection.mark_enemy_model = spawnfx(common_scripts\utility::getfx("threat_detect_model_stand_hostile"),self.var_2E6,anglestoforward(self.var_41),anglestoup(self.var_41));
	...
	if(param_00 == "attached_glow")
	{
		foreach(var_05, var_03 in level._threatdetection.fx_data)
		{
			...
			var_08 show();
			var_08.var_2E6 = self gettagorigin(var_03[0]);
			var_08.var_41 = self gettagangles(var_03[0]);
...
//Function Number: 36
lib_A756::visitorupdatelosmarker(param_00,param_01,param_02)
{
	lib_A756::visitorupdatemarkerpos(param_00,param_01,param_02);
	lib_A756::visitorshowtoplayer(param_00,param_01,param_02);
}
...
//Function Number: 38
lib_A756::showthreat(param_00,param_01,param_02,param_03)
{
	if(param_00 == self)
	{
		return;
	...
	var_04 = param_02;
	if((level.teambased || level.multiteambased) && param_00.inliveplayerkillstreak == self.inliveplayerkillstreak)
	{
		var_04 = param_01;
	}
	...
	lib_A756::visitfxent(param_03,var_04,param_00);
}