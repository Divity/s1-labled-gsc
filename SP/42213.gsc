...
//Function Number: 1
lib_A4E5::setmodelfromarray(param_00)
{
	self setmodel(param_00[randomint(param_00.size)]);
}

//Function Number: 2
lib_A4E5::precachemodelarray(param_00)
{
...
//Function Number: 3
lib_A4E5::attachhead(param_00,param_01)
{
	...
	lib_A4E5::setheadmodel(param_01[var_02]);
}

//Function Number: 4
lib_A4E5::setheadmodel(param_00)
{
...
//Function Number: 5
lib_A4E5::attachhat(param_00,param_01)
{
...
//Function Number: 10
lib_A4E5::get_random_character(param_00)
{
	...
	{
		if(isdefined(self.connectedpostgame["modelIndex"]) && self.connectedpostgame["modelIndex"] < param_00)
		{
			return self.connectedpostgame["modelIndex"];
		}

		var_02 = randomint(param_00);
		self.connectedpostgame["modelIndex"] = var_02;
		return var_02;
	}
	...
	{
		lib_A4E5::initialize_character_group(var_04,var_02,param_00);
	}

	if(!isdefined(var_03))
	{
		var_03 = lib_A4E5::get_least_used_index(var_04,var_02);
		if(!isdefined(var_03))
		{
...
//Function Number: 11
lib_A4E5::get_least_used_index(param_00,param_01)
{
	var_02 = [];
	...
	return lib_A4E5::random(var_02);
}

//Function Number: 12
lib_A4E5::initialize_character_group(param_00,param_01,param_02)
{
...
//Function Number: 13
lib_A4E5::get_random_weapon(param_00)
{
	return randomint(param_00);
}

//Function Number: 14
lib_A4E5::random(param_00)
{
