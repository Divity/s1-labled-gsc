...
lib_A5CE::main()
{
	...
	thread lib_A570::func_3B97(500,"msg_fx_zone0_apartment_intro_vista");
	thread lib_A570::func_3B97(1000,"msg_fx_zone1_apartment_exit","msg_fx_zone1a_top_upper_mid_drop");
	thread lib_A570::func_3B97(1200,"msg_fx_zone1b_upper_mid_apartment");
	thread lib_A570::func_3B97(1400,"msg_fx_zone1c_mid_lower_drop","msg_fx_zone1d_mid_lower_drop_exit");
	thread lib_A570::func_3B97(1600,"msg_fx_zone1e_mid_lower_apartment","msg_fx_zone1f_lower_apartment_exit_drop");
	thread lib_A570::func_3B97(1800,"msg_fx_zone1g_building_ground_floor","msg_fx_zone1h_building_ground_floor_exit");
	thread lib_A570::func_3B97(2000,"msg_fx_zone2_forward_operating_base","msg_fx_zone2b_forward_operating_base_transition");
	thread lib_A570::func_3B97(2200,"msg_fx_zone2c_base_transition_exit","msg_fx_zone2d_drone_swarm_street");
	thread lib_A570::func_3B97(2400,"msg_fx_zone2e_exo_push_intersection","msg_fx_zone2f_performing_arts_front_streets");
	thread lib_A570::func_3B97(3000,"msg_fx_zone3_performing_arts_entrance","msg_fx_zone3a_performing_arts_exit");
	thread lib_A570::func_3B97(3600,"msg_fx_zone3b_transition_lobby","msg_fx_zone3c_transition_office_building");
	thread lib_A570::func_3B97(4000,"msg_fx_zone4_sinkhole_traverse","msg_fx_zone4a_sinkhole_exit");
	thread lib_A570::func_3B97(5000,"msg_fx_zone5_subway_traverse","msg_fx_zone5a_subway_ceiling_breach");
	thread lib_A570::func_3B97(6000,"msg_fx_zone6_escalator_exit_shopping","msg_fx_zone6a_shopping_district_street");
	thread lib_A570::func_3B97(6400,"msg_fx_zone6b_shopping_narrow_alley","msg_fx_zone6c_shopping_narrow_alley_exit");
	thread lib_A570::func_3B97(7000,"msg_fx_zone7_2nd_floor_building_overview","msg_fx_zone7a_river_bridge_section");
	thread lib_A5CE::func_4F0D();
	thread lib_A5CE::func_4F0C();
	thread lib_A5CE::func_9E81();
	thread lib_A5CE::func_9E80();
	thread lib_A5CE::func_9E83();
	thread lib_A5CE::func_4ED6();
	thread lib_A5CE::func_0B2B();
	thread lib_A5CE::func_0B1B();
	thread lib_A5CE::func_6528();
	thread lib_A5CE::func_652B();
	thread lib_A5CE::func_652A();
	thread lib_A5CE::func_6529();
	thread lib_A5CE::func_652C();
	thread lib_A5CE::func_2ECA();
	thread lib_A5CE::func_6BB4();
	thread lib_A5CE::func_6BC1();
	thread lib_A5CE::func_6BC0();
	thread lib_A5CE::func_858A();
	thread lib_A5CE::func_858C();
	thread lib_A5CE::func_858B();
	thread lib_A5CE::func_8F85();
	thread lib_A5CE::func_8F93();
	thread lib_A5CE::func_8417();
	thread lib_A5CE::func_8418();
	thread lib_A5CE::func_8419();
	thread lib_A5CE::func_7D2B();
	thread lib_A5CE::func_3736();
	thread lib_A5CE::func_3737();
	thread lib_A5CE::func_3738();
	thread lib_A5CE::func_9745();
}
...
lib_A5CE::func_3B28()
{
	thread lib_A570::func_3536(2);
}

//Function Number: 4
lib_A5CE::func_4F0D()
{
	thread lib_A5CE::func_4F51();
	thread lib_A5CE::func_4F0E();
}
...
lib_A5CE::func_4F51()
{
	...
	wait(5);
	lib_A59A::stop_exploder("95");
	lib_A59A::stop_exploder("97");
}
...
lib_A5CE::func_4F0E()
{
	...
	wait(0.9);
	playfxontag(common_scripts\utility::getfx("seo_intro_drop_pod_vm_motionline"),level.var_6E10,"tag_origin");
}

//Function Number: 7
lib_A5CE::func_4F0F(param_00)
{
...
//Function Number: 11
lib_A5CE::func_4EEB(param_00)
{
	var_01 = common_scripts\utility::spawn_tag_origin();
	var_01 linkto(param_00,"lock4",(900,-550,0),(90,0,0));
	param_00 lib_A5DE::snd_message("droppod_intro_blimp_explode");
	...
	thread lib_A5CE::func_4EEC(param_00);
	wait(1);
	var_02 delete();
	var_03 delete();
	wait(4);
...
lib_A5CE::func_4EEC(param_00)
{
	...
	thread lib_A5CE::func_4EED(param_00);
	wait(0.8);
	playfxontag(common_scripts\utility::getfx("seo_intro_blimp_explo2"),var_01,"tag_origin");
...
lib_A5CE::func_4EED(param_00)
{
	...
	thread lib_A5CE::func_4EEE(param_00);
	wait(0.3);
	playfxontag(common_scripts\utility::getfx("seo_intro_blimp_explo2"),var_01,"tag_origin");
	wait(0.3);
...
//Function Number: 14
lib_A5CE::func_4EEE(param_00)
{
	var_01 = common_scripts\utility::spawn_tag_origin();
	var_01 linkto(param_00,"tag_flash_flares",(0,0,150),(90,0,0));
	playfxontag(common_scripts\utility::getfx("seo_intro_blimp_explo2"),var_01,"tag_origin");
	wait(0.3);
	thread lib_A5CE::func_4EEF(param_00);
...
//Function Number: 18
lib_A5CE::func_58FA(param_00)
{
	var_01 = common_scripts\utility::spawn_tag_origin();
	var_01 linkto(param_00,"jetlid01",(-15,0,80),(75,0,0));
	param_00 lib_A5DE::snd_message("droppod_main_pod_jets");
	playfxontag(common_scripts\utility::getfx("drop_pod_hovering_side_spray"),var_01,"tag_origin");
	wait(0.2);
	stopfxontag(common_scripts\utility::getfx("drop_pod_hovering_side_spray"),var_01,"tag_origin");
	wait(0.6);
...
lib_A5CE::func_4F0C()
{
	...
	thread lib_A5CE::func_4EF8();
	thread lib_A5CE::func_4F29();
	thread lib_A5CE::func_4F16();
	thread lib_A5CE::func_4F41();
	thread lib_A5CE::func_4F48();
	thread lib_A5CE::func_4EC3();
}

//Function Number: 22
lib_A5CE::func_359B(param_00)
{
...
{
	wait(4.6);
	thread lib_A5CE::func_4ED1();
	lib_A59A::stop_exploder("100");
	wait(1);
	common_scripts\_exploder::exploder("110");
}

//Function Number: 24
lib_A5CE::func_359A(param_00)
{
...
lib_A5CE::func_4ED1()
{
	...
	lib_A59A::func_671D("150");
	lib_A59A::func_671D("110");
	lib_A59A::func_671D("105");
}
...
//Function Number: 32
lib_A5CE::func_4F44(param_00)
{
	playfxontag(common_scripts\utility::getfx("seo_intro_misl_trail"),param_00,"tag_origin");
}

//Function Number: 33
lib_A5CE::func_4F45(param_00)
{
	stopfxontag(common_scripts\utility::getfx("seo_intro_misl_trail"),param_00,"tag_origin");
}

//Function Number: 34
lib_A5CE::func_4F6F(param_00)
{
...
//Function Number: 37
lib_A5CE::func_4F52(param_00)
{
	level notify("msg_emergency_door_close");
}

//Function Number: 38
lib_A5CE::func_4F13(param_00)
{
...
lib_A5CE::func_4F57(param_00)
{
	...
	wait(3);
	thread lib_A5CE::func_370F(param_00);
...
//Function Number: 41
lib_A5CE::func_4F58(param_00)
{
}

//Function Number: 42
lib_A5CE::func_4F59(param_00)
{
}

//Function Number: 43
lib_A5CE::func_4F5A(param_00)
{
	level notify("hit_3");
}

//Function Number: 44
lib_A5CE::func_4F54(param_00)
{
...
//Function Number: 45
lib_A5CE::func_4F56(param_00)
{
	level notify("intro_pod_crash_end");
}

//Function Number: 46
lib_A5CE::func_4F55(param_00)
{
...
lib_A5CE::func_6AE1(param_00)
{
	...
	wait(1.5);
	lib_A59A::func_671D("cormack_smk_pod_exit");
	wait(6.5);
	lib_A59A::func_671D("cormack_sparks_pod_exit");
	lib_A59A::func_671D("cormack_land");
...
lib_A5CE::func_2211(param_00)
{
	...
	wait(5);
	lib_A59A::func_671D("cormack_land_ground_smk");
	wait(2.5);
	lib_A59A::func_671D("cormack_land_pulse");
}

//Function Number: 49
lib_A5CE::func_9DF0(param_00)
{
	wait(1.15);
...
lib_A5CE::func_9E81()
{
	...
	lib_A59A::delaythread(0.5,::common_scripts\_exploder::exploder,513);
	lib_A59A::delaythread(1.15,::common_scripts\_exploder::exploder,510);
	lib_A5DE::snd_message("vista_rockets_first_impact",1.15);
	lib_A59A::delaythread(2.95,::common_scripts\_exploder::exploder,511);
	lib_A5DE::snd_message("vista_rockets_pod_door_view_01",2.95);
	lib_A59A::delaythread(3.8,::common_scripts\_exploder::exploder,512);
	lib_A5DE::snd_message("vista_rockets_pod_door_view_02",3.8);
	lib_A59A::delaythread(12.5,::common_scripts\_exploder::exploder,"planks_exit_pod");
	lib_A59A::delaythread(15,::lib_A5CE::func_9E82);
	level waittill("reduce_falling_debris");
	lib_A59A::func_671D(514);
	lib_A59A::func_671D(513);
	wait(3);
	common_scripts\_exploder::kill_exploder("falling_planks_delayed");
}

//Function Number: 51
lib_A5CE::func_2F54(param_00)
{
...
lib_A5CE::func_4ED6()
{
	...
	lib_A59A::func_671D(550);
	wait(0.75);
	common_scripts\_exploder::exploder(518);
	wait(8.5);
	common_scripts\_exploder::exploder(550);
	lib_A59A::func_671D(518);
	lib_A59A::func_671D(515);
...
lib_A5CE::func_9E82()
{
	...
	thread lib_A570::func_8BB2("seo_ambexplo_air_nonlit_parent",var_00,var_02,var_03,"msg_kill_vista_effects",0,var_01,"vista_rockets");
}
...
lib_A5CE::func_9E80()
{
	...
	thread lib_A570::func_8BB2("aa_explosion_runner_single",var_00,var_02,var_03,"msg_kill_vista_effects",1,var_01,"seo_vista_amb_explos");
}
...
lib_A5CE::func_9E83()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_midair_runner_single",var_00,var_02,var_03,"msg_kill_vista_effects",1,var_01,"midair_exp_audio");
}
...
lib_A5CE::func_9745()
{
	...
	{
		lib_A59E::func_7EF7(var_05,"brick",var_02);
		lib_A59E::func_7EF7(var_05,"bark",var_02);
		lib_A59E::func_7EF7(var_05,"carpet",var_02);
		lib_A59E::func_7EF7(var_05,"cloth",var_02);
		lib_A59E::func_7EF7(var_05,"concrete",var_02);
		lib_A59E::func_7EF7(var_05,"dirt",var_02);
		lib_A59E::func_7EF7(var_05,"flesh",var_02);
		lib_A59E::func_7EF7(var_05,"foliage",var_02);
		lib_A59E::func_7EF7(var_05,"glass",var_02);
		lib_A59E::func_7EF7(var_05,"grass",var_02);
		lib_A59E::func_7EF7(var_05,"gravel",var_02);
		lib_A59E::func_7EF7(var_05,"ice",var_02);
		lib_A59E::func_7EF7(var_05,"metal",var_02);
		lib_A59E::func_7EF7(var_05,"mud",var_02);
		lib_A59E::func_7EF7(var_05,"paper",var_02);
		lib_A59E::func_7EF7(var_05,"plaster",var_02);
		lib_A59E::func_7EF7(var_05,"rock",var_02);
		lib_A59E::func_7EF7(var_05,"sand",var_02);
		lib_A59E::func_7EF7(var_05,"snow",var_02);
		lib_A59E::func_7EF7(var_05,"water",var_02);
		lib_A59E::func_7EF7(var_05,"wood",var_02);
		lib_A59E::func_7EF7(var_05,"asphalt",var_02);
		lib_A59E::func_7EF7(var_05,"ceramic",var_02);
		lib_A59E::func_7EF7(var_05,"plastic",var_02);
		lib_A59E::func_7EF7(var_05,"rubber",var_02);
		lib_A59E::func_7EF7(var_05,"cushion",var_02);
		lib_A59E::func_7EF7(var_05,"fruit",var_02);
		lib_A59E::func_7EF7(var_05,"paintedmetal",var_02);
		lib_A59E::func_7EF7(var_05,"riotshield",var_02);
		lib_A59E::func_7EF7(var_05,"slush",var_02);
		lib_A59E::func_7EF7(var_05,"default",var_02);
	}

	foreach(var_05 in var_00)
	{
		lib_A59E::func_7EF7(var_05,"brick",var_03);
		lib_A59E::func_7EF7(var_05,"bark",var_03);
		lib_A59E::func_7EF7(var_05,"carpet",var_03);
		lib_A59E::func_7EF7(var_05,"cloth",var_03);
		lib_A59E::func_7EF7(var_05,"concrete",var_03);
		lib_A59E::func_7EF7(var_05,"dirt",var_03);
		lib_A59E::func_7EF7(var_05,"flesh",var_03);
		lib_A59E::func_7EF7(var_05,"foliage",var_03);
		lib_A59E::func_7EF7(var_05,"glass",var_03);
		lib_A59E::func_7EF7(var_05,"grass",var_03);
		lib_A59E::func_7EF7(var_05,"gravel",var_03);
		lib_A59E::func_7EF7(var_05,"ice",var_03);
		lib_A59E::func_7EF7(var_05,"metal",var_03);
		lib_A59E::func_7EF7(var_05,"mud",var_03);
		lib_A59E::func_7EF7(var_05,"paper",var_03);
		lib_A59E::func_7EF7(var_05,"plaster",var_03);
		lib_A59E::func_7EF7(var_05,"rock",var_03);
		lib_A59E::func_7EF7(var_05,"sand",var_03);
		lib_A59E::func_7EF7(var_05,"snow",var_03);
		lib_A59E::func_7EF7(var_05,"water",var_03);
		lib_A59E::func_7EF7(var_05,"wood",var_03);
		lib_A59E::func_7EF7(var_05,"asphalt",var_03);
		lib_A59E::func_7EF7(var_05,"ceramic",var_03);
		lib_A59E::func_7EF7(var_05,"plastic",var_03);
		lib_A59E::func_7EF7(var_05,"rubber",var_03);
		lib_A59E::func_7EF7(var_05,"cushion",var_03);
		lib_A59E::func_7EF7(var_05,"fruit",var_03);
		lib_A59E::func_7EF7(var_05,"paintedmetal",var_03);
		lib_A59E::func_7EF7(var_05,"riotshield",var_03);
		lib_A59E::func_7EF7(var_05,"slush",var_03);
		lib_A59E::func_7EF7(var_05,"default",var_03);
	}
}
...
//Function Number: 60
lib_A5CE::func_2F55(param_00)
{
	lib_A59A::delaythread(0,::lib_A5CE::func_2F61,param_00);
	lib_A59A::delaythread(2.4,::lib_A5CE::func_2F56,param_00);
	lib_A59A::delaythread(2.97,::lib_A5CE::func_2F50,param_00);
}

//Function Number: 61
lib_A5CE::func_2F61(param_00)
{
	playfxontag(common_scripts\utility::getfx("drop_pod_hovering_thruster"),param_00,"tag_fx");
...
//Function Number: 62
lib_A5CE::func_2F56(param_00)
{
	playfxontag(common_scripts\utility::getfx("drop_pod_landing_impact_ground"),param_00,"tag_fx");
	earthquake(0.2,2.4,param_00.var_2E6,1600);
}

//Function Number: 63
lib_A5CE::func_2F50(param_00)
{
...
lib_A5CE::func_6528()
{
	...
	thread lib_A570::func_8BB2("aa_explosion_runner_single",var_00,var_02,var_03,"drone_swarm_spawning",1,var_01,"seo_ambient_ground_explosions");
}
...
lib_A5CE::func_652B()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_midair_runner_single",var_00,var_02,var_02,"drone_swarm_spawning",1,var_01,"midair_exp_audio");
}
...
lib_A5CE::func_652A()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_fireball",var_00,var_02,var_03,"drone_swarm_spawning",0,var_01,"seo_fireball_explosions");
}
...
lib_A5CE::func_6529()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_dirt_runner",var_00,var_02,var_03,"drone_swarm_spawning",0,var_01,"seo_dirt_explosions","incoming_complete");
}
...
lib_A5CE::func_652C()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_windowglass",var_00,var_02,var_03,"drone_swarm_spawning",0,var_01,"midair_exp_glass");
}

//Function Number: 69
lib_A5CE::func_9381(param_00)
{
	earthquake(0.2,1.8,param_00.var_2E6,1600);
	wait(1);
	earthquake(0.2,1.8,param_00.var_2E6,1600);
}

//Function Number: 70
lib_A5CE::func_938B(param_00)
{
	...
	earthquake(0.3,1.8,param_00.var_2E6,1600);
	wait(2.5);
	...
	wait(4);
	playfxontag(common_scripts\utility::getfx("titan_tread_impact"),param_00,"frontWheelTread07_FL");
	earthquake(0.2,1.8,param_00.var_2E6,800);
	wait(3);
	playfxontag(common_scripts\utility::getfx("titan_tread_impact"),param_00,"frontWheelTread07_FL");
	earthquake(0.2,1.8,param_00.var_2E6,800);
	wait(1);
	...
	earthquake(0.2,1.8,param_00.var_2E6,800);
	wait(4.8);
	thread lib_A5CE::func_9392(param_00);
}

//Function Number: 71
lib_A5CE::func_938C(param_00)
{
	param_00 endon("death");
	wait(0.2);
	playfxontag(common_scripts\utility::getfx("titan_tread_impact"),param_00,"frontWheelTread07_FR");
	earthquake(0.3,1.8,param_00.var_2E6,2000);
	wait(2);
...
lib_A5CE::func_9394()
{
	...
	lib_A5DE::snd_message("titan_walker_explo",2053);
	wait(0.3);
	common_scripts\_exploder::exploder(2052);
	lib_A5DE::snd_message("titan_walker_explo",2052);
	wait(0.2);
	common_scripts\_exploder::exploder(2051);
	lib_A5DE::snd_message("titan_walker_explo",2051);
	wait(0.2);
	common_scripts\_exploder::exploder(2056);
	lib_A5DE::snd_message("titan_walker_explo",2056);
}

//Function Number: 75
lib_A5CE::func_9392(param_00)
{
...
//Function Number: 79
lib_A5CE::func_1B6D(param_00)
{
	common_scripts\_exploder::exploder(2220);
}

//Function Number: 80
lib_A5CE::func_1B6C(param_00)
{
}

//Function Number: 81
lib_A5CE::func_34F9(param_00)
{
}

//Function Number: 82
lib_A5CE::func_220E(param_00)
{
	wait(1.1);
	common_scripts\_exploder::exploder(3629);
	wait(1.3);
	common_scripts\_exploder::exploder(3626);
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3626);
	wait(0.15);
	common_scripts\_exploder::exploder(3627);
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3627);
	wait(2.3);
	common_scripts\_exploder::exploder(3623);
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3623);
}

//Function Number: 83
lib_A5CE::func_A31D(param_00)
{
	wait(1.9);
	common_scripts\_exploder::exploder(3622);
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3622);
	wait(2.65);
	wait(6.65);
	common_scripts\_exploder::exploder(3621);
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3621);
}
...
lib_A5CE::func_6BB4()
{
	...
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3624);
	common_scripts\_exploder::exploder(3628);
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3628);
	wait(1.05);
	common_scripts\_exploder::exploder(3626);
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3626);
	wait(2.65);
	...
	lib_A5DE::snd_message("seo_per_arts_jump_explo_3",3625);
}
...
lib_A5CE::func_6BC1()
{
	...
	lib_A59A::delaythread(0.35,::common_scripts\_exploder::exploder,4023);
}
...
lib_A5CE::func_858A()
{
	...
	thread lib_A570::func_8BB2("aa_explosion_runner_single",var_00,var_02,var_03,"msg_fx_zone5_subway_traverse",0,var_01,"seo_ambient_ground_explosions");
}
...
lib_A5CE::func_858B()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_midair_runner_single",var_00,var_02,var_03,"msg_fx_zone5_subway_traverse",0,var_01,"midair_exp_audio");
}
...
lib_A5CE::func_858C()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_windowglass",var_00,var_02,var_03,"msg_fx_zone5_subway_traverse",0,var_01,"midair_exp_glass_audio");
}
...
lib_A5CE::func_8F85()
{
	...
	var_00.var_2E6 = self.var_31D getorigin();
	var_00.var_41 = (270,0,-45);
	if(!isdefined(level.var_154A))
	{
		level.var_154A = 6;
		level.var_154B = 5;
	}
	...
	for(;;)
	{
		...
		if(common_scripts\utility::flag("msg_fx_zone5_subway_traverse"))
		{
			var_01 = 1008;
			var_00.var_2E6 = self.var_31D getorigin();
			var_02 = bullettrace(self.var_31D.var_2E6 + (0,0,12),self.var_31D.var_2E6 + (0,0,1200),0,undefined);
			var_03 = distance(var_00.var_2E6,var_02["position"]);
			if(var_03 < 200)
			{
				lib_A5DE::snd_message("subway_bomb_shake");
				lib_A570::func_3B26("dust_falling_debris_01","viewmodel_medium",0.127,2,0.3,0.53);
			}
		}

		var_04 = randomfloatrange(level.var_154B * -1,level.var_154B) + level.var_154A;
		wait(var_04);
	}
}

//Function Number: 92
lib_A5CE::func_1D6C(param_00)
{
	wait(0.9);
...
lib_A5CE::func_8417()
{
	...
	thread lib_A570::func_8BB2("aa_explosion_runner_single",var_00,1,3,"msg_fx_zone7_2nd_floor_building_overview",0,var_01,"midair_exp_audio");
}
...
lib_A5CE::func_8418()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_midair_runner_single",var_00,2,6,"msg_fx_zone7_2nd_floor_building_overview",0,var_01,"midair_exp_audio");
}
...
lib_A5CE::func_8419()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_windowglass",var_00,4,6,"msg_fx_zone7_2nd_floor_building_overview",0,var_01,"midair_exp_glass_audio");
}
...
lib_A5CE::func_3736()
{
	...
	thread lib_A570::func_8BB2("aa_explosion_runner_single",var_00,2,2,"vfx_msg_finale_sequence_start",0,var_01,"midair_exp_audio");
}
...
lib_A5CE::func_3737()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_midair_runner_single",var_00,3,4,"vfx_msg_finale_sequence_start",0,var_01,"midair_exp_audio");
}
...
lib_A5CE::func_3738()
{
	...
	thread lib_A570::func_8BB2("ambient_explosion_windowglass",var_00,4,6,"vfx_msg_finale_sequence_start",0,var_01,"midair_exp_glass_audio");
}

//Function Number: 102
lib_A5CE::func_46DB(param_00)
{
...
lib_A5CE::func_7D2B()
{
	...
	if(level.currentgen)
	{
		...
		playfxontag(common_scripts\utility::getfx("light_carmack_drag1_cg_runner"),level.var_A2C5,"TAG_ORIGIN");
	}
}

//Function Number: 107
lib_A5CE::func_7D33(param_00)
{
...
//Function Number: 109
lib_A5CE::func_7D2C(param_00)
{
	lib_A59A::delaythread(0,::lib_A5CE::func_7D2D,param_00);
	lib_A59A::delaythread(0,::lib_A5CE::func_7D24);
	lib_A59A::delaythread(2.1,::lib_A5CE::func_7D28,param_00);
	lib_A59A::delaythread(2.95,::lib_A5CE::func_7D32,param_00);
	lib_A59A::delaythread(3.15,::lib_A5CE::func_7D29,param_00);
	lib_A59A::delaythread(3.9,::lib_A5CE::func_7D2A,param_00);
	lib_A59A::delaythread(4.85,::lib_A5CE::func_7D2F,param_00);
	lib_A59A::delaythread(4.95,::lib_A5CE::func_7D30);
	lib_A59A::delaythread(5.2,::lib_A5CE::func_7D2E,param_00);
	lib_A59A::delaythread(5.2,::lib_A5CE::func_7D25);
	lib_A59A::delaythread(6.5,::lib_A5CE::func_7D23);
	lib_A59A::delaythread(7.5,::lib_A5CE::func_7D27);
}

//Function Number: 110
lib_A5CE::func_7D2D(param_00)
{
	...
	var_01 lib_A5DE::snd_message("seo_finale_wp_init_explo");
	wait(3);
...
lib_A5CE::func_7D24()
{
	lib_A59A::func_671D(10000);
	wait(3);
	common_scripts\_exploder::exploder(10040);
}

//Function Number: 112
lib_A5CE::func_7D28(param_00)
{
	var_01 = common_scripts\utility::spawn_tag_origin();
	...
	var_01 lib_A5DE::snd_message("seo_finale_wp_belly_explo");
	level waittill("wp_final_explo");
	var_01 delete();
}

//Function Number: 113
lib_A5CE::func_7D29(param_00)
{
	var_01 = common_scripts\utility::spawn_tag_origin();
...
lib_A5CE::func_7D32(param_00)
{
	...
	var_01 lib_A5DE::snd_message("seo_finale_wp_wing_explo");
	level waittill("wp_final_explo");
	var_01 delete();
}

//Function Number: 116
lib_A5CE::func_7D2F(param_00)
{
...
lib_A5CE::func_7D2E(param_00)
{
	...
	var_01 lib_A5DE::snd_message("seo_finale_wp_big_explo");
	wait(10);
	var_01 delete();
}
...
lib_A5CE::func_7D25()
{
	lib_A59A::delaythread(0,::common_scripts\_exploder::exploder,"outro_grnd_smk_gush");
	lib_A59A::delaythread(1.75,::lib_A5CE::func_7D26);
	lib_A59A::delaythread(1.9,::common_scripts\_exploder::exploder,"outro_grnd_smk_linger");
	lib_A59A::delaythread(7,::common_scripts\_exploder::exploder,"outro_grnd_smk_settle");
}

//Function Number: 120
lib_A5CE::func_7D26()
{
	var_00 = spawn("script_model",level.var_31D.var_2E6);
...
lib_A5CE::func_7D23()
{
	lib_A59A::delaythread(3,::common_scripts\_exploder::exploder,"outro_rock_fall");
	lib_A59A::delaythread(5,::common_scripts\_exploder::exploder,"outro_glass_fall");
	lib_A59A::delaythread(0,::common_scripts\_exploder::exploder,"outro_ash");
	lib_A59A::delaythread(7,::lib_A59A::func_671D,"outro_rock_fall");
}
