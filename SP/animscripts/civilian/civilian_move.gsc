 ...
 * Decompiled File: civilian_move.gsc
...
//Function Number: 2
func_1DDA(param_00,param_01)
{
	var_02 = undefined;
	if(param_00 < -60 && param_00 > -120)
	{
		var_02 = level.var_78A9[self.animname]["turn_left_90"];
	}

	if(param_00 > 60 && param_00 < 120)
	{
		var_02 = level.var_78A9[self.animname]["turn_right_90"];
	}

	if(isdefined(var_02) && animscripts\move::func_66D1(var_02))
	{
		return var_02;
	}
...
func_1DA4(param_00,param_01)
{
	...
	if(param_00 < -22.5)
	{
		...
		else if(param_00 > -112.5)
		{
			...
			var_03 = animscripts\utility::func_711B(%civilian_run_hunched_turnl90_slide,%civilian_run_hunched_turnl90_stumble);
		}
		else if(param_00 > -157.5)
		{
			var_02 = %civilian_run_upright_turnl135;
	...
	else if(param_00 > 22.5)
	{
		...
		else if(param_00 < 112.5)
		{
			...
			var_03 = animscripts\utility::func_711B(%civilian_run_hunched_turnr90_slide,%civilian_run_hunched_turnr90_stumble);
		}
		else if(param_00 < 157.5)
		{
			var_02 = %civilian_run_upright_turnr135;
	...
	if(isdefined(var_03) && randomint(3) < 2 && animscripts\move::func_66D1(var_03))
	{
		return var_03;
	}
