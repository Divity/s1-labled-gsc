...
func_4E1E()
{
	...
	level.var_CCA["s1_soldier"]["cover_trans"] = var_00;
}
...
func_4E1F()
{
	...
	level.var_CCA["s1_soldier"]["cover_exit"] = var_00;
}
...
func_4D3D()
{
	...
	var_00["hide_idle_twitch"] = animscripts\utility::func_CD8(%s1_covercrouch_twitch_1,%s1_covercrouch_twitch_2,%s1_covercrouch_twitch_3,%s1_covercrouch_twitch_4,%s1_covercrouch_twitch_5);
	var_00["hide_idle_flinch"] = animscripts\utility::func_CD8(%s1_covercrouch_explosion_1,%s1_covercrouch_explosion_2,%s1_covercrouch_explosion_3);
	...
	var_00["blind_fire"] = animscripts\utility::func_CD8(%s1_covercrouch_blindfire_1,%s1_covercrouch_blindfire_2,%s1_covercrouch_blindfire_3,%s1_covercrouch_blindfire_4);
	var_00["reload"] = %s1_covercrouch_reload_hide;
	var_00["grenade_safe"] = animscripts\utility::func_CD8(%s1_covercrouch_grenadea);
	var_00["grenade_exposed"] = animscripts\utility::func_CD8(%s1_covercrouch_grenadea);
	var_00["exposed_idle"] = animscripts\utility::func_CD8(%s1_exposed_idle_alert_v1,%s1_exposed_idle_alert_v2,%s1_exposed_idle_alert_v3);
	var_00["look"] = animscripts\utility::func_CD8(%s1_covercrouch_hide_look);
	level.var_CCA["s1_soldier"]["cover_crouch"] = var_00;
	var_00 = [];
	...
	var_00["hide_idle_twitch"] = animscripts\utility::func_CD8(%s1_coverstand_hide_idle_twitch01,%s1_coverstand_hide_idle_twitch02,%s1_coverstand_hide_idle_twitch03,%s1_coverstand_hide_idle_twitch04,%s1_coverstand_hide_idle_twitch05);
	var_00["hide_idle_flinch"] = animscripts\utility::func_CD8(%s1_coverstand_react01,%s1_coverstand_react02,%s1_coverstand_react03,%s1_coverstand_react04);
	...
	var_00["single"] = animscripts\utility::func_CD8(%s1_coverstandaim_fire);
	...
	var_00["blind_fire"] = animscripts\utility::func_CD8(%s1_coverstand_blindfire_1,%s1_coverstand_blindfire_2);
	var_00["reload"] = %s1_coverstand_reloada;
	var_00["look"] = animscripts\utility::func_CD8(%s1_coverstand_look_quick,%s1_coverstand_look_quick_v2);
	var_00["grenade_safe"] = animscripts\utility::func_CD8(%s1_coverstand_grenadea,%s1_coverstand_grenadeb);
	var_00["grenade_exposed"] = animscripts\utility::func_CD8(%s1_coverstand_grenadea,%s1_coverstand_grenadeb);
	var_00["exposed_idle"] = animscripts\utility::func_CD8(%s1_exposed_idle_alert_v1,%s1_exposed_idle_alert_v2,%s1_exposed_idle_alert_v3);
	...
	level.var_CCA["s1_soldier"]["cover_stand"] = var_00;
}

//Function Number: 4
func_7EAA()
{
	level.var_4D85["burst2"] = %s1_exposed_shoot_burst3;
	level.var_4D85["burst3"] = %s1_exposed_shoot_burst3;
	level.var_4D85["burst4"] = %s1_exposed_shoot_burst4;
	level.var_4D85["burst5"] = %s1_exposed_shoot_burst5;
	level.var_4D85["burst6"] = %s1_exposed_shoot_burst6;
	level.var_4D85["semi2"] = %s1_exposed_shoot_semi2;
	level.var_4D85["semi3"] = %s1_exposed_shoot_semi3;
	level.var_4D85["semi4"] = %s1_exposed_shoot_semi4;
	level.var_4D85["semi5"] = %s1_exposed_shoot_semi5;
}
...
func_4D44()
{
	...
	level.var_CCA["s1_soldier"]["melee"] = var_00;
}

//Function Number: 6
func_7EAD()
{
	level.var_4D85["crouch_2_stand"] = %s1_exposed_crouch_2_stand;
	level.var_4D85["stand_2_crouch"] = %s1_exposed_stand_2_crouch;
}
...
{
	anim.var_4D85 = [];
	level.var_4D85["add_aim_up"] = %s1_exposed_aim_8;
	level.var_4D85["add_aim_down"] = %s1_exposed_aim_2;
	level.var_4D85["add_aim_left"] = %s1_exposed_aim_4;
	level.var_4D85["add_aim_right"] = %s1_exposed_aim_6;
	level.var_4D85["straight_level"] = %s1_exposed_aim_5;
	level.var_4D85["fire"] = %s1_exposed_shoot_auto_v3;
	level.var_4D85["fire_corner"] = %s1_exposed_shoot_auto_v2;
	level.var_4D85["single"] = animscripts\utility::func_CD8(%s1_exposed_shoot_semi1);
	func_7EAA();
	level.var_4D85["exposed_idle"] = [%s1_exposed_idle_alert_v1,%s1_exposed_idle_alert_v2,%s1_exposed_idle_alert_v3,%s1_exposed_idle_alert_v4,%s1_exposed_idle_alert_v5];
	level.var_4D85["exposed_grenade"] = [%s1_exposed_grenadethrowb,%s1_exposed_grenadethrowc];
	level.var_4D85["reload"] = [%s1_exposed_reload,%s1_exposed_reloadc];
	level.var_4D85["reload_crouchhide"] = animscripts\utility::func_CD8(%s1_exposed_reloadb);
	func_7EAD();
	func_7EAF();
	func_7EA8();
	level.var_CCA["s1_soldier"]["default_stand"] = level.var_4D85;
}
...
func_4D3C()
{
	...
	level.var_CCA["s1_soldier"]["cover_right_stand"] = var_00;
	var_00 = [];
	...
	level.var_CCA["s1_soldier"]["cover_right_crouch"] = var_00;
}
...
func_4D3B()
{
	...
	level.var_CCA["s1_soldier"]["cover_left_stand"] = var_00;
	var_00 = [];
	...
	level.var_CCA["s1_soldier"]["cover_left_crouch"] = var_00;
}
...
{
	anim.var_4D85 = [];
	level.var_4D85["F"] = %s1_run_n_gun_f;
	level.var_4D85["L"] = %s1_run_n_gun_l;
	level.var_4D85["R"] = %s1_run_n_gun_r;
	level.var_4D85["LB"] = %s1_run_n_gun_l_120;
	level.var_4D85["RB"] = %s1_run_n_gun_r_120;
	level.var_4D85["move_back"] = %s1_combatwalk_b;
	level.var_CCA["s1_soldier"]["run_n_gun"] = level.var_4D85;
}
...
func_4D40()
{
	anim.var_4D85 = [];
	func_7EAB();
	level.var_4D85["fire"] = %s1_exposed_crouch_shoot_auto_v2;
	level.var_4D85["single"] = animscripts\utility::func_CD8(%s1_exposed_crouch_shoot_semi1);
	func_7EA9();
	level.var_4D85["reload"] = animscripts\utility::func_CD8(%s1_exposed_crouch_reload);
	level.var_4D85["exposed_idle"] = animscripts\utility::func_CD8(%s1_exposed_crouch_idle_alert_v1,%s1_exposed_crouch_idle_alert_v2,%s1_exposed_crouch_idle_alert_v3);
	func_7EAD();
	func_7EAC();
	func_7EA7();
	level.var_CCA["s1_soldier"]["default_crouch"] = level.var_4D85;
}
...
func_4D48()
{
	...
	func_7EAC();
	func_7EA7();
	level.var_CCA["s1_soldier"]["smg_crouch"] = level.var_4D85;
}
...
func_7EAB()
{
	level.var_4D85["add_aim_up"] = %s1_exposed_crouch_aim_8;
	level.var_4D85["add_aim_down"] = %s1_exposed_crouch_aim_2;
	level.var_4D85["add_aim_left"] = %s1_exposed_crouch_aim_4;
	level.var_4D85["add_aim_right"] = %s1_exposed_crouch_aim_6;
	level.var_4D85["straight_level"] = %s1_exposed_crouch_aim_5;
}

//Function Number: 15
func_7EA9()
{
	level.var_4D85["burst2"] = %s1_exposed_crouch_shoot_burst3;
	level.var_4D85["burst3"] = %s1_exposed_crouch_shoot_burst3;
	level.var_4D85["burst4"] = %s1_exposed_crouch_shoot_burst4;
	level.var_4D85["burst5"] = %s1_exposed_crouch_shoot_burst5;
	level.var_4D85["burst6"] = %s1_exposed_crouch_shoot_burst6;
	level.var_4D85["semi2"] = %s1_exposed_crouch_shoot_semi2;
	level.var_4D85["semi3"] = %s1_exposed_crouch_shoot_semi3;
	level.var_4D85["semi4"] = %s1_exposed_crouch_shoot_semi4;
	level.var_4D85["semi5"] = %s1_exposed_crouch_shoot_semi5;
}

//Function Number: 16
func_7EAC()
{
	level.var_4D85["turn_left_45"] = %s1_exposed_crouch_turn_90_left;
	level.var_4D85["turn_left_90"] = %s1_exposed_crouch_turn_90_left;
	level.var_4D85["turn_left_135"] = %s1_exposed_crouch_turn_180_left;
	level.var_4D85["turn_left_180"] = %s1_exposed_crouch_turn_180_left;
	level.var_4D85["turn_right_45"] = %s1_exposed_crouch_turn_90_right;
	level.var_4D85["turn_right_90"] = %s1_exposed_crouch_turn_90_right;
	level.var_4D85["turn_right_135"] = %s1_exposed_crouch_turn_180_right;
	level.var_4D85["turn_right_180"] = %s1_exposed_crouch_turn_180_right;
}

//Function Number: 17
func_7EA7()
{
	level.var_4D85["add_turn_aim_up"] = %s1_exposed_crouch_turn_aim_8;
	level.var_4D85["add_turn_aim_down"] = %s1_exposed_crouch_turn_aim_2;
	level.var_4D85["add_turn_aim_left"] = %s1_exposed_crouch_turn_aim_4;
	level.var_4D85["add_turn_aim_right"] = %s1_exposed_crouch_turn_aim_6;
}
...
func_4D3E()
{
	...
	level.var_4D85["add_aim_right"] = %s1_exposed_aim_6;
	level.var_4D85["straight_level"] = %s1_exposed_aim_5;
	level.var_4D85["fire"] = %s1_exposed_shoot_auto_v2;
	level.var_4D85["single"] = animscripts\utility::func_CD8(%s1_exposed_shoot_semi1);
	func_7EAA();
	level.var_4D85["exposed_idle"] = [%s1_exposed_idle_alert_v5,%s1_exposed_idle_alert_v4,%s1_exposed_idle_alert_v1,%s1_exposed_idle_alert_v2,%s1_exposed_idle_alert_v3];
	level.var_4D85["reload"] = [%s1_exposed_reload,%s1_exposed_reloadc];
	level.var_4D85["reload_crouchhide"] = animscripts\utility::func_CD8(%s1_exposed_reloadb);
	func_7EAD();
	func_7EAF();
	func_7EA8();
	level.var_CCA["s1_soldier"]["cqb_stand"] = level.var_4D85;
}
...
{
	anim.var_4D85 = [];
	level.var_4D85["sprint"] = %s1_sprint1_loop;
	level.var_4D85["sprint_short"] = %s1_sprint1_loop;
	level.var_4D85["straight"] = %s1_run_lowready_f;
	level.var_4D85["move_f"] = %s1_combatwalk_f;
	level.var_4D85["move_l"] = %s1_combatwalk_l;
	level.var_4D85["move_r"] = %s1_combatwalk_r;
	level.var_4D85["move_b"] = %s1_combatwalk_b;
	level.var_CCA["s1_soldier"]["run"] = level.var_4D85;
}
...
func_4D49()
{
	anim.var_4D85 = [];
	level.var_4D85["sprint"] = %s1_sprint1_loop;
	level.var_4D85["sprint_short"] = %s1_run_lowready_f;
	level.var_4D85["straight"] = %s1_combatwalk_f;
	level.var_4D85["move_f"] = %s1_combatwalk_f;
	level.var_4D85["move_l"] = %s1_combatwalk_l;
	level.var_4D85["move_r"] = %s1_combatwalk_r;
	level.var_4D85["move_b"] = %s1_combatwalk_b;
	level.var_4D85["aim_2"] = %s1_combatwalk_f_aim2;
	level.var_4D85["aim_4"] = %s1_combatwalk_f_aim4;
	level.var_4D85["aim_6"] = %s1_combatwalk_f_aim6;
	level.var_4D85["aim_8"] = %s1_combatwalk_f_aim8;
	level.var_CCA["s1_soldier"]["walk"] = level.var_4D85;
}
...
func_4D3F()
{
	...
	level.var_CCA["s1_soldier"]["death"] = var_00;
}
...
func_4D3A()
{
	...
	level.var_CCA["s1_soldier"]["combat"] = var_00;
}
...
func_4D45()
{
	...
	level.var_CCA["s1_soldier"]["pain"] = var_00;
	var_00 = [];
...
func_4D41()
{
	...
	var_00["semi4"] = %s1_exposed_shoot_semi4;
	var_00["semi5"] = %s1_exposed_shoot_semi5;
	level.var_CCA["s1_soldier"]["shoot_while_moving"] = var_00;
	var_00 = [];
	...
	level.var_CCA["s1_soldier"]["shuffle"] = var_00;
}
...
func_4D43()
{
	...
	level.var_CCA["s1_soldier"]["idle"] = var_00;
	var_00 = [];
	var_00["stand"][0] = [2,1,1];
	var_00["stand"][1] = [10,0,0,4];
	var_00["stand_cqb"][0] = [2,1];
	var_00["crouch"][0] = [6];
	level.var_CCA["s1_soldier"]["idle_weights"] = var_00;
	var_00 = [];
	...
	level.var_CCA["s1_soldier"]["idle_transitions"] = var_00;
}
...
{
	anim.var_4D85 = [];
	level.var_4D85[0] = %s1_run_turn_180;
	level.var_4D85[1] = %s1_run_turn_l135;
	level.var_4D85[2] = %s1_run_turn_l90;
	level.var_4D85[3] = %s1_run_turn_l45;
	level.var_4D85[5] = %s1_run_turn_r45;
	level.var_4D85[6] = %s1_run_turn_r90;
	level.var_4D85[7] = %s1_run_turn_r135;
	level.var_4D85[8] = %s1_run_turn_180;
	level.var_CCA["s1_soldier"]["run_turn"] = level.var_4D85;
	anim.var_4D85 = [];
	level.var_4D85[0] = %s1_run_turn_180;
	level.var_4D85[1] = %s1_run_turn_l135;
	level.var_4D85[2] = %s1_run_turn_l90;
	...
	level.var_4D85[7] = %s1_run_turn_r135;
	level.var_4D85[8] = %s1_run_turn_180;
	level.var_CCA["s1_soldier"]["walk_turn"] = level.var_4D85;
}

//Function Number: 28
func_7EAF()
{
	level.var_4D85["turn_left_45"] = %s1_exposed_tracking_turn45l;
	level.var_4D85["turn_left_90"] = %s1_exposed_tracking_turn90l;
	level.var_4D85["turn_left_135"] = %s1_exposed_tracking_turn135l;
	level.var_4D85["turn_left_180"] = %s1_exposed_tracking_turn180l;
	level.var_4D85["turn_right_45"] = %s1_exposed_tracking_turn45r;
	level.var_4D85["turn_right_90"] = %s1_exposed_tracking_turn90r;
	level.var_4D85["turn_right_135"] = %s1_exposed_tracking_turn135r;
	level.var_4D85["turn_right_180"] = %s1_exposed_tracking_turn180r;
}
...
{
	anim.var_4D85 = [];
	level.var_4D85["turn_left_45"] = %s1_coverstand_tracking_turn45l;
	level.var_4D85["turn_left_90"] = %s1_coverstand_tracking_turn90l;
	level.var_4D85["turn_left_135"] = %s1_coverstand_tracking_turn135l;
	level.var_4D85["turn_left_180"] = %s1_coverstand_tracking_turn180l;
	level.var_4D85["turn_right_45"] = %s1_coverstand_tracking_turn45r;
	level.var_4D85["turn_right_90"] = %s1_coverstand_tracking_turn90r;
	level.var_4D85["turn_right_135"] = %s1_coverstand_tracking_turn135r;
	level.var_4D85["turn_right_180"] = %s1_coverstand_tracking_turn180r;
	level.var_CCA["s1_soldier"]["coverstand_turn"] = level.var_4D85;
}
...
func_4D4B()
{
	...
	level.var_4D85["turn_right_135"] = %s1_exposed_tracking_turn135r;
	level.var_4D85["turn_right_180"] = %s1_exposed_tracking_turn180r;
	level.var_CCA["s1_soldier"]["exposed_turn"] = level.var_4D85;
	anim.var_4D85 = [];
	level.var_4D85["turn_left_45"] = %s1_exposed_crouch_turn_90_left;
	level.var_4D85["turn_left_90"] = %s1_exposed_crouch_turn_90_left;
	level.var_4D85["turn_left_135"] = %s1_exposed_crouch_turn_180_left;
	...
	level.var_4D85["turn_right_135"] = %s1_exposed_crouch_turn_180_right;
	level.var_4D85["turn_right_180"] = %s1_exposed_crouch_turn_180_right;
	level.var_CCA["s1_soldier"]["exposed_turn_crouch"] = level.var_4D85;
}