 ...
 * Decompiled File: 42972.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 10
 * Decompile Time: 16 ms
 * Timestamp: 4/20/2022 8:24:17 PM
*******************************************************************/
...
lib_A7DC::init()
{
	...
	{
		level.var_89D9["enemy"] = "static_tactical_insertion_device";
		level.var_89D9["friendly"] = "static_tactical_insertion_device";
		level.spawnglow["enemy"] = loadfx("vfx/props/tac_insert_enemy");
		level.spawnglow["friendly"] = loadfx("vfx/props/tac_insert_friendly");
		level.var_89CB = loadfx("vfx/explosion/mp_tac_explosion");
	}
	...
	lib_A7DC::initperkdvars();
	level thread lib_A7DC::onplayerconnect();
}

//Function Number: 2
lib_A7DC::validateperk(param_00,param_01)
{
...
//Function Number: 4
lib_A7DC::onplayerconnect()
{
	for(;;)
	{
		level waittill("connected",var_00);
		var_00 thread lib_A7DC::onplayerspawned();
	}
}

//Function Number: 5
lib_A7DC::onplayerspawned()
{
...
//Function Number: 6
lib_A7DC::cac_modified_damage(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08)
{
	var_09 = 0;
...
//Function Number: 8
lib_A7DC::cac_selector()
{
}

//Function Number: 9
lib_A7DC::giveblindeyeafterspawn()
{
	self endon("death");
	self endon("disconnect");
