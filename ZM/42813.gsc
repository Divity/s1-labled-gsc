 ...
 * Decompiled File: 42813.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 7
 * Decompile Time: 1 ms
 * Timestamp: 4/20/2022 8:24:09 PM
*******************************************************************/
...
//Function Number: 2
lib_A73D::startmonitoringflash()
{
	thread lib_A73D::monitorflash();
}

//Function Number: 3
lib_A73D::stopmonitoringflash(param_00)
{
	self notify("stop_monitoring_flash");
}

//Function Number: 4
lib_A73D::flashrumbleloop(param_00)
{
...
lib_A73D::monitorflash()
{
	...
	for(;;)
	{
		...
		if(level.teambased && isdefined(var_04) && isdefined(var_04.inliveplayerkillstreak) && var_04.inliveplayerkillstreak == self.inliveplayerkillstreak && var_04 != self)
		{
		...
		{
			thread lib_A73D::applyflash(var_09,var_0A);
		...
		{
			var_04 thread lib_A73D::applyflash(var_09,var_0A);
		}
	}
}

//Function Number: 6
lib_A73D::applyflash(param_00,param_01)
{
	...
	{
		thread lib_A73D::flashrumbleloop(self.flashrumbleduration);
	}
