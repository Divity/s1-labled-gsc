...
//Function Number: 2
lib_A72D::setheadicon(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A,param_0B)
{
	...
	if(var_0C == "")
	{
		...
		var_0D thread lib_A72D::keeppositioned(self,param_03,param_07);
	}
	else
	{
		var_0D.x = param_03[0];
	...
	thread lib_A72D::destroyiconsondeath();
	if(isplayer(param_01))
	{
		var_0D thread lib_A72D::destroyonownerdisconnect(param_01);
	}

	if(isplayer(self))
	{
		var_0D thread lib_A72D::destroyonownerdisconnect(self);
	}
...
//Function Number: 3
lib_A72D::destroyonownerdisconnect(param_00)
{
	self endon("death");
...
//Function Number: 5
lib_A72D::keeppositioned(param_00,param_01,param_02)
{
	self endon("death");
...
//Function Number: 6
lib_A72D::setteamheadicon(param_00,param_01,param_02,param_03)
{
	if(!level.teambased)
	{
		return;
	...
	if(!isdefined(param_03))
	{
		if(param_02 == "")
		{
			...
			thread lib_A72D::keepiconpositioned();
		}
		else
		{
	...
	else
	{
		...
		if(param_02 == "")
		{
			...
			var_06.y = var_08[1];
			var_06.z = var_08[2];
			thread lib_A72D::keepiconpositioned(param_03);
		}
		else
		{
			var_06.x = var_08[0];
	...
	thread lib_A72D::destroyheadiconsondeath();
}

//Function Number: 7
lib_A72D::setplayerheadicon(param_00,param_01,param_02)
{
	if(level.teambased)
	{
		return;
...
//Function Number: 8
lib_A72D::keepiconpositioned(param_00)
{
	...
	for(;;)
	{
		...
		{
			lib_A72D::updateheadiconorigin(param_00);
			var_01 = self.var_2E6;
		}
...
//Function Number: 9
lib_A72D::destroyheadiconsondeath()
{
	self endon("kill_entity_headicon_thread");
	self waittill("death");
	if(!isdefined(self.entityheadicon))
