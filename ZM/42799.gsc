...
//Function Number: 1
lib_A72F::update_exo_battery_hud(param_00)
{
	...
	while(lib_A72F::get_exo_ability_hud_omnvar_value(param_00,"ui_exo_battery_toggle") == 1)
	{
		var_01 = self method_84A2(param_00);
		lib_A72F::set_exo_ability_hud_omnvar(param_00,"ui_exo_battery_level",var_01);
		wait(0.05);
	}
}

//Function Number: 2
lib_A72F::set_exo_ability_hud_omnvar(param_00,param_01,param_02)
{
...
//Function Number: 3
lib_A72F::get_exo_ability_hud_omnvar_value(param_00,param_01)
{
	if(self getoffhandsecondaryclass() == param_00)
	{
...
//Function Number: 4
lib_A72F::play_insufficient_tactical_energy_sfx()
{
	level endon("game_ended");
	self endon("disconnect");
	self endon("death");
...
//Function Number: 5
lib_A72F::play_insufficient_lethal_energy_sfx()
{
	level endon("game_ended");
	self endon("disconnect");
	self endon("death");
