...
//Function Number: 1
lib_A757::watchtrackingdroneusage()
{
	...
	for(;;)
	{
		...
		{
			var_00 thread lib_A757::destroy_tracking_drone_in_water();
			wait(0.5);
			if(!function_0294(var_00) && isdefined(var_00))
			{
				self.trackingdronestartposition = var_00.var_2E6;
				self.trackingdronestartangles = var_00.var_41;
				var_00 lib_A757::deletetrackingdrone();
				if(!lib_A757::prevent_tracking_drone_in_water(self.trackingdronestartposition))
				{
					lib_A757::tryusetrackingdrone(var_01);
				}
			}
		}
	}
...
lib_A757::trackingdroneinit()
{
	...
	level.trackingdronesettings.var_275 = 60;
	...
	level thread lib_A757::ontrackingplayerconnect();
...
//Function Number: 3
lib_A757::tryusetrackingdrone(param_00)
{
	var_01 = 1;
	...
	else if(lib_A757::exceededmaxtrackingdrones())
	{
	...
	if(self.trackingdronearray.size)
	{
		...
		if(self.trackingdronearray.size >= level.trackingdronemaxperplayer)
		{
			...
			{
				self.trackingdronearray[0] thread lib_A757::trackingdrone_leave();
			}
		}
	}

	maps\mp\_utility::incrementfauxvehiclecount();
	var_02 = lib_A757::createtrackingdrone(param_00);
	if(!isdefined(var_02))
	{
	...
	thread lib_A757::starttrackingdrone(var_02);
	return 1;
}

//Function Number: 4
lib_A757::createtrackingdrone(param_00,param_01,param_02,param_03,param_04)
{
...
//Function Number: 5
lib_A757::idletargetmover(param_00)
{
	self endon("disconnect");
...
//Function Number: 6
lib_A757::trackingdrone_lightfx(param_00,param_01)
{
...
//Function Number: 7
lib_A757::trackingdrone_enemy_lightfx()
{
	self endon("death");
	foreach(var_01 in level.var_328)
	{
		...
		{
			childthread lib_A757::trackingdrone_lightfx(level.trackingdronesettings.fxid_enemy_light,var_01);
			wait(0.2);
		}
	}
}
...
//Function Number: 8
lib_A757::trackingdrone_friendly_lightfx()
{
	self endon("death");
	foreach(var_01 in level.var_328)
	{
		if(isdefined(var_01) && issentient(var_01) && issentient(self) && var_01.inliveplayerkillstreak == self.inliveplayerkillstreak)
		{
			childthread lib_A757::trackingdrone_lightfx(level.trackingdronesettings.fxid_friendly_light,var_01);
			wait(0.2);
		}
	}

	thread lib_A757::watchconnectedplayfx();
	thread lib_A757::watchjoinedteamplayfx();
}

//Function Number: 9
lib_A757::drone_thrusterfx()
{
	self endon("death");
	foreach(var_01 in level.var_328)
	{
...
lib_A757::watchconnectedplayfx()
{
	...
	for(;;)
	{
		...
		{
			childthread lib_A757::trackingdrone_lightfx(level.trackingdronesettings.fxid_friendly_light,var_00);
			wait(0.2);
		}
	}
}
...
//Function Number: 11
lib_A757::watchjoinedteamplayfx()
{
	self endon("death");
	for(;;)
	{
...
//Function Number: 12
lib_A757::starttrackingdrone(param_00)
{
	level endon("game_ended");
	param_00 endon("death");
	param_00 thread lib_A757::trackingdrone_followtarget();
	param_00 thread lib_A757::aud_drone_start_jets();
	if(isdefined(param_00.type))
	{
		if(param_00.type == "explosive_drone")
		{
			param_00 thread lib_A757::checkforexplosivegoal();
			return;
		}

		if(param_00.type == "tracking_drone" && !isdefined(level.var_511A))
		{
			param_00 thread lib_A757::trackingdrone_highlighttarget();
			return;
		}
	}
}
...
//Function Number: 13
lib_A757::checkforexplosivegoal()
{
	level endon("game_ended");
	...
	for(;;)
	{
		...
		{
			var_00 = distancesquared(self.trackedplayer.var_2E6,self.var_2E6);
			if(var_00 <= 16384)
			{
				self notify("exploding");
				thread lib_A757::blowupdronesequence();
				break;
			}
		}
	}
...
lib_A757::blowupdronesequence()
{
	...
	if(isdefined(self))
	{
		thread lib_A757::turnondangerlights();
		self playsoundasmaster("drone_warning_beap");
	}

	wait(var_00);
	if(isdefined(self))
	{
		self playsoundasmaster("drone_bomb_explosion");
		var_02 = anglestoup(self.var_41);
		var_03 = anglestoforward(self.var_41);
		playfx(level.trackingdronesettings.fxid_lethalexplode,self.var_2E6,var_03,var_02);
		if(isdefined(var_01))
		{
			self entityradiusdamage(self.var_2E6,256,1000,25,var_01,"MOD_EXPLOSIVE","killstreak_missile_strike_mp");
		}
		else
		{
			self entityradiusdamage(self.var_2E6,256,1000,25,undefined,"MOD_EXPLOSIVE","killstreak_missile_strike_mp");
		}
...
//Function Number: 16
lib_A757::trackingdrone_followtarget()
{
	level endon("game_ended");
	level endon("host_migration_begin");
	self endon("death");
	...
	if(!isdefined(self.owner))
	{
		thread lib_A757::trackingdrone_leave();
		return;
	}
		...
		if(isdefined(self.owner) && isalive(self.owner))
		{
			...
			if(!isdefined(level.var_511A))
			{
				if(!isdefined(self.trackedplayer) || self.trackedplayer == self.owner)
				{
					...
					{
						if(isdefined(var_03) && isalive(var_03) && var_03.inliveplayerkillstreak != self.inliveplayerkillstreak && !var_03 maps\mp\_utility::_hasperk("specialty_blindeye"))
						{
							...
							if(var_04 < var_01)
							{
								...
								thread lib_A757::watchplayerdeathdisconnect(var_03);
							}
						}
					}
				}
			...
			if(isdefined(self.trackedplayer))
			{
				lib_A757::trackingdrone_movetoplayer(self.trackedplayer);
			}

			if(self.trackedplayer != self.previoustrackedplayer)
			{
				lib_A757::stophighlightingplayer(self.previoustrackedplayer);
...
//Function Number: 17
lib_A757::watchplayerdeathdisconnect(param_00)
{
	self endon("death");
	self endon("leaving");
	self endon("exploding");
...
//Function Number: 18
lib_A757::trackingdrone_movetoplayer(param_00)
{
	level endon("game_ended");
	self endon("death");
	self endon("leaving");
...
//Function Number: 19
lib_A757::trackingdrone_stopmovement()
{
...
//Function Number: 20
lib_A757::trackingdrone_changeowner(param_00)
{
	maps\mp\_utility::incrementfauxvehiclecount();
	var_01 = param_00 lib_A757::createtrackingdrone(self.fx_origin,1,self.var_2E6,self.var_41);
	if(!isdefined(var_01))
	{
		maps\mp\_utility::decrementfauxvehiclecount();
		return 0;
	...
	param_00 thread lib_A757::starttrackingdrone(var_01);
	...
	lib_A757::removetrackingdrone();
	return 1;
}

//Function Number: 21
lib_A757::trackingdrone_highlighttarget()
{
	level endon("game_ended");
	self endon("death");
	self endon("leaving");
...
//Function Number: 22
lib_A757::starthighlightingplayer(param_00)
{
	self.lasertag method_80B2("tracking_drone_laser");
...
//Function Number: 23
lib_A757::stophighlightingplayer(param_00)
{
...
//Function Number: 24
lib_A757::ontrackingplayerconnect()
{
	level endon("game_ended");
	for(;;)
	{
...
//Function Number: 25
lib_A757::trackingdrone_watchforgoal()
{
	level endon("game_ended");
	self endon("death");
	self endon("leaving");
...
//Function Number: 26
lib_A757::trackingdrone_watchdeath()
{
	level endon("game_ended");
	self endon("gone");
	self waittill("death");
	thread lib_A757::trackingdronedestroyed();
}

//Function Number: 27
lib_A757::trackingdrone_watchtimeout()
{
	level endon("game_ended");
	level endon("host_migration_begin");
	self endon("death");
...
//Function Number: 28
lib_A757::trackingdrone_watchownerloss()
{
	level endon("game_ended");
	self endon("death");
	self endon("leaving");
...
//Function Number: 29
lib_A757::trackingdrone_watchownerdeath()
{
	level endon("game_ended");
	self endon("death");
	self endon("leaving");
...
//Function Number: 30
lib_A757::trackingdrone_watchtargetdisconnect()
{
	level endon("game_ended");
	level endon("host_migration_begin");
	self endon("death");
	...
	lib_A757::stophighlightingplayer(self.trackedplayer);
	lib_A757::trackingdrone_movetoplayer(self.owner);
}

//Function Number: 31
lib_A757::trackingdrone_watchroundend()
{
	level endon("game_ended");
	self endon("death");
	self endon("leaving");
...
//Function Number: 32
lib_A757::trackingdrone_watchhostmigration()
{
	level endon("game_ended");
	self endon("death");
	self endon("leaving");
	...
	thread lib_A757::trackingdrone_changeowner(self.owner);
}

//Function Number: 33
lib_A757::trackingdrone_leave()
{
	self endon("death");
	self notify("leaving");
	lib_A757::stophighlightingplayer(self.trackedplayer);
	lib_A757::trackingdroneexplode();
}

//Function Number: 34
lib_A757::ontrackingdronedeath(param_00,param_01,param_02,param_03)
{
	self notify("death");
}

//Function Number: 35
lib_A757::trackingdrone_watchdisable()
{
	self endon("death");
	self.owner endon("disconnect");
	level endon("game_ended");
	for(;;)
	{
		...
		thread lib_A757::trackingdrone_stunned();
	}
}

//Function Number: 36
lib_A757::trackingdrone_stunned()
{
	...
	self.owner endon("disconnect");
	level endon("game_ended");
	lib_A757::trackingdrone_stunbegin();
	wait(10);
	lib_A757::trackingdrone_stunend();
}
...
lib_A757::trackingdrone_stunbegin()
{
	...
	thread lib_A757::stophighlightingplayer(self.trackedplayer);
	self.trackedplayer = undefined;
	self.previoustrackedplayer = self.owner;
	thread lib_A757::trackingdrone_stopmovement();
}
...
//Function Number: 39
lib_A757::trackingdronedestroyed()
{
	if(!isdefined(self))
	{
		return;
...
lib_A757::trackingdroneexplode()
{
	...
	{
		playfx(level.trackingdronesettings.fxid_explode,self.var_2E6);
	}

	if(isdefined(level.trackingdronesettings.sound_explode))
	{
		self playsoundasmaster(level.trackingdronesettings.sound_explode);
	}
...
//Function Number: 43
lib_A757::addtotrackingdronelist()
{
	level.trackingdrones[self getentitynumber()] = self;
}

//Function Number: 44
lib_A757::removefromtrackingdronelistondeath()
{
...
//Function Number: 45
lib_A757::exceededmaxtrackingdrones()
{
...
//Function Number: 46
lib_A757::aud_drone_start_jets()
{
	self playloopsound("veh_tracking_drone_jets_lp");
}

//Function Number: 47
lib_A757::destroy_tracking_drone_in_water()
{
	self endon("death");
...
//Function Number: 48
lib_A757::prevent_tracking_drone_in_water(param_00)
{
	if(!isdefined(level.water_triggers))
	{
		return 0;
