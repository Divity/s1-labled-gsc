 ...
 * Timestamp: 4/20/2022 8:23:59 PM
*******************************************************************/
...
initplayerscriptvariables(param_00)
{
	if(!param_00)
	{
		...
		self.assistedsuicide = undefined;
		self.name = undefined;
		self.saved_actionslotdata = undefined;
		self.perks = undefined;
		self.weaponlist = undefined;
		self.omaclasschanged = undefined;
		self.exocount = undefined;
	...
	else
	{
		...
		self.assistedsuicide = maps\mp\_utility::getuniqueid();
		self.name = self.assistedsuicide;
		self.sessionteam = self.inliveplayerkillstreak;
...
{
	var_02 = getnodesinradius(self.var_2E6,350,64,128,"Path");
	...
	if(isdefined(level.waterdeletez) && isdefined(level.trigunderwater))
	{
		...
		{
			if(var_05.var_2E6[2] > level.waterdeletez || !ispointinvolume(var_05.var_2E6,level.trigunderwater))
			{
	...
	var_07 = anglestoforward(self.var_41);
	var_08 = -10;
	...
	foreach(var_0E in var_02)
	{
		...
		var_0F = vectornormalize(var_0E.var_2E6 - self.var_2E6);
	...
	for(var_11 = 0;var_11 < var_0B.size;var_11++)
	{
		...
		var_14 = self.var_2E6 + var_0A;
		var_15 = var_0E.var_2E6 + var_0A;
		if(var_11 > 0)
		{
			wait(0.05);
		}
		...
		if(param_01)
		{
			...
			var_16 = playerphysicstrace(var_0E.var_2E6 + var_0A,var_0E.var_2E6);
			if(distancesquared(var_16,var_0E.var_2E6) > 1)
			{
				continue;
			}
		}
	...
	if(var_0B.size > 0 && isdefined(level.var_511A))
	{
		return var_0B[0];
	}
}
...
killagent(param_00)
{
	param_00 dodamage(param_00.health + 500000,param_00.var_2E6);
}
