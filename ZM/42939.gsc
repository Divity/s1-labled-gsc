...
//Function Number: 2
lib_A7BB::promptforstreaksupport(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	if(!level.teambased)
	{
		return;
	...
	var_08.active = 0;
	var_08.promptid = lib_A7BB::getuniquestreakpromptid();
	if(isdefined(param_05))
	{
		var_08 disableplayeruse(param_05);
	}

	lib_A7BB::addstreaksupportprompt(var_08);
	return var_08.promptid;
}

//Function Number: 3
lib_A7BB::stoppromptforstreaksupport(param_00)
{
	if(!level.teambased)
	{
		return;
	...
	foreach(var_02 in level.streaksupportqueueallies)
	{
		...
		{
			thread lib_A7BB::removestreaksupportprompt(var_02);
			return;
		}
	}
...
//Function Number: 4
lib_A7BB::waittillbuddyjoinedstreak(param_00)
{
	for(;;)
	{
...
//Function Number: 5
lib_A7BB::playersetupcoopstreak(param_00)
{
	lib_A7BB::playersetupcoopstreakinternal(param_00);
}

//Function Number: 6
lib_A7BB::playerresetaftercoopstreak()
{
	lib_A7BB::playerresetaftercoopstreakinternal();
}

//Function Number: 7
lib_A7BB::playerstoppromptforstreaksupport()
{
	if(!level.teambased)
	{
		return;
...
//Function Number: 8
lib_A7BB::playerstartpromptforstreaksupport()
{
	if(!level.teambased)
	{
		return;
...
//Function Number: 9
lib_A7BB::addstreaksupportprompt(param_00)
{
	if(param_00.inliveplayerkillstreak == "allies")
	{
		...
		{
			level thread lib_A7BB::startstreaksupportprompt(param_00);
			return;
		}
...
//Function Number: 10
lib_A7BB::removestreaksupportprompt(param_00)
{
	...
	if(param_00.inliveplayerkillstreak == "allies")
	{
		...
		{
			level thread lib_A7BB::startstreaksupportprompt(level.streaksupportqueueallies[0]);
		}
	}
	else
	{
		...
		{
			level thread lib_A7BB::startstreaksupportprompt(level.streaksupportqueueaxis[0]);
		}
	}

	thread lib_A7BB::delaydeleteprompt(param_00);
}

//Function Number: 11
lib_A7BB::delaydeleteprompt(param_00)
{
	wait(1);
	param_00 delete();
}
...
//Function Number: 12
lib_A7BB::getuniquestreakpromptid(param_00)
{
	var_01 = 0;
...
//Function Number: 13
lib_A7BB::startstreaksupportprompt(param_00)
{
	param_00.active = 1;
	level thread lib_A7BB::handleprompt(param_00);
	level thread lib_A7BB::onconnectprompt(param_00);
	foreach(var_02 in level.var_328)
	{
		...
		{
			var_02 thread lib_A7BB::playersetupstreakprompt(param_00);
		}

		var_02 thread lib_A7BB::playeronspawnprompt(param_00);
	}
}

//Function Number: 14
lib_A7BB::onconnectprompt(param_00)
{
	...
	for(;;)
	{
		...
		var_01 thread lib_A7BB::playeronspawnprompt(param_00);
	}
}

//Function Number: 15
lib_A7BB::playeronspawnprompt(param_00)
{
	level endon("game_ended");
	...
	for(;;)
	{
		...
		{
			thread lib_A7BB::playersetupstreakprompt(param_00);
		}
	}
}

//Function Number: 16
lib_A7BB::playersetupstreakprompt(param_00)
{
	level endon("game_ended");
	self endon("death");
	self endon("disconnect");
	...
	lib_A7BB::playerdisabledwait(param_00);
	thread lib_A7BB::playerdisplayjoinrequest(param_00);
	thread lib_A7BB::playertakestreaksupportinput(param_00);
}
...
//Function Number: 18
lib_A7BB::playerdisplayjoinrequest(param_00)
{
	level endon("game_ended");
	self endon("death");
	self endon("disconnect");
...
//Function Number: 19
lib_A7BB::waittillplayercanbebuddy(param_00,param_01)
{
...
//Function Number: 20
lib_A7BB::waittillpromptactivated(param_00)
{
	param_00 endon("streakPromptStopped");
...
//Function Number: 21
lib_A7BB::playertakestreaksupportinput(param_00)
{
	level endon("game_ended");
	self endon("death");
	self endon("disconnect");
	for(;;)
	{
		lib_A7BB::waittillplayercanbebuddy(self);
		var_01 = lib_A7BB::waittillpromptactivated(param_00);
		if(!isdefined(var_01))
		{
			return;
		}
		...
		{
			var_02 = lib_A7BB::playergetusetime();
			var_01 = lib_A7BB::playerhandlejoining(param_00,var_02);
...
//Function Number: 23
lib_A7BB::handleprompt(param_00)
{
...
//Function Number: 24
lib_A7BB::playerhandlejoining(param_00,param_01)
{
	var_02 = param_01 * 1000;
	if(param_00 lib_A7BB::useholdthink(self,var_02,param_00))
	{
...
//Function Number: 25
lib_A7BB::useholdthink(param_00,param_01,param_02)
{
	param_00 playerlinkto(param_02);
	param_00 playerlinkedoffsetenable();
	param_00.manuallyjoiningkillstreak = 1;
	thread lib_A7BB::useholdthinkcleanuponplayerdeath(param_00);
	self.curprogress = 0;
	self.inuse = 1;
	self.userate = 0;
	...
	param_00 thread lib_A7BB::personalusebar(self,param_02);
	var_03 = lib_A7BB::useholdthinkloop(param_00,param_02);
	if(!isdefined(var_03))
	{
		var_03 = 0;
	}
	...
	{
		param_00 lib_A7BB::playerresetaftercoopstreakinternal();
	}
...
//Function Number: 26
lib_A7BB::useholdthinkcleanuponplayerdeath(param_00)
{
...
lib_A7BB::playerresetaftercoopstreakinternal()
{
	...
	thread lib_A7BB::playerdelaycontrol();
	self unlink();
}
...
//Function Number: 30
lib_A7BB::personalusebar(param_00,param_01)
{
	self endon("disconnect");
...
//Function Number: 31
lib_A7BB::useholdthinkloop(param_00,param_01)
{
	param_01 endon("streakPromptStopped");
