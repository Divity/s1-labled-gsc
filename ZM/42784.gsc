...
//Function Number: 1
lib_A720::waittill_aerial_pathnodes_calculated()
{
...
//Function Number: 3
lib_A720::get_group_connect_dist()
{
...
//Function Number: 4
lib_A720::node_is_valid__to_convert_to_aerial_pathnode(param_00)
{
...
//Function Number: 5
lib_A720::calculate_aerial_pathnodes()
{
	...
	{
		if(lib_A720::node_is_valid__to_convert_to_aerial_pathnode(var_03))
		{
			...
			{
				if(lib_A720::node_is_valid__to_convert_to_aerial_pathnode(var_06) && !common_scripts\utility::array_contains(var_03.aerial_neighbors,var_06))
				{
	...
	var_01 = undefined;
	wait(0.05);
	var_09 = lib_A720::divide_nodes_into_groups(level.aerial_pathnodes,1);
	var_0A = 3;
	if(!0)
	{
		var_0B = lib_A720::get_group_connect_dist();
		var_0C = [];
		var_0D = 0;
		for(var_0E = 0;var_0E < var_09.size;var_0E++)
		{
			...
			foreach(var_03 in var_09[var_0E])
			{
				for(var_10 = var_0E + 1;var_10 < var_09.size;var_10++)
				{
					...
					{
						var_14 = distance(var_03.var_2E6,var_13.var_2E6);
						...
						if(!var_15)
						{
							if(isdefined(level.aerial_pathnodes_force_connect))
							{
								foreach(var_18 in level.aerial_pathnodes_force_connect)
								{
									...
									if(distance2dsquared(var_18.var_2E6,var_03.var_2E6) < var_19 && distance2dsquared(var_18.var_2E6,var_13.var_2E6) < var_19)
									{
										var_16 = 1;
										break;
									}
						...
						if(var_15 && var_1B)
						{
							...
							var_11 = common_scripts\utility::array_sort_with_func(var_11,::lib_A720::is_pair_a_closer_than_pair_b);
							continue;
						}
		...
		for(var_0E = 0;var_0E < var_09.size;var_0E++)
		{
			for(var_10 = var_0E + 1;var_10 < var_09.size;var_10++)
			{
				...
				var_0C[var_0E][var_10] = common_scripts\utility::array_sort_with_func(var_0C[var_0E][var_10],::lib_A720::is_pair_a_closer_than_pair_b,150);
				if(var_21 > 500)
				{
					wait(0.05);
					var_21 = 0;
		...
		wait(0.05);
		var_22 = lib_A720::get_aerial_offset();
		var_23 = 10;
		var_24 = 0;
		if(0)
		{
		...
		for(var_0E = 0;var_0E < var_09.size;var_0E++)
		{
			for(var_10 = var_0E + 1;var_10 < var_09.size;var_10++)
			{
				foreach(var_26 in var_0C[var_0E][var_10])
				{
					var_27 = var_26[0];
					var_28 = var_26[1];
					if(!lib_A720::node0_has_neighbor_connected_to_node1(var_27,var_28))
					{
						var_29 = lib_A720::num_node_connections_to_group(var_27,var_28.aerial_group);
						var_2A = lib_A720::num_node_connections_to_group(var_28,var_27.aerial_group);
						if(var_29 < var_0A && var_2A < var_0A)
						{
							var_2B = playerphysicstrace(var_27.var_2E6 + var_22,var_28.var_2E6 + var_22);
							var_24++;
							var_2C = distancesquared(var_2B,var_28.var_2E6 + var_22) < 1;
							if(!var_2C && var_26[2] == -1)
							{
								var_2C = bullettracepassed(var_27.var_2E6 + var_22,var_28.var_2E6 + var_22,0,undefined);
							}
		...
		var_0C = undefined;
		var_09 = lib_A720::divide_nodes_into_groups(level.aerial_pathnodes);
		if(0)
		{
			var_09 = common_scripts\utility::array_sort_with_func(var_09,::lib_A720::is_group_a_larger_than_group_b);
			for(var_0E = 0;var_0E < var_09.size;var_0E++)
			{
				foreach(var_03 in var_09[var_0E])
				{
...
//Function Number: 6
lib_A720::is_group_a_larger_than_group_b(param_00,param_01)
{
	return param_00.size > param_01.size;
}

//Function Number: 7
lib_A720::is_pair_a_closer_than_pair_b(param_00,param_01)
{
	return param_00[2] < param_01[2];
}

//Function Number: 8
lib_A720::num_node_connections_to_group(param_00,param_01)
{
	var_02 = 0;
...
//Function Number: 9
lib_A720::node0_has_neighbor_connected_to_node1(param_00,param_01)
{
...
//Function Number: 10
lib_A720::divide_nodes_into_groups(param_00,param_01)
{
...
//Function Number: 11
lib_A720::node_is_aerial(param_00)
{
	return isdefined(param_00.aerial_neighbors);
}

//Function Number: 12
lib_A720::get_ent_closest_aerial_node(param_00,param_01)
{
	...
	var_02 = getnodesinradiussorted(self.var_2E6,param_00,param_01,lib_A720::get_aerial_offset()[2] * 2,"path");
	for(var_03 = 0;var_03 < var_02.size;var_03++)
	{
		if(lib_A720::node_is_aerial(var_02[var_03]))
		{
...
//Function Number: 13
lib_A720::find_path_between_aerial_nodes(param_00,param_01)
{
